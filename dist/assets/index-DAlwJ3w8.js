 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ws;const Nt={};class De{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return E(Nt&&G,"ChildrenNode.ts has not been loaded"),ws=ws||new De({".priority":Nt},{".priority":G}),ws}get(e){const n=pt(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof de?n:null}hasIndex(e){return xe(this.indexSet_,e.toString())}addIndex(e,n){E(e!==Mt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(N.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=pi(i,e.getCompare()):a=Nt;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new De(d,c)}addToIndexes(e,n){const i=di(this.indexes_,(s,r)=>{const o=pt(this.indexSet_,r);if(E(o,"Missing index implementation for "+r),s===Nt)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(N.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),pi(a,o.getCompare())}else return Nt;else{const a=n.get(e.name);let l=s;return a&&(l=l.remove(new N(e.name,a))),l.insert(e,e.node)}});return new De(i,this.indexSet_)}removeFromIndexes(e,n){const i=di(this.indexes_,s=>{if(s===Nt)return s;{const r=n.get(e.name);return r?s.remove(new N(e.name,r)):s}});return new De(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ap extends ji{compare(e,n){const i=e.node.compareTo(n.node);return i===0?xt(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return N.MIN}maxPost(){return N.MAX}makePost(e,n){const i=J(e);return new N(n,i)}toString(){return".value"}}const Rp=new Ap;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=be.MERGE}operationForChild(e){if(L(this.path)){const n=this.children.subtree(new $(e));return n.isEmpty()?null:n.value?new gt(this.source,D(),n.value):new zt(this.source,D(),n)}else return E(P(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zt(this.source,U(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class om{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const pc=new om;class Lr{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new st(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Nr(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:yt(this.viewCache_),r=sm(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return L(this._path)?null:Er(this._path)}get ref(){return new Pe(this._repo,this._path)}get _queryIdentifier(){const e=ea(this._queryParams),n=wr(e);return n==="{}"?"default":n}get _queryObject(){return ea(this._queryParams)}isEqual(e){if(e=q(e),!(e instanceof Yr))return!1;const n=this._repo===e._repo,i=Ir(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+cp(this._path)}}class Pe extends Yr{constructor(e,n){super(e,n,new Sr,!1)}get parent(){const e=Zl(this._path);return e===null?null:new Pe(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class qt{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new $(e),i=Nn(this.ref,e);return new qt(this._node.getChild(n),i,G)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new qt(s,Nn(this.ref,i),G)))}hasChild(e){const n=new $(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function V(t,e){return t=q(t),t._checkNotDeleted("ref"),e!==void 0?Nn(t._root,e):t._root}function Nn(t,e){return t=q(t),P(t._path)===null?Qm("child","path",e):Nc("child","path",e),new Pe(t._repo,K(t._path,e))}function Ln(t,e){t=q(t),Yi("push",t._path),Pc("push",e,t._path,!0);const n=Dc(t._repo),i=yg(n),s=Nn(t,i),r=Nn(t,i);let o;return e!=null?o=ze(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Uc(t){return Yi("remove",t._path),ze(t,null)}function ze(t,e){t=q(t),Yi("set",t._path),Pc("set",e,t._path,!1);const n=new Qt;return og(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function es(t,e){Ym("update",e,t._path);const n=new Qt;return ag(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function vg(t){t=q(t);const e=new Fc(()=>{}),n=new ts(e);return rg(t._repo,t,n).then(i=>new qt(i,new Pe(t._repo,t._path),t._queryParams.getIndex()))}class ts{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new wg("value",this,new qt(e.snapshotNode,new Pe(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new _g(this,e,n):null}matches(e){return e instanceof ts?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function bg(t,e,n,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=n,c=(d,u)=>{pa(t._repo,t,a),l(d,u)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Fc(n,r||void 0),a=new ts(o);return cg(t._repo,t,a),()=>pa(t._repo,t,a)}function wt(t,e,n,i){return bg(t,"value",e,n,i)}bm(Pe);xm(Pe);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pg(t){bf(kt),Ie(new we("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return kg(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),ue($o,Bo,t),ue($o,Bo,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ay(t,e){return q(t).setPersistence(e)}function Ry(t,e,n,i){return q(t).onIdTokenChanged(e,n,i)}function Py(t,e,n){return q(t).beforeAuthStateChanged(e,n)}function Ny(t,e,n,i){return q(t).onAuthStateChanged(e,n,i)}function Ly(t){return q(t).signOut()}const Ci="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pw=new zn(3e4,6e4);function Pa(){const t=Re().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function mw(t){return new Promise((e,n)=>{var i,s,r;function o(){Pa(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Pa(),n(Ae(t,"network-request-failed"))},timeout:pw.get()})}if(!((s=(i=Re().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=Re().gapi)===null||r===void 0)&&r.load)o();else{const a=ly("iframefcb");return Re()[a]=()=>{gapi.load?o():n(Ae(t,"network-request-failed"))},rd(`${ay()}?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw ri=null,e})}let ri=null;function gw(t){return ri=ri||mw(t),ri}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pi="analytics",Hv="firebase_id",Vv="origin",qv=60*1e3,Gv="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",yo="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
  ...
  `;t.innerHTML=n};window.reorderCarImage=function(t,e){const n=window.state.carImages,i=t+e;if(i>=0&&i<n.length){const s=n[t];n[t]=n[i],n[i]=s,window.renderCarImageManager()}};window.removeCarImage=function(t){if(t<0||t>=window.state.carImages.length)return;const e=window.state.carImages[t].isMain;window.state.carImages.splice(t,1),e&&window.state.carImages.length>0&&(window.state.carImages[0].isMain=!0),window.renderCarImageManager()};window.setCarMainImage=function(t){window.state.carImages.forEach((e,n)=>e.isMain=n===t),window.renderCarImageManager()};window.saveLuxuryItem=async function(t){t&&t.preventDefault();const e=window.state.currentEdit;if(!e)return;const{type:n,id:i}=e,s=document.getElementById("item-form");if(!s)return;const r=s.querySelector('button[type="submit"]'),o=r.innerText;r&&(r.disabled=!0,r.innerText="جاري الحفظ والمعالجة...");const a=new FormData(s),l={};a.forEach((c,d)=>{d!=="main_img_file"&&d!=="gallery_files"&&(l[d]=c)});try{if(n==="cars"){const u=[];let h="";const f=window.state.carImages||[];f.length;for(let p=0;p<f.length;p++){const _=f[p];let b="";if(_.type==="url")b=_.value;else if(_.type==="file"){const g=_.value,m=`cars/${Date.now()}_${p}_${g.name.replace(/\s/g,"_")}`,w=ev(kb,m),v=await X_(w,g);b=await Z_(v.ref)}u.push(b),_.isMain&&(h=b)}!h&&u.length>0&&(h=u[0]),l.image=h,l.images=u}["price","year","mileage","rating","installmentPeriod"].forEach(u=>{l[u]!==void 0&&l[u]!==""&&l[u]!==null&&(l[u]=Number(l[u]))}),l.isFeatured!==void 0&&(l.isFeatured=l.isFeatured==="true"||l.isFeatured===!0),i||(l.createdAt=new Date().toISOString()),l.updatedAt=new Date().toISOString();const d=i?V(j,`${n}/${i}`):Ln(V(j,n));await(i?es(d,l):ze(d,l)),window.showLuxuryToast(i?"تم تحديث البيانات بنجاح":"تم إضافة العنصر بنجاح"),window.closeModal("item-modal"),window.createLog(i?"تعديل":"إضافة",`${i?"تعديل":"إضافة"} في ${n} - ${l.make||l.title||i}`,"data")}catch(c){console.error("Save Error:",c),window.showLuxuryToast("حدث خطأ أثناء الحفظ: "+(c.message||"خطأ غير معروف"),"error")}finally{r&&(r.disabled=!1,r.innerText=o)}};window.openQuickReplyModal=function(){window.openCRUDModal("quickReplies")};window.renderQuickRepliesAdmin=function(){var i;const t=document.getElementById("quick-replies-list");if(!t)return;const e=(((i=document.getElementById("qr-search"))==null?void 0:i.value)||"").toLowerCase().trim(),n=(window.state.quickReplies||[]).filter(s=>(s.title||"").toLowerCase().includes(e)||(s.content||"").toLowerCase().includes(e));if(n.length===0){t.innerHTML='<div class="no-results-v2" style="grid-column:1/-1;"><p>لا توجد نتائج مطابقة لبحثك</p></div>';return}t.innerHTML=n.map(s=>`
    ...
    `;const c=l.querySelector(".fa-times-btn");c.onmouseover=()=>c.style.color="#e02424",c.onmouseout=()=>c.style.color="#999";const d=async()=>{var f;try{await Ln(V(j,"notifications"),{userId:n||((f=window.state.userProfile)==null?void 0:f.id)||"admin",type:"wa_message",title:"رسالة واتساب من "+o,body:a,phone:t,read:!1,createdAt:new Date().toISOString()})}catch(p){console.warn("Could not save to notifications DB",p)}};let u=setTimeout(()=>{h(),d()},1e4);const h=()=>{l.style.transform="translateX(-120%)",l.style.opacity="0",l.style.marginTop=`-${l.offsetHeight}px`,setTimeout(()=>{l.parentNode&&l.parentNode.removeChild(l)},400)};c.onclick=f=>{f.stopPropagation(),clearTimeout(u),h()},l.onclick=()=>{clearTimeout(u),h(),r?(window.viewBookingDetails(r.id),setTimeout(()=>{const f=document.getElementById("details-modal").querySelector(".dash-tab.admin-only");f&&f.click()},100)):window.showLuxuryToast("الرسالة من رقم غير مسجل في أي طلب مفتوح","info")},i.insertBefore(l,i.firstChild),requestAnimationFrame(()=>{l.style.transform="translateX(0)",l.style.opacity="1"})};window.startCurrentWASession=function(){if(!window.state.user)return;const t=()=>{H.emit("start_session",{userId:window.state.user.uid});const e=document.getElementById("wa-my-status-title"),n=document.getElementById("wa-my-status-desc");e&&(e.innerText="جاري الاتصال..."),n&&(n.innerText="يتم الآن التواصل مع خادم الواتساب لتوليد رمز الاستجابة السريعة...")};H?H.connected?t():(H.once("connect",t),H.connect()):window.initWhatsAppServer()};window.logoutCurrentWASession=function(){window.state.user&&confirm("هل أنت متأكد من تسجيل الخروج من واتساب؟ لن تتمكن من المراسلة من هنا.")&&H&&H.emit("logout_session",{userId:window.state.user.uid})};window._waMediaCache=window._waMediaCache||{};window._unsubModalChat=null;window.fetchServerWAChat=function(t,e,n=!1){if(!t)return;const i=document.getElementById("wa-modal-chat-box");if(!i)return;let s=window.state.userProfile.id;window.state.userProfile.role==="admin"&&e&&(s=e),window._currentWaPhone=t,window._unsubModalChat&&window._unsubModalChat();try{const r=window.dbRef?window.dbRef(window.db||j,`whatsapp/messages/${s}/${t}`):V(j,`whatsapp/messages/${s}/${t}`);window._unsubModalChat=wt(r,o=>{const a=o.val()||{},l=Object.keys(a);if(l.length===0){i.innerHTML='<div style="text-align:center; margin-top:auto; margin-bottom:auto;"><div style="background:rgba(255,255,255,0.95); display:inline-block; padding:15px 30px; border-radius:15px; font-size:13px; color:#555;"><i class="fas fa-comment-dots" style="color:#00a884; font-size:24px; margin-bottom:10px; display:block;"></i>لا توجد رسائل سابقة مع هذا الرقم.<br>يمكنك بدء دردشة جديدة الآن.</div></div>';return}l.sort((u,h)=>a[u].timestamp-a[h].timestamp);let c='<div class="chat-security-hint" style="text-align:center; margin:10px 0;"><span style="background:var(--bg-card); padding:5px 15px; border-radius:10px; font-size:12px; color:var(--text-dim);"><i class="fas fa-lock"></i> محمية في فايربيس</span></div>';l.forEach(u=>{const h=a[u],f=new Date(h.timestamp*1e3).toLocaleTimeString("ar-SA",{hour:"2-digit",minute:"2-digit",timeZone:"Asia/Riyadh"}),p=h.isMe?"me":"them";let _="";h.isMe&&(h.ack<=1?_='<i class="fas fa-check" style="font-size:11px; color:#999;"></i>':h.ack===2?_='<i class="fas fa-check-double" style="font-size:11px; color:#999;"></i>':h.ack>=3&&(_='<i class="fas fa-check-double" style="font-size:11px; color:#53bdeb;"></i>'));let b=(h.body||"").replace(/</g,"&lt;").replace(/>/g,"&gt;");b=b.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" style="color:#027eb5; text-decoration:underline;">$1</a>');let g=`<div>${b}</div>`;h.hasMedia&&(g=`
                        <div id="modal-dl-${h.id}" class="media-dl-box" style="background:rgba(0,0,0,0.05); padding:10px; border-radius:8px; display:flex; align-items:center; gap:10px; margin-bottom:5px;">
                            ...
                            <button class="btn-premium btn-sm" onclick="window.downloadWAMedia('${s}', '${t}', '${h.id}', 'modal-dl-${h.id}', 'unknown', '${h.type}')"><i class="fas fa-download"></i></button>
                        </div>`+g),c+=`
