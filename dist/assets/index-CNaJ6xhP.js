 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xu="FirebaseError";class ke extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=Xu,Object.setPrototypeOf(this,ke.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Tt.prototype.create)}}class Tt{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Zu(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new ke(s,a,i)}}function Zu(t,e){return t.replace(eh,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const eh=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const df="firebase-heartbeat-database",uf=1,Tn="firebase-heartbeat-store";let ps=null;function Sl(){return ps||(ps=kl(df,uf,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Tn)}catch(n){console.warn(n)}}}}).catch(t=>{throw Ze.create("idb-open",{originalErrorMessage:t.message})})),ps}async function hf(t){try{const n=(await Sl()).transaction(Tn),i=await n.objectStore(Tn).get(Cl(t));return await n.done,i}catch(e){if(e instanceof ke)Ue.warn(e.message);else{const n=Ze.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ue.warn(n.message)}}}async function Lo(t,e){try{const i=(await Sl()).transaction(Tn,"readwrite");await i.objectStore(Tn).put(e,Cl(t)),await i.done}catch(n){if(n instanceof ke)Ue.warn(n.message);else{const i=Ze.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ue.warn(i.message)}}}function Cl(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wf(t){Ie(new we("platform-logger",e=>new Rh(e),"PRIVATE")),Ie(new we("heartbeat",e=>new mf(e),"PRIVATE")),ue(js,No,t),ue(js,No,"esm2017"),ue("fire-js","")}wf("");var _f="firebase",vf="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="5",Dl="v",Ml="s",$l="r",Bl="f",Fl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ul="ls",jl="p",Vs="ac",Wl="websocket",zl="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const n of e.values())this.sendListen_(n);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let n="js";e["sdk."+n+"."+Al.replace(/\./g,"-")]=1,mr()?e["framework.cordova"]=1:_l()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=fi.getInstance().currentlyOnline();return Bs(this.interruptReasons_)&&e}}Fe.nextPersistentConnectionId_=0;Fe.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ji{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new P(jt,e),s=new P(jt,n);return this.compare(i,s)!==0}minPost(){return P.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _p(t,e){return xt(t.name,e.name)}function kr(t,e){return xt(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qs;function vp(t){qs=t}const nc=function(t){return typeof t=="number"?"number:"+Ol(t):"string:"+t},ic=function(t){if(t.isLeafNode()){const e=t.val();E(typeof e=="string"||typeof e=="number"||typeof e=="object"&&xe(e,".sv"),"Priority must be a string or number.")}else E(t===qs||t.isEmpty(),"priority of unexpected type.");E(t===qs||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ws;const Pt={};class De{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return E(Pt&&G,"ChildrenNode.ts has not been loaded"),ws=ws||new De({".priority":Pt},{".priority":G}),ws}get(e){const n=pt(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof de?n:null}hasIndex(e){return xe(this.indexSet_,e.toString())}addIndex(e,n){E(e!==Mt,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(P.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=pi(i,e.getCompare()):a=Pt;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const d=Object.assign({},this.indexes_);return d[l]=a,new De(d,c)}addToIndexes(e,n){const i=di(this.indexes_,(s,r)=>{const o=pt(this.indexSet_,r);if(E(o,"Missing index implementation for "+r),s===Pt)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(P.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),pi(a,o.getCompare())}else return Pt;else{const a=n.get(e.name);let l=s;return a&&(l=l.remove(new P(e.name,a))),l.insert(e,e.node)}});return new De(i,this.indexSet_)}removeFromIndexes(e,n){const i=di(this.indexes_,s=>{if(s===Pt)return s;{const r=n.get(e.name);return r?s.remove(new P(e.name,r)):s}});return new De(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pp{constructor(e){this.withinDirectionalStart=n=>this.reverse_?this.withinEndPost(n):this.withinStartPost(n),this.withinDirectionalEnd=n=>this.reverse_?this.withinStartPost(n):this.withinEndPost(n),this.withinStartPost=n=>{const i=this.index_.compare(this.rangedFilter_.getStartPost(),n);return this.startIsInclusive_?i<=0:i<0},this.withinEndPost=n=>{const i=this.index_.compare(n,this.rangedFilter_.getEndPost());return this.endIsInclusive_?i<=0:i<0},this.rangedFilter_=new An(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,n,i,s,r,o){return this.rangedFilter_.matches(new P(n,i))||(i=x.EMPTY_NODE),e.getImmediateChild(n).equals(i)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,n,i,s,r,o):this.fullLimitUpdateChild_(e,n,i,r,o)}updateFullNode(e,n,i){let s;if(n.isLeafNode()||n.isEmpty())s=x.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<n.numChildren()&&n.isIndexed(this.index_)){s=x.EMPTY_NODE.withIndex(this.index_);let r;this.reverse_?r=n.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):r=n.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let o=0;for(;r.hasNext()&&o<this.limit_;){const a=r.getNext();if(this.withinDirectionalStart(a))if(this.withinDirectionalEnd(a))s=s.updateImmediateChild(a.name,a.node),o++;else break;else continue}}else{s=n.withIndex(this.index_),s=s.updatePriority(x.EMPTY_NODE);let r;this.reverse_?r=s.getReverseIterator(this.index_):r=s.getIterator(this.index_);let o=0;for(;r.hasNext();){const a=r.getNext();o<this.limit_&&this.withinDirectionalStart(a)&&this.withinDirectionalEnd(a)?o++:s=s.updateImmediateChild(a.name,x.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,s,i)}updatePriority(e,n){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,n,i,s,r){let o;if(this.reverse_){const u=this.index_.getCompare();o=(h,f)=>u(f,h)}else o=this.index_.getCompare();const a=e;E(a.numChildren()===this.limit_,"");const l=new P(n,i),c=this.reverse_?a.getFirstChild(this.index_):a.getLastChild(this.index_),d=this.rangedFilter_.matches(l);if(a.hasChild(n)){const u=a.getImmediateChild(n);let h=s.getChildAfterChild(this.index_,c,this.reverse_);for(;h!=null&&(h.name===n||a.hasChild(h.name));)h=s.getChildAfterChild(this.index_,h,this.reverse_);const f=h==null?1:o(h,l);if(d&&!i.isEmpty()&&f>=0)return r!=null&&r.trackChildChange(Cn(n,i,u)),a.updateImmediateChild(n,i);{r!=null&&r.trackChildChange(Sn(n,u));const _=a.updateImmediateChild(n,x.EMPTY_NODE);return h!=null&&this.rangedFilter_.matches(h)?(r!=null&&r.trackChildChange(Wt(h.name,h.node)),_.updateImmediateChild(h.name,h.node)):_}}else return i.isEmpty()?e:d&&o(c,l)>=0?(r!=null&&(r.trackChildChange(Sn(c.name,c.node)),r.trackChildChange(Wt(n,i))),a.updateImmediateChild(n,i).updateImmediateChild(c.name,x.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=be.MERGE}operationForChild(e){if(L(this.path)){const n=this.children.subtree(new $(e));return n.isEmpty()?null:n.value?new gt(this.source,D(),n.value):new zt(this.source,D(),n)}else return E(N(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zt(this.source,U(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ei;class yc{constructor(){this.views=new Map}}function bm(t){E(!Ei,"__referenceConstructor has already been defined"),Ei=t}function Em(){return E(Ei,"Reference.ts has not been loaded"),Ei}function Im(t){return t.views.size===0}function Or(t,e,n,i){const s=e.source.queryId;if(s!==null){const r=t.views.get(s);return E(r!=null,"SyncTree gave us an op for an invalid query."),ca(r,e,n,i)}else{let r=[];for(const o of t.views.values())r=r.concat(ca(o,e,n,i));return r}}function wc(t,e,n,i,s){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=_i(n,s?i:null),l=!1;a?l=!0:i instanceof x?(a=Nr(n,i),l=!1):(a=x.EMPTY_NODE,l=!1);const c=Wi(new st(a,l,!1),new st(i,s,!1));return new mm(e,c)}return o}function Tm(t,e,n,i,s,r){const o=wc(t,e,i,s,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),_m(o,n),vm(o,n)}function km(t,e,n,i){const s=e._queryIdentifier,r=[];let o=[];const a=rt(t);if(s==="default")for(const[l,c]of t.views.entries())o=o.concat(la(c,n,i)),aa(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(s);l&&(o=o.concat(la(l,n,i)),aa(l)&&(t.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!rt(t)&&r.push(new(Em())(e._repo,e._path)),{removed:r,events:o}}function _c(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function tt(t,e){let n=null;for(const i of t.views.values())n=n||wm(i,e);return n}function vc(t,e){if(e._queryParams.loadsAllData())return Hi(t);{const i=e._queryIdentifier;return t.views.get(i)}}function bc(t,e){return vc(t,e)!=null}function rt(t){return Hi(t)!=null}function Hi(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ii;function xm(t){E(!Ii,"__referenceConstructor has already been defined"),Ii=t}function Sm(){return E(Ii,"Reference.ts has not been loaded"),Ii}let Cm=1;class da{constructor(e){this.listenProvider_=e,this.syncPointTree_=new F(null),this.pendingWriteTree_=im(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Dr(t,e,n,i,s){return Vp(t.pendingWriteTree_,e,n,i,s),s?Zt(t,new gt(Cr(),e,n)):[]}function Am(t,e,n,i){qp(t.pendingWriteTree_,e,n,i);const s=F.fromObject(n);return Zt(t,new zt(Cr(),e,s))}function Je(t,e,n=!1){const i=Gp(t.pendingWriteTree_,e);if(Kp(t.pendingWriteTree_,e)){let r=new F(null);return i.snap!=null?r=r.set(D(),!0):ie(i.children,o=>{r=r.set(new $(o),!0)}),Zt(t,new yi(i.path,r,n))}else return[]}function Fn(t,e,n){return Zt(t,new gt(Ar(),e,n))}function Rm(t,e,n){const i=F.fromObject(n);return Zt(t,new zt(Ar(),e,i))}function Nm(t,e){return Zt(t,new Rn(Ar(),e))}function Pm(t,e,n){const i=Mr(t,n);if(i){const s=$r(i),r=s.path,o=s.queryId,a=oe(r,e),l=new Rn(Rr(o),a);return Br(t,r,l)}else return[]}function Ti(t,e,n,i,s=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||bc(o,e))){const l=km(o,e,n,i);Im(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(r,(h,f)=>rt(f));if(d&&!u){const h=t.syncPointTree_.subtree(r);if(!h.isEmpty()){const f=Dm(h);for(let p=0;p<f.length;++p){const _=f[p],b=_.query,g=kc(t,_);t.listenProvider_.startListening(yn(b),Nn(t,b),g.hashFn,g.onComplete)}}}!u&&c.length>0&&!i&&(d?t.listenProvider_.stopListening(yn(e),null):c.forEach(h=>{const f=t.queryToTagMap.get(qi(h));t.listenProvider_.stopListening(yn(h),f)}))}Mm(t,c)}return a}function Ec(t,e,n,i){const s=Mr(t,i);if(s!=null){const r=$r(s),o=r.path,a=r.queryId,l=oe(o,e),c=new gt(Rr(a),l,n);return Br(t,o,c)}else return[]}function Lm(t,e,n,i){const s=Mr(t,i);if(s){const r=$r(s),o=r.path,a=r.queryId,l=oe(o,e),c=F.fromObject(n),d=new zt(Rr(a),l,c);return Br(t,o,d)}else return[]}function Zs(t,e,n,i=!1){const s=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(s,(h,f)=>{const p=oe(h,s);r=r||tt(f,p),o=o||rt(f)});let a=t.syncPointTree_.get(s);a?(o=o||rt(a),r=r||tt(a,D())):(a=new yc,t.syncPointTree_=t.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=x.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,p)=>{const _=tt(p,D());_&&(r=r.updateImmediateChild(f,_))}));const c=bc(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=qi(e);E(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=$m();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const d=zi(t.pendingWriteTree_,s);let u=Tm(a,e,n,d,r,l);if(!c&&!o&&!i){const h=vc(a,e);u=u.concat(Bm(t,e,h))}return u}function Vi(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=oe(o,e),c=tt(a,l);if(c)return c});return uc(s,e,r,n,!0)}function Om(t,e){const n=e._path;let i=null;t.syncPointTree_.foreachOnPath(n,(c,d)=>{const u=oe(c,n);i=i||tt(d,u)});let s=t.syncPointTree_.get(n);s?i=i||tt(s,D()):(s=new yc,t.syncPointTree_=t.syncPointTree_.set(n,s));const r=i!=null,o=r?new st(i,!0,!1):null,a=zi(t.pendingWriteTree_,e._path),l=wc(s,e,a,r?o.getNode():x.EMPTY_NODE,r);return ym(l)}function Zt(t,e){return Ic(e,t.syncPointTree_,null,zi(t.pendingWriteTree_,D()))}function Ic(t,e,n,i){if(L(t.path))return Tc(t,e,n,i);{const s=e.get(D());n==null&&s!=null&&(n=tt(s,D()));let r=[];const o=N(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,d=hc(i,o);r=r.concat(Ic(a,l,c,d))}return s&&(r=r.concat(Or(s,t,i,n))),r}}function Tc(t,e,n,i){const s=e.get(D());n==null&&s!=null&&(n=tt(s,D()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=hc(i,o),d=t.operationForChild(o);d&&(r=r.concat(Tc(d,a,l,c)))}),s&&(r=r.concat(Or(s,t,i,n))),r}function kc(t,e){const n=e.query,i=Nn(t,n);return{hashFn:()=>(gm(e)||x.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Pm(t,n._path,i):Nm(t,n._path);{const r=Nf(s,n);return Ti(t,n,null,r)}}}}function Nn(t,e){const n=qi(e);return t.queryToTagMap.get(n)}function qi(t){return t._path.toString()+"$"+t._queryIdentifier}function Mr(t,e){return t.tagToQueryMap.get(e)}function $r(t){const e=t.indexOf("$");return E(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new $(t.substr(0,e))}}function Br(t,e,n){const i=t.syncPointTree_.get(e);E(i,"Missing sync point for query tag that we're tracking");const s=zi(t.pendingWriteTree_,e);return Or(i,n,s,null)}function Dm(t){return t.fold((e,n,i)=>{if(n&&rt(n))return[Hi(n)];{let s=[];return n&&(s=_c(n)),ie(i,(r,o)=>{s=s.concat(o)}),s}})}function yn(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Sm())(t._repo,t._path):t}function Mm(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const s=qi(i),r=t.queryToTagMap.get(s);t.queryToTagMap.delete(s),t.tagToQueryMap.delete(r)}}}function $m(){return Cm++}function Bm(t,e,n){const i=e._path,s=Nn(t,e),r=kc(t,n),o=t.listenProvider_.startListening(yn(e),s,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(i);if(s)E(!rt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!L(c)&&d&&rt(d))return[Hi(d).query];{let h=[];return d&&(h=h.concat(_c(d).map(f=>f.query))),ie(u,(f,p)=>{h=h.concat(p)}),h}});for(let c=0;c<l.length;++c){const d=l[c];t.listenProvider_.stopListening(yn(d),Nn(t,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yr{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return L(this._path)?null:Er(this._path)}get ref(){return new Ne(this._repo,this._path)}get _queryIdentifier(){const e=ea(this._queryParams),n=wr(e);return n==="{}"?"default":n}get _queryObject(){return ea(this._queryParams)}isEqual(e){if(e=q(e),!(e instanceof Yr))return!1;const n=this._repo===e._repo,i=Ir(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+cp(this._path)}}class Ne extends Yr{constructor(e,n){super(e,n,new Sr,!1)}get parent(){const e=Zl(this._path);return e===null?null:new Ne(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class qt{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new $(e),i=Pn(this.ref,e);return new qt(this._node.getChild(n),i,G)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new qt(s,Pn(this.ref,i),G)))}hasChild(e){const n=new $(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function V(t,e){return t=q(t),t._checkNotDeleted("ref"),e!==void 0?Pn(t._root,e):t._root}function Pn(t,e){return t=q(t),N(t._path)===null?Qm("child","path",e):Pc("child","path",e),new Ne(t._repo,K(t._path,e))}function Ln(t,e){t=q(t),Yi("push",t._path),Nc("push",e,t._path,!0);const n=Dc(t._repo),i=yg(n),s=Pn(t,i),r=Pn(t,i);let o;return e!=null?o=ze(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Uc(t){return Yi("remove",t._path),ze(t,null)}function ze(t,e){t=q(t),Yi("set",t._path),Nc("set",e,t._path,!1);const n=new Qt;return og(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function es(t,e){Ym("update",e,t._path);const n=new Qt;return ag(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function vg(t){t=q(t);const e=new Fc(()=>{}),n=new ts(e);return rg(t._repo,t,n).then(i=>new qt(i,new Ne(t._repo,t._path),t._queryParams.getIndex()))}class ts{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new wg("value",this,new qt(e.snapshotNode,new Ne(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new _g(this,e,n):null}matches(e){return e instanceof ts?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function bg(t,e,n,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=n,c=(d,u)=>{pa(t._repo,t,a),l(d,u)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Fc(n,r||void 0),a=new ts(o);return cg(t._repo,t,a),()=>pa(t._repo,t,a)}function wt(t,e,n,i){return bg(t,"value",e,n,i)}bm(Ne);xm(Ne);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ng(t){bf(kt),Ie(new we("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return kg(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),ue($o,Bo,t),ue($o,Bo,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki=new Fi("@firebase/auth");function Og(t,...e){ki.logLevel<=M.WARN&&ki.warn(`Auth (${kt}): ${t}`,...e)}function ni(t,...e){ki.logLevel<=M.ERROR&&ki.error(`Auth (${kt}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,n){this.shortDelay=e,this.longDelay=n,We(n>e,"Short delay should be less than long delay!"),this.isMobile=mr()||_l()}get(){return Mg()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fg=new zn(3e4,6e4);function At(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function at(t,e,n,i,s={}){return Vc(t,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=Jt(Object.assign({key:t.config.apiKey},o)).slice(1),l=await t._getAdditionalHeaders();l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode);const c=Object.assign({method:e,headers:l},r);return Ku()||(c.referrerPolicy="no-referrer"),Hc.fetch()(qc(t,t.config.apiHost,n,a),c)})}async function Vc(t,e,n){t._canInitEmulator=!1;const i=Object.assign(Object.assign({},Bg),e);try{const s=new jg(t),r=await Promise.race([n(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Yn(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Yn(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw Yn(t,"email-already-in-use",o);if(l==="USER_DISABLED")throw Yn(t,"user-disabled",o);const d=i[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw zc(t,d,c);Te(t,d)}}catch(s){if(s instanceof ke)throw s;Te(t,"network-request-failed",{message:String(s)})}}async function ns(t,e,n,i,s={}){const r=await at(t,e,n,i,s);return"mfaPendingCredential"in r&&Te(t,"multi-factor-auth-required",{_serverResponse:r}),r}function qc(t,e,n,i){const s=`${e}${n}?${i}`;return t.config.emulator?Zr(t.config,s):`${t.config.apiScheme}://${s}`}function Ug(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class jg{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,i)=>{this.timer=setTimeout(()=>i(Ae(this.auth,"network-request-failed")),Fg.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Yn(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const s=Ae(t,e,i);return s.customData._tokenResponse=n,s}function wa(t){return t!==void 0&&t.enterprise!==void 0}class Wg{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return Ug(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function zg(t,e){return at(t,"GET","/v2/recaptchaConfig",At(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function On(t,e,n=!1){if(n)return e;try{return await e}catch(i){throw i instanceof ke&&qg(i)&&t.auth.currentUser===t&&await t.auth.signOut(),i}}function qg({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qg(t,e){const n=await Vc(t,{},async()=>{const i=Jt({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=qc(t,s,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Hc.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Jg(t,e){return at(t,"POST","/v2/accounts:revokeToken",At(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const va=new Map;function Be(t){We(t instanceof Function,"Expected a class definition");let e=va.get(t);return e?(We(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,va.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sd(t,e=[]){let n;switch(t){case"Browser":n=Ea(le());break;case"Worker":n=`${Ea(le())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${kt}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ty(t,e={}){return at(t,"GET","/v2/passwordPolicy",At(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wy(t,e){return ns(t,"POST","/v1/accounts:signInWithPassword",At(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _y(t,e){return ns(t,"POST","/v1/accounts:signInWithEmailLink",At(t,e))}async function vy(t,e){return ns(t,"POST","/v1/accounts:signInWithEmailLink",At(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ft(t,e){return ns(t,"POST","/v1/accounts:signInWithIdp",At(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cd(t,e,n=!1){if(Oe(t.app))return Promise.reject(nt(t));const i="signIn",s=await ld(t,i,e),r=await Gt._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function xy(t,e){return cd(tn(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sy(t){const e=tn(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}function Cy(t,e,n){return Oe(t.app)?Promise.reject(nt(t)):xy(q(t),nn.credential(e,n)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Sy(t),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _d{constructor(e,n,i,s,r=!1){this.auth=e,this.resolver=i,this.user=s,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:s,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:i,tenantId:r||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Yy;case"linkViaPopup":case"linkViaRedirect":return Jy;case"reauthViaPopup":case"reauthViaRedirect":return Qy;default:Te(this.auth,"internal-error")}}resolve(e){We(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){We(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bd="firebasestorage.googleapis.com",Ed="storageBucket",Vw=2*60*1e3,qw=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function R_(t,e){return e}class re{constructor(e,n,i,s){this.server=e,this.local=n||e,this.writable=!!i,this.xform=s||R_}}let Jn=null;function N_(t){return!lo(t)||t.length<2?t:Ad(t)}function Rd(){if(Jn)return Jn;const t=[];t.push(new re("bucket")),t.push(new re("generation")),t.push(new re("metageneration")),t.push(new re("name","fullPath",!0));function e(r,o){return N_(o)}const n=new re("name");n.xform=e,t.push(n);function i(r,o){return o!==void 0?Number(o):o}const s=new re("size");return s.xform=i,t.push(s),t.push(new re("timeCreated")),t.push(new re("updated")),t.push(new re("md5Hash",null,!0)),t.push(new re("cacheControl",null,!0)),t.push(new re("contentDisposition",null,!0)),t.push(new re("contentEncoding",null,!0)),t.push(new re("contentLanguage",null,!0)),t.push(new re("contentType",null,!0)),t.push(new re("metadata","customMetadata",!0)),Jn=t,Jn}function P_(t,e){function n(){const i=t.bucket,s=t.fullPath,r=new pe(i,s);return e._makeStorageReference(r)}Object.defineProperty(t,"ref",{get:n})}function L_(t,e,n){const i={};i.type="file";const s=n.length;for(let r=0;r<s;r++){const o=n[r];i[o.local]=o.xform(i,e[o.server])}return P_(i,t),i}function Nd(t,e,n){const i=Cd(e);return i===null?null:L_(t,i,n)}function O_(t,e,n,i){const s=Cd(e);if(s===null||!lo(s.downloadTokens))return null;const r=s.downloadTokens;if(r.length===0)return null;const o=encodeURIComponent;return r.split(",").map(c=>{const d=t.bucket,u=t.fullPath,h="/b/"+o(d)+"/o/"+o(u),f=uo(h,n,i),p=Td({alt:"media",token:c});return f+p})[0]}function D_(t,e){const n={},i=e.length;for(let s=0;s<i;s++){const r=e[s];r.writable&&(n[r.server]=t[r.local])}return JSON.stringify(n)}class Pd{constructor(e,n,i,s){this.url=e,this.method=n,this.handler=i,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(e,n){this._service=e,n instanceof pe?this._location=n:this._location=pe.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new vt(e,n)}get root(){const e=new pe(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Ad(this._location.path)}get storage(){return this._service}get parent(){const e=C_(this._location.path);if(e===null)return null;const n=new pe(this._location.bucket,e);return new vt(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw o_(e)}}function V_(t,e,n){t._throwIfRoot("uploadBytes");const i=W_(t.storage,t._location,Rd(),new Qe(e,!0),n);return t.storage.makeRequestWithTokens(i,Dd).then(s=>({metadata:s,ref:t}))}function q_(t){t._throwIfRoot("getDownloadURL");const e=F_(t.storage,t._location,Rd());return t.storage.makeRequestWithTokens(e,Dd).then(n=>{if(n===null)throw s_();return n})}function G_(t,e){const n=A_(t._location.path,e),i=new pe(t._location.bucket,n);return new vt(t.storage,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d="storage";function X_(t,e,n){return t=q(t),V_(t,e,n)}function Z_(t){return t=q(t),q_(t)}function ev(t,e){return t=q(t),Q_(t,e)}function tv(t=Ui(),e){t=q(t);const i=ot(t,$d).getImmediate({identifier:e}),s=pl("storage");return s&&nv(i,...s),i}function nv(t,e,n,i={}){J_(t,e,n,i)}function iv(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new ho(n,i,s,e,kt)}function sv(){Ie(new we($d,iv,"PUBLIC").setMultipleInstances(!0)),ue(Ua,ja,""),ue(Ua,ja,"esm2017")}sv();const Bd="@firebase/installations",fo="0.6.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zd({projectId:t}){return`${rv}/projects/${t}/installations`}function Hd(t){return{token:t.token,requestStatus:2,expiresIn:uv(t.expiresIn),creationTime:Date.now()}}async function Vd(t,e){const i=(await e.json()).error;return bt.create("request-failed",{requestName:t,serverCode:i.code,serverMessage:i.message,serverStatus:i.status})}function qd({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function dv(t,{refreshToken:e}){const n=qd(t);return n.append("Authorization",hv(e)),n}async function Gd(t){const e=await t();return e.status>=500&&e.status<600?t():e}function uv(t){return Number(t.replace("s","000"))}function hv(t){return`${jd} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fv({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const i=zd(t),s=qd(t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&s.append("x-firebase-client",c)}const o={fid:n,authVersion:jd,appId:t.appId,sdkVersion:Ud},a={method:"POST",headers:s,body:JSON.stringify(o)},l=await Gd(()=>fetch(i,a));if(l.ok){const c=await l.json();return{fid:c.fid||n,registrationStatus:2,refreshToken:c.refreshToken,authToken:Hd(c.authToken)}}else throw await Vd("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd=new Map;function Qd(t,e){const n=os(t);Jd(n,e),wv(n,e)}function Jd(t,e){const n=Yd.get(t);if(n)for(const i of n)i(e)}function wv(t,e){const n=_v();n&&n.postMessage({key:t,fid:e}),vv()}let ht=null;function _v(){return!ht&&"BroadcastChannel"in self&&(ht=new BroadcastChannel("[Firebase] FID Change"),ht.onmessage=t=>{Jd(t.data.key,t.data.fid)}),ht}function vv(){Yd.size===0&&ht&&(ht.close(),ht=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bv="firebase-installations-database",Ev=1,Et="firebase-installations-store";let xs=null;function po(){return xs||(xs=kl(bv,Ev,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Et)}}})),xs}async function Ri(t,e){const n=os(t),s=(await po()).transaction(Et,"readwrite"),r=s.objectStore(Et),o=await r.get(n);return await r.put(e,n),await s.done,(!o||o.fid!==e.fid)&&Qd(t,e.fid),e}async function Xd(t){const e=os(t),i=(await po()).transaction(Et,"readwrite");await i.objectStore(Et).delete(e),await i.done}async function as(t,e){const n=os(t),s=(await po()).transaction(Et,"readwrite"),r=s.objectStore(Et),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await s.done,a&&(!o||o.fid!==a.fid)&&Qd(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function go(t,e=!1){let n;const i=await as(t.appConfig,r=>{if(!eu(r))throw bt.create("not-registered");const o=r.authToken;if(!e&&Pv(o))return r;if(o.requestStatus===1)return n=Rv(t,e),r;{if(!navigator.onLine)throw bt.create("app-offline");const a=Ov(r);return n=Nv(t,a),a}});return n?await n:i.authToken}async function Rv(t,e){let n=await za(t.appConfig);for(;n.authToken.requestStatus===1;)await Kd(100),n=await za(t.appConfig);const i=n.authToken;return i.requestStatus===0?go(t,e):i}function za(t){return as(t,e=>{if(!eu(e))throw bt.create("not-registered");const n=e.authToken;return Dv(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function Nv(t,e){try{const n=await Cv(t,e),i=Object.assign(Object.assign({},e),{authToken:n});return await Ri(t.appConfig,i),n}catch(n){if(Wd(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Xd(t.appConfig);else{const i=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Ri(t.appConfig,i)}throw n}}function eu(t){return t!==void 0&&t.registrationStatus===2}function Pv(t){return t.requestStatus===2&&!Lv(t)}function Lv(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+ov}function Ov(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function Dv(t){return t.requestStatus===1&&t.requestTime+Fd<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tu="installations",Uv="installations-internal",jv=t=>{const e=t.getProvider("app").getImmediate(),n=Fv(e),i=ot(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},Wv=t=>{const e=t.getProvider("app").getImmediate(),n=ot(e,tu).getImmediate();return{getId:()=>Mv(n),getToken:s=>$v(n,s)}};function zv(){Ie(new we(tu,jv,"PUBLIC")),Ie(new we(Uv,Wv,"PRIVATE"))}zv();ue(Bd,fo);ue(Bd,fo,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni="analytics",Hv="firebase_id",Vv="origin",qv=60*1e3,Gv="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",yo="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class gb{constructor(e){this.app=e}_delete(){return delete vn[this.app.options.appId],Promise.resolve()}}let vn={},Ha=[];const Va={};let Cs="dataLayer",yb="gtag",qa,ru,Ga=!1;function wb(){const t=[];if(wl()&&t.push("This is a browser extension environment."),Ju()||t.push("Cookies are not available."),t.length>0){const e=t.map((i,s)=>`(${s+1}) ${i}`).join(" "),n=me.create("invalid-analytics-context",{errorInfo:e});he.warn(n.message)}}function _b(t,e,n){wb();const i=t.options.appId;if(!i)throw me.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)he.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw me.create("no-api-key");if(vn[i]!=null)throw me.create("already-exists",{id:i});if(!Ga){Xv(Cs);const{wrappedGtag:r,gtagCore:o}=nb(vn,Ha,Va,Cs,yb);ru=r,qa=o,Ga=!0}return vn[i]=mb(t,Ha,Va,e,qa,Cs,n),new gb(t)}function vb(t=Ui()){t=q(t);const e=ot(t,Ni);return e.isInitialized()?e.getImmediate():bb(t)}function bb(t,e={}){const n=ot(t,Ni);if(n.isInitialized()){const s=n.getImmediate();if(In(e,n.getOptions()))return s;throw me.create("already-initialized")}return n.initialize({options:e})}function Eb(t,e,n,i){t=q(t),fb(ru,vn[t.app.options.appId],e,n,i).catch(s=>he.error(s))}const Ka="@firebase/analytics",Ya="0.10.8";function Ib(){Ie(new we(Ni,(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return _b(i,s,n)},"PUBLIC")),Ie(new we("analytics-internal",t,"PRIVATE")),ue(Ka,Ya),ue(Ka,Ya,"esm2017");function t(e){try{const n=e.getProvider(Ni).getImmediate();return{logEvent:(i,s,r)=>Eb(n,i,s,r)}}catch(n){throw me.create("interop-component-reg-failed",{reason:n})}}}Ib();const Tb={apiKey:"AIzaSyAhmJ3_2V0OOP26nZOMWMOyTDePiyI01Yk",authDomain:"diar-shahama-1088b.firebaseapp.com",projectId:"diar-shahama-1088b",storageBucket:"diar-shahama-1088b.firebasestorage.app",messagingSenderId:"887214900924",appId:"1:887214900924:web:0a265e755c852f0113b2b9",measurementId:"G-HB41E2SHWR",databaseURL:"https://diar-shahama-1088b-default-rtdb.firebaseio.com"},ls=xl(Tb),j=Ag(ls),Pi=zw(ls),kb=tv(ls);vb(ls);function Xn(t){if(typeof t!="string"||!t)throw new Error("expected a non-empty string, got: "+t)}function As(t){if(typeof t!="number")throw new Error("expected a number, got: "+t)}const xb=1,Sb=1,Rt="emoji",Kt="keyvalue",wo="favorites",Cb="tokens",ou="tokens",Ab="unicode",au="count",Rb="group",Nb="order",lu="group-order",lr="eTag",Li="url",Qa="skinTone",sn="readonly",_o="readwrite",cu="skinUnicodes",Pb="skinUnicodes",Lb="https://cdn.jsdelivr.net/npm/emoji-picker-element-data@^1/en/emojibase/data.json",Ob="en";function Db(t,e){const n=new Set,i=[];for(const s of t){const r=e(s);n.has(r)||(n.add(r),i.push(s))}return i}function Ja(t){return Db(t,e=>e.unicode)}function Mb(t){function e(n,i,s){const r=i?t.createObjectStore(n,{keyPath:i}):t.createObjectStore(n);if(s)for(const[o,[a,l]]of Object.entries(s))r.createIndex(o,a,{multiEntry:l});return r}e(Kt),e(Rt,Ab,{[ou]:[Cb,!0],[lu]:[[Rb,Nb]],[cu]:[Pb,!0]}),e(wo,void 0,{[au]:[""]})}const cr={},oi={},Oi={};function du(t,e,n){n.onerror=()=>e(n.error),n.onblocked=()=>e(new Error("IDB blocked")),n.onsuccess=()=>t(n.result)}async function $b(t){const e=await new Promise((n,i)=>{const s=indexedDB.open(t,xb);cr[t]=s,s.onupgradeneeded=r=>{r.oldVersion<Sb&&Mb(s.result)},du(n,i,s)});return e.onclose=()=>vo(t),e}function Bb(t){return oi[t]||(oi[t]=$b(t)),oi[t]}function He(t,e,n,i){return new Promise((s,r)=>{const o=t.transaction(e,n,{durability:"relaxed"}),a=typeof e=="string"?o.objectStore(e):e.map(c=>o.objectStore(c));let l;i(a,o,c=>{l=c}),o.oncomplete=()=>s(l),o.onerror=()=>r(o.error)})}function vo(t){const e=cr[t],n=e&&e.result;if(n){n.close();const i=Oi[t];if(i)for(const s of i)s()}delete cr[t],delete oi[t],delete Oi[t]}function Fb(t){return new Promise((e,n)=>{vo(t);const i=indexedDB.deleteDatabase(t);du(e,n,i)})}function Ub(t,e){let n=Oi[t];n||(n=Oi[t]=[]),n.push(e)}const jb=new Set([":D","XD",":'D","O:)",":X",":P",";P","XP",":L",":Z",":j","8D","XO","8)",":B",":O",":S",":'o","Dx","X(","D:",":C",">0)",":3","</3","<3","\\M/",":E","8#"]);function Ut(t){return t.split(/[\s_]+/).map(e=>!e.match(/\w/)||jb.has(e)?e.toLowerCase():e.replace(/[)(:,]/g,"").replace(/’/g,"'").toLowerCase()).filter(Boolean)}const Wb=2;function uu(t){return t.filter(Boolean).map(e=>e.toLowerCase()).filter(e=>e.length>=Wb)}function zb(t){return t.map(({annotation:n,emoticon:i,group:s,order:r,shortcodes:o,skins:a,tags:l,emoji:c,version:d})=>{const u=[...new Set(uu([...(o||[]).map(Ut).flat(),...(l||[]).map(Ut).flat(),...Ut(n),i]))].sort(),h={annotation:n,group:s,order:r,tags:l,tokens:u,unicode:c,version:d};if(i&&(h.emoticon=i),o&&(h.shortcodes=o),a){h.skinTones=[],h.skinUnicodes=[],h.skinVersions=[];for(const{tone:f,emoji:p,version:_}of a)h.skinTones.push(f),h.skinUnicodes.push(p),h.skinVersions.push(_)}return h})}function hu(t,e,n,i){t[e](n).onsuccess=s=>i&&i(s.target.result)}function It(t,e,n){hu(t,"get",e,n)}function fu(t,e,n){hu(t,"getAll",e,n)}function bo(t){t.commit&&t.commit()}function Hb(t,e){let n=t[0];for(let i=1;i<t.length;i++){const s=t[i];e(n)>e(s)&&(n=s)}return n}function pu(t,e){const n=Hb(t,s=>s.length),i=[];for(const s of n)t.some(r=>r.findIndex(o=>e(o)===e(s))===-1)||i.push(s);return i}async function Vb(t){return!await Eo(t,Kt,Li)}async function qb(t,e,n){const[i,s]=await Promise.all([lr,Li].map(r=>Eo(t,Kt,r)));return i===n&&s===e}async function Gb(t,e){return He(t,Rt,sn,(i,s,r)=>{let o;const a=()=>{i.getAll(o&&IDBKeyRange.lowerBound(o,!0),50).onsuccess=l=>{const c=l.target.result;for(const d of c)if(o=d.unicode,e(d))return r(d);if(c.length<50)return r();a()}};a()})}async function mu(t,e,n,i){try{const s=zb(e);await He(t,[Rt,Kt],_o,([r,o],a)=>{let l,c,d=0;function u(){++d===2&&h()}function h(){if(!(l===i&&c===n)){r.clear();for(const f of s)r.put(f);o.put(i,lr),o.put(n,Li),bo(a)}}It(o,lr,f=>{l=f,u()}),It(o,Li,f=>{c=f,u()})})}finally{}}async function Kb(t,e){return He(t,Rt,sn,(n,i,s)=>{const r=IDBKeyRange.bound([e,0],[e+1,0],!1,!0);fu(n.index(lu),r,s)})}async function gu(t,e){const n=uu(Ut(e));return n.length?He(t,Rt,sn,(i,s,r)=>{const o=[],a=()=>{o.length===n.length&&l()},l=()=>{const c=pu(o,d=>d.unicode);r(c.sort((d,u)=>d.order<u.order?-1:1))};for(let c=0;c<n.length;c++){const d=n[c],u=c===n.length-1?IDBKeyRange.bound(d,d+"￿",!1,!0):IDBKeyRange.only(d);fu(i.index(ou),u,h=>{o.push(h),a()})}}):[]}async function Yb(t,e){const n=await gu(t,e);return n.length?n.filter(i=>(i.shortcodes||[]).map(r=>r.toLowerCase()).includes(e.toLowerCase()))[0]||null:await Gb(t,s=>(s.shortcodes||[]).includes(e.toLowerCase()))||null}async function Qb(t,e){return He(t,Rt,sn,(n,i,s)=>It(n,e,r=>{if(r)return s(r);It(n.index(cu),e,o=>s(o||null))}))}function Eo(t,e,n){return He(t,e,sn,(i,s,r)=>It(i,n,r))}function Jb(t,e,n,i){return He(t,e,_o,(s,r)=>{s.put(i,n),bo(r)})}function Xb(t,e){return He(t,wo,_o,(n,i)=>It(n,e,s=>{n.put((s||0)+1,e),bo(i)}))}function Zb(t,e,n){return n===0?[]:He(t,[wo,Rt],sn,([i,s],r,o)=>{const a=[];i.index(au).openCursor(void 0,"prev").onsuccess=l=>{const c=l.target.result;if(!c)return o(a);function d(f){if(a.push(f),a.length===n)return o(a);c.continue()}const u=c.primaryKey,h=e.byName(u);if(h)return d(h);It(s,u,f=>{if(f)return d(f);c.continue()})}})}const Zn="";function eE(t,e){const n=new Map;for(const s of t){const r=e(s);for(const o of r){let a=n;for(let c=0;c<o.length;c++){const d=o.charAt(c);let u=a.get(d);u||(u=new Map,a.set(d,u)),a=u}let l=a.get(Zn);l||(l=[],a.set(Zn,l)),l.push(s)}}return(s,r)=>{let o=n;for(let c=0;c<s.length;c++){const d=s.charAt(c),u=o.get(d);if(u)o=u;else return[]}if(r)return o.get(Zn)||[];const a=[],l=[o];for(;l.length;){const d=[...l.shift().entries()].sort((u,h)=>u[0]<h[0]?-1:1);for(const[u,h]of d)u===Zn?a.push(...h):l.push(h)}return a}}const tE=["name","url"];function nE(t){const e=t&&Array.isArray(t),n=e&&t.length&&(!t[0]||tE.some(i=>!(i in t[0])));if(!e||n)throw new Error("Custom emojis are in the wrong format")}function Xa(t){nE(t);const e=(h,f)=>h.name.toLowerCase()<f.name.toLowerCase()?-1:1,n=t.sort(e),s=eE(t,h=>{const f=new Set;if(h.shortcodes)for(const p of h.shortcodes)for(const _ of Ut(p))f.add(_);return f}),r=h=>s(h,!0),o=h=>s(h,!1),a=h=>{const f=Ut(h),p=f.map((_,b)=>(b<f.length-1?r:o)(_));return pu(p,_=>_.name).sort(e)},l=new Map,c=new Map;for(const h of t){c.set(h.name.toLowerCase(),h);for(const f of h.shortcodes||[])l.set(f.toLowerCase(),h)}return{all:n,search:a,byShortcode:h=>l.get(h.toLowerCase()),byName:h=>c.get(h.toLowerCase())}}const iE=typeof wrappedJSObject<"u";function dn(t){if(!t)return t;if(iE&&(t=structuredClone(t)),delete t.tokens,t.skinTones){const e=t.skinTones.length;t.skins=Array(e);for(let n=0;n<e;n++)t.skins[n]={tone:t.skinTones[n],unicode:t.skinUnicodes[n],version:t.skinVersions[n]};delete t.skinTones,delete t.skinUnicodes,delete t.skinVersions}return t}function yu(t){t||console.warn("emoji-picker-element is more efficient if the dataSource server exposes an ETag header.")}const sE=["annotation","emoji","group","order","version"];function rE(t){if(!t||!Array.isArray(t)||!t[0]||typeof t[0]!="object"||sE.some(e=>!(e in t[0])))throw new Error("Emoji data is in the wrong format")}function wu(t,e){if(Math.floor(t.status/100)!==2)throw new Error("Failed to fetch: "+e+":  "+t.status)}async function oE(t){const e=await fetch(t,{method:"HEAD"});wu(e,t);const n=e.headers.get("etag");return yu(n),n}async function dr(t){const e=await fetch(t);wu(e,t);const n=e.headers.get("etag");yu(n);const i=await e.json();return rE(i),[n,i]}function aE(t){for(var e="",n=new Uint8Array(t),i=n.byteLength,s=-1;++s<i;)e+=String.fromCharCode(n[s]);return e}function lE(t){for(var e=t.length,n=new ArrayBuffer(e),i=new Uint8Array(n),s=-1;++s<e;)i[s]=t.charCodeAt(s);return n}async function _u(t){const e=JSON.stringify(t);let n=lE(e);const i=await crypto.subtle.digest("SHA-1",n),s=aE(i);return btoa(s)}async function cE(t,e){let n,i=await oE(e);if(!i){const s=await dr(e);i=s[0],n=s[1],i||(i=await _u(n))}await qb(t,e,i)||(n||(n=(await dr(e))[1]),await mu(t,n,e,i))}async function dE(t,e){let[n,i]=await dr(e);n||(n=await _u(i)),await mu(t,i,e,n)}async function uE(t,e){try{await cE(t,e)}catch(n){if(n.name!=="InvalidStateError")throw n}}class hE{constructor({dataSource:e=Lb,locale:n=Ob,customEmoji:i=[]}={}){this.dataSource=e,this.locale=n,this._dbName=`emoji-picker-element-${this.locale}`,this._db=void 0,this._lazyUpdate=void 0,this._custom=Xa(i),this._clear=this._clear.bind(this),this._ready=this._init()}async _init(){const e=this._db=await Bb(this._dbName);Ub(this._dbName,this._clear);const n=this.dataSource;await Vb(e)?await dE(e,n):this._lazyUpdate=uE(e,n)}async ready(){const e=async()=>(this._ready||(this._ready=this._init()),this._ready);await e(),this._db||await e()}async getEmojiByGroup(e){return As(e),await this.ready(),Ja(await Kb(this._db,e)).map(dn)}async getEmojiBySearchQuery(e){Xn(e),await this.ready();const n=this._custom.search(e),i=Ja(await gu(this._db,e)).map(dn);return[...n,...i]}async getEmojiByShortcode(e){Xn(e),await this.ready();const n=this._custom.byShortcode(e);return n||dn(await Yb(this._db,e))}async getEmojiByUnicodeOrName(e){Xn(e),await this.ready();const n=this._custom.byName(e);return n||dn(await Qb(this._db,e))}async getPreferredSkinTone(){return await this.ready(),await Eo(this._db,Kt,Qa)||0}async setPreferredSkinTone(e){return As(e),await this.ready(),Jb(this._db,Kt,Qa,e)}async incrementFavoriteEmojiCount(e){return Xn(e),await this.ready(),Xb(this._db,e)}async getTopFavoriteEmoji(e){return As(e),await this.ready(),(await Zb(this._db,this._custom,e)).map(dn)}set customEmoji(e){this._custom=Xa(e)}get customEmoji(){return this._custom.all}async _shutdown(){await this.ready();try{await this._lazyUpdate}catch{}}_clear(){this._db=this._ready=this._lazyUpdate=void 0}async close(){await this._shutdown(),await vo(this._dbName)}async delete(){await this._shutdown(),await Fb(this._dbName)}}const ur=[[-1,"✨","custom"],[0,"😀","smileys-emotion"],[1,"👋","people-body"],[3,"🐱","animals-nature"],[4,"🍎","food-drink"],[5,"🏠️","travel-places"],[6,"⚽","activities"],[7,"📝","objects"],[8,"⛔️","symbols"],[9,"🏁","flags"]].map(([t,e,n])=>({id:t,emoji:e,name:n})),Rs=ur.slice(1),fE=2,Za=6,vu=typeof requestIdleCallback=="function"?requestIdleCallback:setTimeout;function el(t){return t.unicode.includes("‍")}const pE={"🫪":17,"🫩":16,"🫨":15.1,"🫠":14,"🥲":13.1,"🥻":12.1,"🥰":11,"🤩":5,"👱‍♀️":4,"🤣":3,"👁️‍🗨️":2,"😀":1,"😐️":.7,"😃":.6},mE=1e3,gE="🖐️",yE=8,wE=["😊","😒","❤️","👍️","😍","😂","😭","☺️","😔","😩","😏","💕","🙌","😘"],bu='"Twemoji Mozilla","Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji","EmojiOne Color","Android Emoji",sans-serif',_E=(t,e)=>t<e?-1:t>e?1:0,tl=(t,e)=>{const n=document.createElement("canvas");n.width=n.height=1;const i=n.getContext("2d",{willReadFrequently:!0});return i.textBaseline="top",i.font=`100px ${bu}`,i.fillStyle=e,i.scale(.01,.01),i.fillText(t,0,0),i.getImageData(0,0,1,1).data},vE=(t,e)=>{const n=[...t].join(","),i=[...e].join(",");return n===i&&!n.startsWith("0,0,0,")};function bE(t){const e=tl(t,"#000"),n=tl(t,"#fff");return e&&n&&vE(e,n)}function EE(){const t=Object.entries(pE);try{for(const[e,n]of t)if(bE(e))return n}catch{}finally{}return t[0][1]}let Ns;const Ps=()=>(Ns||(Ns=new Promise(t=>vu(()=>t(EE())))),Ns),hr=new Map,IE="️",TE="\uD83C",kE="‍",xE=127995,SE=57339;function CE(t,e){if(e===0)return t;const n=t.indexOf(kE);return n!==-1?t.substring(0,n)+String.fromCodePoint(xE+e-1)+t.substring(n):(t.endsWith(IE)&&(t=t.substring(0,t.length-1)),t+TE+String.fromCodePoint(SE+e-1))}function Se(t){t.preventDefault(),t.stopPropagation()}function Ls(t,e,n){return e+=t?-1:1,e<0?e=n.length-1:e>=n.length&&(e=0),e}function Eu(t,e){const n=new Set,i=[];for(const s of t){const r=e(s);n.has(r)||(n.add(r),i.push(s))}return i}function AE(t,e){const n=i=>{const s={};for(const r of i)typeof r.tone=="number"&&r.version<=e&&(s[r.tone]=r.unicode);return s};return t.map(({unicode:i,skins:s,shortcodes:r,url:o,name:a,category:l,annotation:c})=>({unicode:i,name:a,shortcodes:r,url:o,category:l,annotation:c,id:i||a,skins:s&&n(s)}))}const ai=requestAnimationFrame;let RE=typeof ResizeObserver=="function";function NE(t,e,n){let i;RE?(i=new ResizeObserver(n),i.observe(t)):ai(n),e.addEventListener("abort",()=>{i&&i.disconnect()})}function nl(t){{const e=document.createRange();return e.selectNode(t.firstChild),e.getBoundingClientRect().width}}const PE="😀";let Os,lt;function il(t,e,n){const i=nl(e);if(!i){if(!lt){lt=n.cloneNode(!0);const s=getComputedStyle(n);for(const r of["font-family","line-height","width","height","font-size","display","align-items","justify-content"])lt.style.setProperty(r,s.getPropertyValue(r),"important")}try{return document.body.appendChild(lt),lt.firstChild.nodeValue=t,nl(lt)}finally{lt.remove()}}return i}function LE(t,e,n){let i=!0;for(const s of t){const r=n(s);if(!r)continue;typeof Os>"u"&&(Os=il(PE,e,e));const a=il(s.unicode,r,e)/1.8<Os;hr.set(s.unicode,a),a||(i=!1)}return i}function OE(t){return Eu(t,e=>e)}function DE(t){t&&(t.scrollTop=0)}function bn(t,e,n){let i=t.get(e);return i||(i=n(),t.set(e,i)),i}function sl(t){return""+t}function ME(t){const e=document.createElement("template");return e.innerHTML=t,e}const $E=new WeakMap,BE=new WeakMap,FE=Symbol("un-keyed"),UE="replaceChildren"in Element.prototype;function jE(t,e){UE?t.replaceChildren(...e):(t.innerHTML="",t.append(...e))}function WE(t,e){let n=t.firstChild,i=0;for(;n;){if(e[i]!==n)return!0;n=n.nextSibling,i++}return i!==e.length}function zE(t,e){const{targetNode:n}=e;let{targetParentNode:i}=e,s=!1;i?s=WE(i,t):(s=!0,e.targetNode=void 0,e.targetParentNode=i=n.parentNode),s&&jE(i,t)}function HE(t,e){for(const n of e){const{targetNode:i,currentExpression:s,binding:{expressionIndex:r,attributeName:o,attributeValuePre:a,attributeValuePost:l}}=n,c=t[r];if(s!==c)if(n.currentExpression=c,o)if(c===null)i.removeAttribute(o);else{const d=a+sl(c)+l;i.setAttribute(o,d)}else{let d;Array.isArray(c)?zE(c,n):c instanceof Element?(d=c,i.replaceWith(d)):i.nodeValue=sl(c),d&&(n.targetNode=d)}}}function VE(t){let e="",n=!1,i=!1,s=-1;const r=new Map,o=[];let a=0;for(let c=0,d=t.length;c<d;c++){const u=t[c];if(e+=u.slice(a),c===d-1)break;for(let m=0;m<u.length;m++)switch(u.charAt(m)){case"<":{u.charAt(m+1)==="/"?o.pop():(n=!0,o.push(++s));break}case">":{n=!1,i=!1;break}case"=":{i=!0;break}}const h=o[o.length-1],f=bn(r,h,()=>[]);let p,_,b;if(i){const m=/(\S+)="?([^"=]*)$/.exec(u);p=m[1],_=m[2];const w=/^([^">]*)("?)/.exec(t[c+1]);b=w[1],e=e.slice(0,-1*m[0].length),a=w[0].length}else a=0;const g={attributeName:p,attributeValuePre:_,attributeValuePost:b,expressionIndex:c};f.push(g),!n&&!i&&(e+=" ")}return{template:ME(e),elementsToBindings:r}}function rl(t,e,n){for(let i=0;i<t.length;i++){const s=t[i],r=s.attributeName?e:e.firstChild,o={binding:s,targetNode:r,targetParentNode:void 0,currentExpression:void 0};n.push(o)}}function qE(t,e){const n=[];let i;if(e.size===1&&(i=e.get(0)))rl(i,t,n);else{const s=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT);let r=t,o=-1;do{const a=e.get(++o);a&&rl(a,r,n)}while(r=s.nextNode())}return n}function GE(t){const{template:e,elementsToBindings:n}=bn($E,t,()=>VE(t)),i=e.cloneNode(!0).content.firstElementChild,s=qE(i,n);return function(o){return HE(o,s),i}}function KE(t){const e=bn(BE,t,()=>new Map);let n=FE;function i(r,...o){const a=bn(e,r,()=>new Map);return bn(a,n,()=>GE(r))(o)}function s(r,o,a){return r.map((l,c)=>{const d=n;n=a(l);try{return o(l,c)}finally{n=d}})}return{map:s,html:i}}function YE(t,e,n,i,s,r,o,a,l){const{labelWithSkin:c,titleForEmoji:d,unicodeWithSkin:u}=n,{html:h,map:f}=KE(e);function p(m,w,v){return f(m,(T,k)=>h`<button role="${w?"option":"menuitem"}" aria-selected="${w?k===e.activeSearchItem:null}" aria-label="${c(T,e.currentSkinTone)}" title="${d(T)}" class="${"emoji"+(w&&k===e.activeSearchItem?" active":"")+(T.unicode?"":" custom-emoji")}" id="${`${v}-${T.id}`}" style="${T.unicode?null:`--custom-emoji-background: url(${JSON.stringify(T.url)})`}">${T.unicode?u(T,e.currentSkinTone):""}</button>`,T=>`${v}-${T.id}`)}const b=h`<section data-ref="rootElement" class="picker" aria-label="${e.i18n.regionLabel}" style="${e.pickerStyle||""}"><div class="pad-top"></div><div class="search-row"><div class="search-wrapper"><input id="search" class="search" type="search" role="combobox" enterkeyhint="search" placeholder="${e.i18n.searchLabel}" autocapitalize="none" autocomplete="off" spellcheck="true" aria-expanded="${!!(e.searchMode&&e.currentEmojis.length)}" aria-controls="search-results" aria-describedby="search-description" aria-autocomplete="list" aria-activedescendant="${e.activeSearchItemId?`emo-${e.activeSearchItemId}`:null}" data-ref="searchElement" data-on-input="onSearchInput" data-on-keydown="onSearchKeydown"><label class="sr-only" for="search">${e.i18n.searchLabel}</label> <span id="search-description" class="sr-only">${e.i18n.searchDescription}</span></div><div class="skintone-button-wrapper ${e.skinTonePickerExpandedAfterAnimation?"expanded":""}"><button id="skintone-button" class="emoji ${e.skinTonePickerExpanded?"hide-focus":""}" aria-label="${e.skinToneButtonLabel}" title="${e.skinToneButtonLabel}" aria-describedby="skintone-description" aria-haspopup="listbox" aria-expanded="${e.skinTonePickerExpanded}" aria-controls="skintone-list" data-on-click="onClickSkinToneButton">${e.skinToneButtonText||""}</button></div><span id="skintone-description" class="sr-only">${e.i18n.skinToneDescription}</span><div data-ref="skinToneDropdown" id="skintone-list" class="skintone-list hide-focus ${e.skinTonePickerExpanded?"":"hidden no-animate"}" style="transform:translateY(${e.skinTonePickerExpanded?0:"calc(-1 * var(--num-skintones) * var(--total-emoji-size))"})" role="listbox" aria-label="${e.i18n.skinTonesLabel}" aria-activedescendant="skintone-${e.activeSkinTone}" aria-hidden="${!e.skinTonePickerExpanded}" tabIndex="-1" data-on-focusout="onSkinToneOptionsFocusOut" data-on-click="onSkinToneOptionsClick" data-on-keydown="onSkinToneOptionsKeydown" data-on-keyup="onSkinToneOptionsKeyup">${f(e.skinTones,(m,w)=>h`<div id="skintone-${w}" class="emoji ${w===e.activeSkinTone?"active":""}" aria-selected="${w===e.activeSkinTone}" role="option" title="${e.i18n.skinTones[w]}" aria-label="${e.i18n.skinTones[w]}">${m}</div>`,m=>m)}</div></div><div class="nav" role="tablist" style="grid-template-columns:repeat(${e.groups.length},1fr)" aria-label="${e.i18n.categoriesLabel}" data-on-keydown="onNavKeydown" data-on-click="onNavClick">${f(e.groups,m=>h`<button role="tab" class="nav-button" aria-controls="tab-${m.id}" aria-label="${e.i18n.categories[m.name]}" aria-selected="${!e.searchMode&&e.currentGroup.id===m.id}" title="${e.i18n.categories[m.name]}" data-group-id="${m.id}"><div class="nav-emoji emoji">${m.emoji}</div></button>`,m=>m.id)}</div><div class="indicator-wrapper"><div class="indicator" style="transform:translateX(${(e.isRtl?-1:1)*e.currentGroupIndex*100}%)"></div></div><div class="message ${e.message?"":"gone"}" role="alert" aria-live="polite">${e.message||""}</div><div data-ref="tabpanelElement" class="tabpanel ${!e.databaseLoaded||e.message?"gone":""}" role="${e.searchMode?"region":"tabpanel"}" aria-label="${e.searchMode?e.i18n.searchResultsLabel:e.i18n.categories[e.currentGroup.name]}" id="${e.searchMode?null:`tab-${e.currentGroup.id}`}" tabIndex="0" data-on-click="onEmojiClick"><div data-action="calculateEmojiGridStyle">${f(e.currentEmojisWithCategories,(m,w)=>h`<div><div id="menu-label-${w}" class="category ${e.currentEmojisWithCategories.length===1&&e.currentEmojisWithCategories[0].category===""?"gone":""}" aria-hidden="true">${e.searchMode?e.i18n.searchResultsLabel:m.category?m.category:e.currentEmojisWithCategories.length>1?e.i18n.categories.custom:e.i18n.categories[e.currentGroup.name]}</div><div class="emoji-menu ${w!==0&&!e.searchMode&&e.currentGroup.id===-1?"visibility-auto":""}" style="${`--num-rows: ${Math.ceil(m.emojis.length/e.numColumns)}`}" data-action="updateOnIntersection" role="${e.searchMode?"listbox":"menu"}" aria-labelledby="menu-label-${w}" id="${e.searchMode?"search-results":null}">${p(m.emojis,e.searchMode,"emo")}</div></div>`,m=>m.category)}</div></div><div class="favorites onscreen emoji-menu ${e.message?"gone":""}" role="menu" aria-label="${e.i18n.favoritesLabel}" data-on-click="onEmojiClick">${p(e.currentFavorites,!1,"fav")}</div><button data-ref="baselineEmoji" aria-hidden="true" tabindex="-1" class="abs-pos hidden emoji baseline-emoji">😀</button></section>`,g=(m,w)=>{for(const v of t.querySelectorAll(`[${m}]`))w(v,v.getAttribute(m))};if(l){t.appendChild(b);for(const m of["click","focusout","input","keydown","keyup"])g(`data-on-${m}`,(w,v)=>{w.addEventListener(m,i[v])});g("data-ref",(m,w)=>{r[w]=m}),o.addEventListener("abort",()=>{t.removeChild(b)})}g("data-action",(m,w)=>{let v=a.get(w);v||a.set(w,v=new WeakSet),v.has(m)||(v.add(m),s[w](m))})}const Di=typeof queueMicrotask=="function"?queueMicrotask:t=>Promise.resolve().then(t);function QE(t){let e=!1,n;const i=new Map,s=new Set;let r;const o=()=>{if(e)return;const c=[...s];s.clear();try{for(const d of c)d()}finally{r=!1,s.size&&(r=!0,Di(o))}},a=new Proxy({},{get(c,d){if(n){let u=i.get(d);u||(u=new Set,i.set(d,u)),u.add(n)}return c[d]},set(c,d,u){if(c[d]!==u){c[d]=u;const h=i.get(d);if(h){for(const f of h)s.add(f);r||(r=!0,Di(o))}}return!0}}),l=c=>{const d=()=>{const u=n;n=d;try{return c()}finally{n=u}};return d()};return t.addEventListener("abort",()=>{e=!0}),{state:a,createEffect:l}}function Ds(t,e,n){if(t.length!==e.length)return!1;for(let i=0;i<t.length;i++)if(!n(t[i],e[i]))return!1;return!0}const ol=new WeakMap;function JE(t,e,n){{const i=t.closest(".tabpanel");let s=ol.get(i);s||(s=new IntersectionObserver(n,{root:i,rootMargin:"50% 0px 50% 0px",threshold:0}),ol.set(i,s),e.addEventListener("abort",()=>{s.disconnect()})),s.observe(t)}}const Ms=[],{assign:ei}=Object;function XE(t,e){const n={},i=new AbortController,s=i.signal,{state:r,createEffect:o}=QE(s),a=new Map;ei(r,{skinToneEmoji:void 0,i18n:void 0,database:void 0,customEmoji:void 0,customCategorySorting:void 0,emojiVersion:void 0}),ei(r,e),ei(r,{initialLoad:!0,currentEmojis:[],currentEmojisWithCategories:[],rawSearchText:"",searchText:"",searchMode:!1,activeSearchItem:-1,message:void 0,skinTonePickerExpanded:!1,skinTonePickerExpandedAfterAnimation:!1,currentSkinTone:0,activeSkinTone:0,skinToneButtonText:void 0,pickerStyle:void 0,skinToneButtonLabel:"",skinTones:[],currentFavorites:[],defaultFavoriteEmojis:void 0,numColumns:yE,isRtl:!1,currentGroupIndex:0,groups:Rs,databaseLoaded:!1,activeSearchItemId:void 0}),o(()=>{r.currentGroup!==r.groups[r.currentGroupIndex]&&(r.currentGroup=r.groups[r.currentGroupIndex])});const l=y=>{t.getElementById(y).focus()},c=y=>t.getElementById(`emo-${y.id}`),d=(y,I)=>{n.rootElement.dispatchEvent(new CustomEvent(y,{detail:I,bubbles:!0,composed:!0}))},u=(y,I)=>y.id===I.id,h=(y,I)=>{const{category:A,emojis:O}=y,{category:te,emojis:se}=I;return A!==te?!1:Ds(O,se,u)},f=y=>{Ds(r.currentEmojis,y,u)||(r.currentEmojis=y)},p=y=>{r.searchMode!==y&&(r.searchMode=y)},_=y=>{Ds(r.currentEmojisWithCategories,y,h)||(r.currentEmojisWithCategories=y)},b=(y,I)=>I&&y.skins&&y.skins[I]||y.unicode,w={labelWithSkin:(y,I)=>OE([y.name||b(y,I),y.annotation,...y.shortcodes||Ms].filter(Boolean)).join(", "),titleForEmoji:y=>y.annotation||(y.shortcodes||Ms).join(", "),unicodeWithSkin:b},v={onClickSkinToneButton:Du,onEmojiClick:Lu,onNavClick:Ru,onNavKeydown:Nu,onSearchKeydown:Au,onSkinToneOptionsClick:Ou,onSkinToneOptionsFocusOut:Bu,onSkinToneOptionsKeydown:Mu,onSkinToneOptionsKeyup:$u,onSearchInput:Fu},T={calculateEmojiGridStyle:S,updateOnIntersection:B};let k=!0;o(()=>{YE(t,r,w,v,T,n,s,a,k),k=!1}),r.emojiVersion||Ps().then(y=>{y||(r.message=r.i18n.emojiUnsupportedMessage)}),o(()=>{async function y(){let I=!1;const A=setTimeout(()=>{I=!0,r.message=r.i18n.loadingMessage},mE);try{await r.database.ready(),r.databaseLoaded=!0}catch(O){console.error(O),r.message=r.i18n.networkErrorMessage}finally{clearTimeout(A),I&&(I=!1,r.message="")}}r.database&&y()}),o(()=>{r.pickerStyle=`
  ...
  `,o=document.getElementById("details-modal-body");if(o){o.innerHTML=r,o.scrollTop=0;const l=document.getElementById("details-modal");l&&(l.scrollTop=0),window.openModal("details-modal"),setTimeout(()=>{window.fetchServerWAChat&&window.fetchServerWAChat(e.phone,e.assignedTo||""),window.updateSubStatusOptions&&window.updateSubStatusOptions(e.status||"new",e.subStatus||"not_contacted"),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();const c=document.querySelector("emoji-picker");c&&c.addEventListener("emoji-click",d=>{const u=document.getElementById("wa-modal-input");u&&(u.value+=d.detail.unicode,u.focus())})},100)}};window._chatPollInterval=null;window.startChatPolling=function(t,e){};window.copyMessage=function(t){navigator.clipboard.writeText(t).then(()=>{window.showLuxuryToast("تم نسخ النص بنجاح","success")})};window.updateSubStatusOptions=function(t,e=null){const n=document.getElementById("update-booking-substatus");if(!n)return;const s={new:[{v:"not_contacted",t:"لم يتم التواصل"},{v:"contacted",t:"تم التواصل"}],waiting:[{v:"docs_received",t:"تم استلام الاوراق"},{v:"waiting_calc",t:"انتظار رد العميل"},{v:"waiting_docs",t:"إنتظار إكمال الاوراق"},{v:"waiting_signature",t:"إنتظار توقيع العميل"}],inquiry:[{v:"docs_not_received",t:"لم يتم استلام الاوراق"}],sold:[{v:"signed",t:"تم التوقيع"},{v:"delivered",t:"تم التسليم"}],rejected:[{v:"no_response",t:"لم يتم رد العميل"},{v:"obligations",t:"التزامات"},{v:"calc_rejected",t:"رفض الحسبة"},{v:"ineligible",t:"غير مسموح له"},{v:"duplicate",t:"مكرر"}]}[t]||[{v:"none",t:"-"}];n.innerHTML=s.map(r=>`<option value="${r.v}" ${r.v===e?"selected":""}>${r.t}</option>`).join("")};window.updateBookingQuickStatus=async function(t){var s,r,o;const e=(s=document.getElementById("update-booking-status"))==null?void 0:s.value,n=((r=document.getElementById("update-booking-substatus"))==null?void 0:r.value)||"",i=((o=document.getElementById("update-booking-details"))==null?void 0:o.value)||"";if(!(!e||!t))try{const a=V(j,`bookings/${t}`);await es(a,{status:e,subStatus:n,additionalDetails:i,updatedAt:new Date().toISOString()}),window.showLuxuryToast("تم تحديث حالة الطلب والتفاصيل بنجاح")}catch(a){console.error(a),window.showLuxuryToast("فشل تحديث الحالة","error")}};window.saveWAServerURL=async function(){var e;const t=(e=document.getElementById("wa-server-url-config"))==null?void 0:e.value;if(t){localStorage.setItem("wa_server_url",t);try{await ze(V(j,"settings/waServerUrl"),t)}catch(n){console.error("Firebase save config error:",n)}window.showLuxuryToast("تم حفظ رابط السيرفر وتعميمه لجميع الموظفين بنجاح. يرجى إعادة تحميل الصفحة."),setTimeout(()=>location.reload(),1500)}};window.setLuxuryDetailImg=function(t,e){document.getElementById("active-luxury-img").src=e,document.querySelectorAll(".thumb-wrapper").forEach(n=>n.classList.remove("active")),t.classList.add("active")};window.switchLuxuryDetailImg=function(t,e){const n=window.state.cars.find(c=>c.id===t);if(!n)return;const i=n.images||[n.image||"logo.jpg"],s=document.getElementById("active-luxury-img").src;let r=i.findIndex(c=>s.includes(c));r===-1&&(r=0);let o=(r+e+i.length)%i.length;const a=i[o];document.getElementById("active-luxury-img").src=a;const l=document.querySelectorAll(".thumb-wrapper");l[o]&&(l.forEach(c=>c.classList.remove("active")),l[o].classList.add("active"))};window.openFullscreenGallery=function(t,e){const n=window.state.cars.find(r=>r.id===t);if(!n)return;const i=n.images||[n.image||"logo.jpg"],s=document.createElement("div");s.className="luxury-lightbox",s.innerHTML=`
    ...
    `}const o=document.getElementById("about-text-display");o&&(o.innerText=t.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const a=document.getElementById("location-text-display");a&&(a.innerText=t.location||"الرياض - معارض القادسية");const l=document.getElementById("f-phone-admin");l&&(l.innerText=t.contactAdmin||"...");const c=document.getElementById("f-phone-sales");c&&(c.innerText=t.contactSales||"...");const d=document.getElementById("f-phone-info");d&&(d.innerText=t.contactComplaints||"...");const u=document.getElementById("f-email-display");u&&(u.innerText=t.contactEmail||"...");const h=document.getElementById("contact-location-link");h&&(h.href=t.locationUrl||"#");const f=document.getElementById("meta-title");f&&(f.innerText=`${i} | ${t.metaTitle||"الفخامة والجودة تليق بك"}`);const p=document.getElementById("meta-description");p&&p.setAttribute("content",t.metaDesc||"وجهتكم الرائدة للسيارات الفاخرة والمعتمدة.");const _={"f-insta":t.socialInsta,"f-snap":t.socialSnap,"f-twitter":t.socialTwitter};Object.entries(_).forEach(([w,v])=>{const T=document.getElementById(w);T&&(T.href=v||"#")});const b={"set-name-ar":t.nameAr||"","set-name-en":t.nameEn||"","set-color-primary":t.primaryColor||"#a11d21","set-color-secondary":t.secondaryColor||"#1c7c8c","set-color-accent":t.accentColor||"#b8860b","set-default-theme":t.defaultTheme||"dark","set-font-family":t.fontFamily||"'Cairo', sans-serif","set-border-radius":t.borderRadius||"16px","set-contact-mgmt":t.contactAdmin||"","set-contact-sales":t.contactSales||"","set-contact-complaints":t.contactComplaints||"","set-contact-email":t.contactEmail||"","set-about-text":t.aboutUs||"","set-location-link":t.locationUrl||"","set-location-text":t.location||"","set-insta-link":t.socialInsta||"","set-snap-link":t.socialSnap||"","set-twitter-link":t.socialTwitter||""};Object.entries(b).forEach(([w,v])=>{const T=document.getElementById(w);T&&(T.value=v)});const g=document.getElementById("set-maintenance-mode");g&&(g.checked=t.maintenanceMode||!1);const m=document.getElementById("logo-preview-img");m&&(m.src=n),localStorage.setItem("luxury-settings-cache",JSON.stringify(t))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const t={nameAr:"ون كار",nameEn:"ONE CAR",primaryColor:"#a11d21",secondaryColor:"#1c7c8c",accentColor:"#b8860b",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await ze(V(j,"settings"),t),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const t=window.state.notifications.map(e=>es(V(j,`notifications/${e.id}`),{read:!0}));await Promise.all(t),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(t){console.error(t)}};window.switchSettingsTab=function(t,e){document.querySelectorAll(".set-pane").forEach(i=>i.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(i=>i.classList.remove("active"));const n=document.getElementById(t);n&&n.classList.remove("hidden"),e&&e.classList.add("active")};window.previewLogo=function(t){if(t.files&&t.files[0]){const e=new FileReader;e.onload=function(n){const i=n.target.result;document.getElementById("logo-preview-img").src=i,document.getElementById("set-logo-b64").value=i},e.readAsDataURL(t.files[0])}};window.saveAppSettings=async function(){var n,i,s,r,o,a,l,c,d,u,h,f,p,_,b,g,m,w,v,T;const t=document.querySelector('button[onclick="window.saveAppSettings()"]');t&&(t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const e={nameAr:(n=document.getElementById("set-name-ar"))==null?void 0:n.value,nameEn:(i=document.getElementById("set-name-en"))==null?void 0:i.value,logo:((s=document.getElementById("set-logo-b64"))==null?void 0:s.value)||window.state.settings.logo||"logo.jpg",primaryColor:(r=document.getElementById("set-color-primary"))==null?void 0:r.value,secondaryColor:(o=document.getElementById("set-color-secondary"))==null?void 0:o.value,accentColor:(a=document.getElementById("set-color-accent"))==null?void 0:a.value,defaultTheme:(l=document.getElementById("set-default-theme"))==null?void 0:l.value,fontFamily:(c=document.getElementById("set-font-family"))==null?void 0:c.value,borderRadius:(d=document.getElementById("set-border-radius"))==null?void 0:d.value,contactAdmin:(u=document.getElementById("set-contact-mgmt"))==null?void 0:u.value,contactSales:(h=document.getElementById("set-contact-sales"))==null?void 0:h.value,contactComplaints:(f=document.getElementById("set-contact-complaints"))==null?void 0:f.value,contactEmail:(p=document.getElementById("set-contact-email"))==null?void 0:p.value,aboutUs:(_=document.getElementById("set-about-text"))==null?void 0:_.value,locationUrl:(b=document.getElementById("set-location-link"))==null?void 0:b.value,location:(g=document.getElementById("set-location-text"))==null?void 0:g.value,socialInsta:(m=document.getElementById("set-insta-link"))==null?void 0:m.value,socialSnap:(w=document.getElementById("set-snap-link"))==null?void 0:w.value,socialTwitter:(v=document.getElementById("set-twitter-link"))==null?void 0:v.value,maintenanceMode:((T=document.getElementById("set-maintenance-mode"))==null?void 0:T.checked)||!1,updatedAt:new Date().toISOString()};try{await ze(V(j,"settings"),e),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{t&&(t.disabled=!1,t.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.filterUsersByRole=function(t,e){e&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(n=>n.classList.remove("active")),e.classList.add("active")),window.state.userRoleFilter=t,window.syncAdminTables("users")};window.syncAdminTables=function(t){var s,r,o,a,l,c,d,u,h,f,p,_,b;if(t==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(m=>window.syncAdminTables(m));return}if(t==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(t==="quick-replies"||t==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const e=document.getElementById(`admin-${t}-table`);if(!e)return;let n=window.state[t]||[];const i=(((s=document.getElementById(`admin-${t}-search`))==null?void 0:s.value)||((r=document.getElementById(`${t}-search`))==null?void 0:r.value)||((o=document.getElementById(`${t.slice(0,-1)}-search`))==null?void 0:o.value)||"").toLowerCase();if(i&&(n=n.filter(g=>(g.make||g.title||g.name||g.model||g.phone||g.carRequested||g.carOrCompany||"").toLowerCase().includes(i))),t==="cars"){const g=document.getElementById("admin-filter-car-make");g&&g.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(T=>T.make))].sort().forEach(T=>{const k=document.createElement("option");k.value=T,k.textContent=T,g.appendChild(k)});const m=((a=document.getElementById("admin-filter-car-status"))==null?void 0:a.value)||"all",w=((l=document.getElementById("admin-filter-car-make"))==null?void 0:l.value)||"all";m!=="all"&&(n=n.filter(v=>v.status===m)),w!=="all"&&(n=n.filter(v=>v.make===w))}if(t==="bookings"){const g=document.getElementById("filter-booking-staff");g&&g.options.length<=1&&window.state.users&&window.state.users.forEach(S=>{if(S.role==="admin"||S.role==="supervisor"||S.role==="staff"){const B=document.createElement("option");B.value=S.id,B.textContent=S.name||S.email||"مستخدم غير محدد",g.appendChild(B)}});const m=document.getElementById("filter-booking-sub-status");if(m&&m.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const w=((c=document.getElementById("filter-booking-status"))==null?void 0:c.value)||window.state.bookingFilter||"all",v=((d=document.getElementById("filter-booking-sub-status"))==null?void 0:d.value)||window.state.bookingSubStatusFilter||"all",T=((u=document.getElementById("filter-booking-staff"))==null?void 0:u.value)||"all",k=((h=document.getElementById("filter-booking-type"))==null?void 0:h.value)||"all";window.state.bookingFilter=w,window.state.bookingSubStatusFilter=v,w!=="all"&&(n=n.filter(S=>{let B=S.status||"new";return w==="cancelled"&&(B==="rejected"||B==="cancelled")?!0:B===w})),v!=="all"&&(n=n.filter(S=>S.subStatus===v)),T!=="all"&&(n=n.filter(S=>S.assignedTo===T)),k!=="all"&&(n=n.filter(S=>(S.customerType||"individual")===k)),!(((f=window.state.userProfile)==null?void 0:f.role)==="admin"||((p=window.state.userProfile)==null?void 0:p.role)==="supervisor")&&window.state.user&&(n=n.filter(S=>S.assignedTo===window.state.user.uid))}if(t==="users"){const g=window.state.userRoleFilter||"all";g!=="all"&&(n=n.filter(T=>T.role===g));const m=document.getElementById("stat-users-total"),w=document.getElementById("stat-users-active"),v=document.getElementById("stat-users-admins");if(m&&(m.innerText=n.length),w){w.innerText=n.filter(k=>k.isAvailable).length;const T=w.nextElementSibling;T&&(T.innerText="متواجد حالياً")}if(v){const T=v.nextElementSibling;if(g==="all")v.innerText=n.filter(k=>k.role==="admin").length,T&&(T.innerText="مدراء النظام");else{v.innerText=n.length;const k={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};T&&(T.innerText="إجمالي الـ "+(k[g]||""))}}}if(t==="bookings"?(((_=document.getElementById("filter-booking-sort"))==null?void 0:_.value)||"newest")==="oldest"?n.sort((m,w)=>new Date(m.createdAt||0)-new Date(w.createdAt||0)):n.sort((m,w)=>new Date(w.createdAt||0)-new Date(m.createdAt||0)):n.sort((g,m)=>new Date(m.createdAt||0)-new Date(g.createdAt||0)),n.length===0){e.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(t==="users"){const g=window.state.bookings||[],m=((b=window.state.userProfile)==null?void 0:b.role)==="admin";let w=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;n.forEach(v=>{const T=g.filter(W=>W.assignedTo===v.id),k=T.filter(W=>W.status==="sold"||W.status==="done").length,R=T.filter(W=>W.status==="new"||W.status==="waiting"||W.status==="inquiry"||!W.status).length,S=T.filter(W=>W.status==="cancelled").length,z={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[v.role]||"مندوب",Pe=v.image||"logo.jpg",ce=v.phone||"";let fe="";if(ce){let W=ce.replace(/\D/g,"");W.startsWith("0")&&(W="966"+W.substring(1)),fe=`<a href="https://wa.me/${W}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}w+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
