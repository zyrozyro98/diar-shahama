import{i as pe,g as ye,a as be,b as me,c as ve,d as he,s as xe,o as ke,r as A,e as Y,u as j,f as W,h as q,j as K,k as Ie,l as $e,p as P,m as Ee,n as de,q as Se,t as Te}from"./firebase-BfvlcbVS.js";import"./emoji-picker-CeBMFWb3.js";import"./vendor-Bg_btqvK.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const ge={apiKey:"AIzaSyDQodWTn2wa0WzQuHqzZt2Ex6CdnQdrlUU",authDomain:"onecar1.firebaseapp.com",projectId:"onecar1",storageBucket:"onecar1.firebasestorage.app",messagingSenderId:"735648367644",appId:"1:735648367644:web:44ae368553280b14bdcbd9",measurementId:"G-RSTPV8SRXT",databaseURL:"https://onecar1-default-rtdb.firebaseio.com"},Q=pe(ge);ye(Q);const M=be(Q),G=me(Q);ve(Q);he(Q);window.state={cars:[],ads:[],bookings:[],users:[],notifications:[],logs:[],partners:[],locations:[],brands:[],agents:[],specs:[],packages:[],blogs:[],reviews:[],plates:[],sales:[],gearboxes:[],bodyTypes:[],engines:[],exteriorColors:[],interiorColors:[],stockStatuses:[],user:null,userProfile:null,settings:{enableTextGradient:!0,textGradColor1:"#c8a95e",textGradColor2:"#ffffff",enableTopbarGradient:!0,topbarGradColor1:"#907537",topbarGradColor2:"#05080c",enablePrimaryGradient:!0,primaryGradColor1:"#907537",primaryGradColor2:"#b39651",enableSecondaryGradient:!0,secondaryGradColor1:"#b39651",secondaryGradColor2:"#0f172a",enableAccentGradient:!0,accentGradColor1:"#c8a95e",accentGradColor2:"#ffd700"},lang:localStorage.getItem("luxury_lang")||"ar",soundEnabled:localStorage.getItem("luxury_sound_enabled")!=="false",tempImages:[],bookingFilter:"all",bookingSubStatusFilter:"all",currentReportPeriod:"day",firstLoadDone:!1,inventoryPage:1,inventorySize:8,sliderIndex:0};const Be={ar:{welcome:"مرحباً بك في عالم الفخامة",inventory:"مخزون السيارات المتاح",totalCars:"إجمالي السيارات",totalBookings:"إجمالي الطلبات",totalValue:"قيمة المخزون",searchPlaceholder:"ابحث عن سيارتك المثالية...",loading:"جاري التحميل...",noResults:"لم يتم العثور على نتائج تطابق بحثك",applyNow:"اطلبها الآن",details:"عرض التفاصيل",back:"رجوع",save:"حفظ",delete:"حذف",edit:"تعديل",cancel:"إلغاء",successMsg:"تمت العملية بنجاح",errorMsg:"حدث خطأ غير متوقع",staff:"قسم المبيعات والمتابعة",admin:"إدارة النظام",supervisor:"مشرف النظام"},en:{welcome:"Welcome to the World of Luxury",inventory:"Available Vehicle Inventory",totalCars:"Total Vehicles",totalBookings:"Total Bookings",totalValue:"Inventory Value",searchPlaceholder:"Search for your perfect car...",loading:"Loading...",noResults:"No results found matching your search",applyNow:"Request Now",details:"View Details",back:"Back",save:"Save",delete:"Delete",edit:"Edit",cancel:"Cancel",successMsg:"Operation successful",errorMsg:"An unexpected error occurred",staff:"Sales & Follow-up Department",admin:"System Administration",supervisor:"System Supervisor"}};window.showLuxuryToast=function(e,t="success"){const n=document.getElementById("toast-container");if(!n)return;const o=document.createElement("div");o.className=`toast-v2 ${t}`,o.style.cssText=`
    ...
    align-items: center;
    gap: 10px;
  `;const i=t==="success"?"fa-check-circle":"fa-exclamation-circle";o.innerHTML=`<i class="fas ${i}"></i> <span>${e}</span>`,n.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateY(-20px)",o.style.transition="all 0.4s ease-in",setTimeout(()=>o.remove(),400)},4e3)};window.compressImage=function(e,t=1e3,n=1e3,o=.6){return new Promise((i,a)=>{if(!e||!(e instanceof File||e instanceof Blob)){i(e);return}const r=new FileReader;r.readAsDataURL(e),r.onload=l=>{const s=new Image;s.src=l.target.result,s.onload=()=>{const d=document.createElement("canvas");let g=s.width,u=s.height;g>u?g>t&&(u*=t/g,g=t):u>n&&(g*=n/u,u=n),d.width=g,d.height=u,d.getContext("2d").drawImage(s,0,0,g,u);const m=e.type==="image/png"||e.type==="image/webp"?"image/webp":"image/jpeg";i(d.toDataURL(m,o))},s.onerror=a},r.onerror=a})};window.openModal=function(e){const t=document.getElementById(e);if(t){t.classList.remove("hidden"),document.body.style.overflow="hidden";const n=document.querySelectorAll(".modal:not(.hidden)");t.style.zIndex=2e3+n.length*10,Le(`modal-${e}`)}};window.closeModal=function(e,t=!1){var o;const n=document.getElementById(e);n&&(n.classList.add("hidden"),n.style.zIndex="",!t&&((o=history.state)==null?void 0:o.type)===`modal-${e}`&&history.back(),document.querySelector(".modal:not(.hidden)")||(document.body.style.overflow="auto"))};window.setModalTitle=function(e,t){const n=document.getElementById(e+"-title");n&&(n.innerText=t)};window.switchLuxuryTab=function(e){const t=document.querySelectorAll(".pane, .admin-tab-content"),n=document.querySelectorAll(".dash-tab, .admin-sidebar-nav li");t.forEach(r=>{r.classList.add("hidden"),r.classList.remove("active")}),n.forEach(r=>r.classList.remove("active"));const o=document.getElementById(e),i=document.querySelector(`[data-tab="${e}"]`);o&&(o.classList.remove("hidden"),o.classList.add("active"),o.style.animation="fade-up 0.5s ease-out forwards"),i&&i.classList.add("active");const a=document.getElementById("bookings-submenu");if(a&&a.classList.toggle("active",e==="bookings-mgmt"||e==="all-bookings"),window.innerWidth<1024){const r=document.querySelector(".dash-sidebar, .admin-sidebar-v2");r&&r.classList.remove("active")}e==="whatsapp-monitor-mgmt"&&window.initWhatsAppServer&&window.initWhatsAppServer(),e==="whatsapp-mgmt"&&window.startCurrentWASession(),e==="ads-mgmt"&&window.syncAdminTables("ads"),e==="quick-replies-mgmt"&&window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin()};function Le(e){var t;((t=history.state)==null?void 0:t.type)!==e&&history.pushState({type:e},"")}window.normalizePhone=function(e){if(!e)return"";const t=e.toString().trim();if(t.includes("@s.whatsapp.net"))return t.split("@")[0].replace(/\D/g,"");if(t.includes("@lid"))return t;let n=t.replace(/\D/g,"");if(n.startsWith("9660")?n="966"+n.substring(4):n.startsWith("9670")&&(n="967"+n.substring(4)),n.startsWith("966")||n.startsWith("967"))return n;if(n.startsWith("05"))return"966"+n.substring(1);if(n.startsWith("07"))return"967"+n.substring(1);if(n.startsWith("0"))return"966"+n.substring(1);if(n.length===9){if(n.startsWith("7"))return"967"+n;if(n.startsWith("5"))return"966"+n}return n};document.addEventListener("DOMContentLoaded",()=>{Ae(),fe(),Me(),window.trackVisit(),Ce()});function Ce(){const e=document.querySelector(".mobile-btn"),t=document.querySelector(".nav-menu"),n=document.querySelector(".mobile-nav-overlay"),o=document.querySelector(".menu-close-btn"),i=(w=!1)=>{const x=w===!1?!t.classList.contains("active"):!1;t.classList.toggle("active",x),n.classList.toggle("active",x),document.body.style.overflow=x?"hidden":"";const f=e==null?void 0:e.querySelector("i");f&&(f.className=x?"fas fa-times":"fas fa-bars-staggered")};e&&(e.onclick=()=>i()),n&&(n.onclick=()=>i(!0)),o&&(o.onclick=()=>i(!0)),document.querySelectorAll(".nav-menu a").forEach(w=>{w.addEventListener("click",()=>i(!0))});const a=document.querySelector(".mobile-menu-header .dynamic-name-ar");a&&window.__DYNAMIC_NAME_AR__&&(a.innerText=window.__DYNAMIC_NAME_AR__);const r=document.getElementById("admin-trigger");r&&(r.onclick=w=>{w.preventDefault(),window.openModal("admin-modal")});const l=document.getElementById("theme-btn");l&&(l.onclick=()=>{const x=(document.body.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.body.setAttribute("data-theme",x),localStorage.setItem("luxury_theme",x),localStorage.setItem("theme_manually_overridden","true"),l.innerHTML=x==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>'});const s=document.getElementById("lang-btn");s&&(s.onclick=()=>{window.state.lang=window.state.lang==="ar"?"en":"ar",localStorage.setItem("luxury_lang",window.state.lang),fe(),window.applyInventoryFilters(),s.innerText=window.state.lang==="ar"?"EN":"AR"}),document.querySelectorAll(".dash-tab").forEach(w=>{w.onclick=()=>window.switchLuxuryTab(w.dataset.tab)});const d=document.getElementById("car-search-input");d&&(d.oninput=()=>window.applyInventoryFilters()),["filter-make","filter-type","filter-year","filter-sort"].forEach(w=>{const x=document.getElementById(w);x&&(x.onchange=()=>{window.state.inventoryPage=1,window.applyInventoryFilters()})});const u=document.getElementById("p-prev"),c=document.getElementById("p-next");u&&(u.onclick=()=>window.moveLuxurySlider(-1)),c&&(c.onclick=()=>window.moveLuxurySlider(1)),setInterval(()=>{const w=document.getElementById("luxury-splash");(!w||w.classList.contains("hidden"))&&window.moveLuxurySlider(1)},5e3),["calc-car-price","calc-down-pay","calc-years"].forEach(w=>{const x=document.getElementById(w);x&&(x.oninput=()=>window.calculateLuxuryFinancing()),x&&x.tagName==="SELECT"&&(x.onchange=()=>window.calculateLuxuryFinancing())}),document.querySelectorAll(".modal-close").forEach(w=>{w.onclick=x=>{x.stopPropagation();const f=w.closest(".modal");if(f){if(f.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(f.id)}}}),window.onclick=w=>{const x=document.getElementById("wa-emoji-picker");if(x&&x.style.display!=="none"){const I=w.target.closest(".fa-smile")!==null,E=x.contains(w.target);!I&&!E&&(x.style.display="none")}const f=Array.from(document.querySelectorAll(".modal:not(.hidden)"));if(f.length>0){const I=f[f.length-1];if(w.target===I){if(I.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(I.id)}}},window.addEventListener("popstate",w=>{const x=document.querySelectorAll(".modal:not(.hidden)");x.length>0&&x.forEach(f=>{var I;((I=w.state)==null?void 0:I.type)!==`modal-${f.id}`&&window.closeModal(f.id,!0)})}),window.onscroll=()=>{const w=document.getElementById("main-nav");w&&w.classList.toggle("scrolled",window.scrollY>50);const x=document.getElementById("scroll-jump");x&&x.classList.toggle("hidden",window.scrollY<500)},document.getElementById("scroll-jump")&&(document.getElementById("scroll-jump").onclick=()=>window.scrollTo({top:0,behavior:"smooth"}));const $=document.getElementById("login-form");$&&($.onsubmit=w=>window.loginAdmin(w));const b=document.getElementById("booking-form");b&&(b.onsubmit=w=>window.submitBooking(w));const y=document.getElementById("item-form");y&&(y.onsubmit=w=>window.saveLuxuryItem(w))}function Ae(){const e=JSON.parse(localStorage.getItem("luxury-settings-cache")||"{}"),t=localStorage.getItem("theme_manually_overridden")==="true",n=(t?localStorage.getItem("luxury_theme"):e.defaultTheme)||"dark";t||localStorage.setItem("luxury_theme",n),document.body.setAttribute("data-theme",n);const o=document.getElementById("theme-btn");o&&(o.innerHTML=n==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}function fe(){const e=window.state.lang;document.body.dir=e==="ar"?"rtl":"ltr",document.body.classList.toggle("en",e==="en");const t=Be[e];document.querySelectorAll("[data-i18n]").forEach(n=>{const o=n.getAttribute("data-i18n");t[o]&&(n.innerText=t[o])})}async function Me(){await xe(G,Te);const e=["settings","ads","cars","sales","partners","reviews","users","plates","locations","brands","agents","specs","packages","blogs","custom_presets","gearboxes","bodyTypes","engines","exteriorColors","interiorColors","stockStatuses"],t=["bookings","notifications","logs","quickReplies"],n={};function o(i,a=null){if(n[i])return;const r=A(M,i);if(i==="cars"){n[i]={type:"child"},onChildAdded(r,l=>{const s={...l.val(),id:l.key};window.state.cars||(window.state.cars=[]),window.state.cars.find(d=>d.id===s.id)||(window.state.cars.push(s),window.applyInventoryFilters()),a&&a(s)}),onChildChanged(r,l=>{const s={...l.val(),id:l.key},d=window.state.cars.findIndex(g=>g.id===s.id);d!==-1&&(window.state.cars[d]=s,window.applyInventoryFilters())}),onChildRemoved(r,l=>{const s=l.key;window.state.cars=window.state.cars.filter(d=>d.id!==s),window.applyInventoryFilters()});return}n[i]=Y(r,l=>{var d,g;const s=l.val();if(i==="settings")window.state.settings=s||{},window.applySettings(s);else{const u=window.state[i]||[],c=s?Object.entries(s).map(([m,$])=>({...$,id:m})):[];if(window.state[i]=c,i==="ads"&&window.renderAdsSlider(),i==="sales"&&window.renderSalesVideos(),i==="partners"&&window.renderPartners(),i==="reviews"&&window.renderPublicReviews(),i==="custom_presets"&&window.renderCustomPresets(),i==="notifications"&&window.state.user&&window.state.firstLoadDone){const m=((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((g=window.state.userProfile)==null?void 0:g.role)==="supervisor",$=w=>w.filter(x=>!x.read&&(m||x.userId===window.state.user.uid||x.assignedTo===window.state.user.uid)),b=$(u).length;$(c).length>b&&window.playNotificationSound&&window.playNotificationSound()}window.state.user&&(window.syncAdminTables(i),window.updateStatistics())}a&&a(s),Re()},l=>{console.warn(`Listener for ${i} failed:`,l.message),delete n[i]})}ke(G,async i=>{if(window.state.user=i,i){const a=A(M,`users/${i.uid}`);Y(a,r=>{window.state.userProfile={...r.val(),id:i.uid},ce(),window.initWhatsAppServer&&window.initWhatsAppServer()}),t.forEach(o)}else window.state.userProfile=null,ce(),t.forEach(a=>{n[a]&&delete n[a]})}),o("settings",()=>{o("ads",()=>{o("sales",()=>{o("cars",()=>{e.filter(a=>!["settings","ads","sales","cars"].includes(a)).forEach(a=>o(a))})})})})}function Re(){var a,r;if(window.state.firstLoadDone)return;const e=window.state.settings,t=e==null?void 0:e.maintenanceMode,n=((a=window.state.userProfile)==null?void 0:a.role)==="admin"||((r=window.state.userProfile)==null?void 0:r.role)==="supervisor";if(t&&!n){const l=document.getElementById("luxury-splash");l&&(l.innerHTML=`
      ...
      <table style="width:100%; border-collapse:collapse; text-align:right; font-size:10px;">
        <thead>
          <tr style="background:#a11d21; color:white;">
            ${w.map(I=>`<th style="padding:10px 5px; border:1px solid #a11d21; white-space:nowrap;">${I}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${d.map((I,E)=>`
            <tr style="background:${E%2===0?"#fff":"#fcfcfc"};">
              ${w.map(T=>`<td style="padding:8px 5px; border:1px solid #eee;">${I[T]}</td>`).join("")}
            </tr>
          `).join("")}
        </tbody>
      </table>
    ...
    `).join("")})};window.viewMonitorChat=function(e,t){const n=document.getElementById("monitor-chat-body"),o=document.getElementById("monitor-chat-header");if(!n||!o)return;o.innerText=`مراقبة: ${t}`,n.innerHTML='<div class="loading-v2">جاري تحميل الرسائل...</div>';const i=A(M,`messages/${e}`);Y(i,a=>{const r=[];a.forEach(l=>r.push(l.val())),n.innerHTML=r.map(l=>`
    ...
    `).join(""),n.scrollTop=n.scrollHeight})};window.renderSupervisorStaffList=function(){const e=document.getElementById("supervisor-staff-list-v2");if(!e)return;const t=(window.state.users||[]).filter(o=>o.role==="staff"),n=window.state.bookings||[];if(t.length===0){e.innerHTML='<tr><td colspan="6" style="text-align:center; padding:30px; opacity:0.5;">لا يوجد موظفين مسجلين حالياً</td></tr>';return}e.innerHTML=t.map((o,i)=>{const a=n.filter(g=>g.assignedTo===o.id),r=a.filter(g=>g.status==="sold"||g.status==="done").length,l=a.length>0?Math.round(r/a.length*100):0,d=(o.phone||"").replace(/\D/g,"");return`
...
*القسط الشهري يبدأ من:* ${Number(t.monthlyInstallment).toLocaleString()} ريال`:"";`${t.make}${t.model}${t.year}${i}${a}${window.location.origin}${t.id}`;const r=`
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px; margin-bottom:15px;">
                <div class="f-group">
                    ...
                    <select id="update-booking-status" onchange="window.updateSubStatusOptions(this.value)" style="width:100%; border-radius:10px; padding:10px; background:var(--bg-alt); border:1px solid var(--glass-border); color:var(--text-main); font-family:inherit;">
                        ${Object.entries(n).map(([r,l])=>`<option value="${r}" ${r===(t.status||"new")?"selected":""}>${l}</option>`).join("")}
                    </select>
                </div>
                <div class="f-group">
  ...
  `).join("")};window.applySettings=function(e){var k,h,R,z;if(!e)return;const t=document.documentElement;if(e.defaultTheme&&!(localStorage.getItem("theme_manually_overridden")==="true")){document.body.setAttribute("data-theme",e.defaultTheme),localStorage.setItem("luxury_theme",e.defaultTheme);const C=document.getElementById("theme-btn");C&&(C.innerHTML=e.defaultTheme==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}e.primaryColor&&(t.style.setProperty("--p-red",e.primaryColor),t.style.setProperty("--p-red-glow",e.primaryColor+"66")),e.secondaryColor&&t.style.setProperty("--p-teal",e.secondaryColor),e.accentColor&&t.style.setProperty("--p-copper",e.accentColor);const n=e.logo||"logo.jpg";document.querySelectorAll(".logo-wrap img, .sidebar-brand img, .splash-logo img, #footer-logo-img, #nav-logo-img, #splash-logo-img").forEach(B=>{B.src=n});const o=e.nameAr||"ديار كار",i=e.nameEn||"DIAR CAR",a=window.state.lang==="ar"?o:i;document.querySelectorAll(".dynamic-name-ar").forEach(B=>B.innerText=o),document.querySelectorAll(".dynamic-name-en").forEach(B=>B.innerText=i),document.title=a+" | "+(window.state.lang==="ar"?"الفخامة في عالم السيارات":"Luxury Automotive"),e.fontFamily&&(t.style.setProperty("--font-main",e.fontFamily),document.body.style.fontFamily=e.fontFamily);const r="dynamic-design-styles";let l=document.getElementById(r);l||(l=document.createElement("style"),l.id=r,document.head.appendChild(l));let s="";const d=((k=e.dark)==null?void 0:k.bgColor)||e.bgColor,g=((h=e.dark)==null?void 0:h.textColor)||e.textColor,u=(R=e.light)==null?void 0:R.bgColor,c=(z=e.light)==null?void 0:z.textColor;if(d&&(s+=`body[data-theme="dark"] { --bg-main: ${d}; }
...
`),e.borderRadius&&(t.style.setProperty("--border-radius-main",e.borderRadius+"px"),s+=`
    ...
    `}l.innerHTML=s;const m=document.getElementById("about-text-display");m&&(m.innerText=e.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const $=document.getElementById("location-text-display");$&&($.innerText=e.location||"الرياض - معارض القادسية");const b=document.getElementById("contact-location-link");b&&(b.href=e.locationUrl||"#");const y={"f-phone-admin":e.contactAdmin,"f-phone-sales":e.contactSales,"f-phone-info":e.contactComplaints,"f-email-display":e.contactEmail};Object.entries(y).forEach(([B,C])=>{const L=document.getElementById(B),_=document.getElementById(`contact-${B.split("-")[1]}-display`)||(L?L.closest("li"):null);L&&(L.innerText=C||"..."),_&&_.classList.toggle("hidden",!C)});const w=document.getElementById("meta-title"),x=`${o} | ${e.metaTitle||"تمويل وبيع أفضل السيارات المعتمدة في السعودية - الرياض"}`;w&&(w.innerText=x);const f=document.getElementById("meta-description"),I=e.metaDesc||"وجهتكم الأولى لتمويل وشراء وبيع السيارات الفاخرة في المملكة العربية السعودية. نوفر أفضل السيارات بأسعار تنافسية وجدولة تمويل مرنة وجودة مضمونة.";f&&f.setAttribute("content",I);const E=(B,C,L)=>{const _=document.querySelector(B);_&&_.setAttribute(C,L)};E('meta[property="og:title"]',"content",x),E('meta[property="og:description"]',"content",I),E('meta[property="twitter:title"]',"content",x),E('meta[property="twitter:description"]',"content",I);const T={"f-insta":e.socialInsta,"f-snap":e.socialSnap,"f-twitter":e.socialTwitter};Object.entries(T).forEach(([B,C])=>{const L=document.getElementById(B);L&&(L.href=C||"#")});const p={"set-name-ar":e.nameAr||"","set-name-en":e.nameEn||"","set-color-primary":e.primaryColor||"#907537","set-color-secondary":e.secondaryColor||"#b39651","set-color-accent":e.accentColor||"#c8a95e","set-color-bg":e.bgColor||"#05080c","set-color-text":e.textColor||"#f8fafc","set-hover-effect":e.hoverEffect||"scale","set-card-style":e.cardStyle||"glass","set-glass-opacity":e.glassOpacity!==void 0?e.glassOpacity:.75,"set-logo-blend":e.logoBlend||"auto","set-logo-scale":e.logoScale||"1","set-default-theme":e.defaultTheme||"dark","set-font-family":e.fontFamily||"'Cairo', sans-serif","set-border-radius":e.borderRadius||"16","set-glass-blur":e.glassBlur||20,"set-shadow-depth":e.shadowDepth||40,"set-anim-speed":e.animSpeed||1,"set-enable-animations":e.enableAnimations!==void 0?e.enableAnimations.toString():"true","set-contact-mgmt":e.contactAdmin||"","set-contact-sales":e.contactSales||"","set-contact-complaints":e.contactComplaints||"","set-contact-email":e.contactEmail||"","set-about-text":e.aboutUs||"","set-location-link":e.locationUrl||"","set-location-text":e.location||"","set-insta-link":e.socialInsta||"","set-snap-link":e.socialSnap||"","set-twitter-link":e.socialTwitter||"","set-text-grad-1":e.textGradColor1||"#c8a95e","set-text-grad-2":e.textGradColor2||"#ffffff","set-topbar-grad-1":e.topbarGradColor1||"#907537","set-topbar-grad-2":e.topbarGradColor2||"#05080c","set-primary-grad-1":e.primaryGradColor1||"#907537","set-primary-grad-2":e.primaryGradColor2||"#b39651"};Object.entries(p).forEach(([B,C])=>{const L=document.getElementById(B);if(L&&(L.value=C,L.type==="range"||L.type==="color")){let _=document.createEvent("HTMLEvents");_.initEvent("input",!1,!0),L.dispatchEvent(_)}});const v={"set-maintenance-mode":e.maintenanceMode||!1,"set-enable-text-grad":e.enableTextGradient!==void 0?e.enableTextGradient:!0,"set-enable-topbar-grad":e.enableTopbarGradient!==void 0?e.enableTopbarGradient:!0,"set-enable-primary-grad":e.enablePrimaryGradient!==void 0?e.enablePrimaryGradient:!0,"set-enable-secondary-grad":e.enableSecondaryGradient!==void 0?e.enableSecondaryGradient:!0,"set-enable-accent-grad":e.enableAccentGradient!==void 0?e.enableAccentGradient:!0};Object.entries(v).forEach(([B,C])=>{const L=document.getElementById(B);L&&(L.checked=C)});const S=document.getElementById("logo-preview-img");S&&(S.src=n),localStorage.setItem("luxury-settings-cache",JSON.stringify(e))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const e={nameAr:"ديار كار",nameEn:"DIAR CAR",primaryColor:"#907537",secondaryColor:"#b39651",accentColor:"#c8a95e",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await q(A(M,"settings"),e),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const e=window.state.notifications.map(t=>j(A(M,`notifications/${t.id}`),{read:!0}));await Promise.all(e),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(e){console.error(e)}};window.switchSettingsTab=function(e,t){document.querySelectorAll(".set-pane").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(o=>o.classList.remove("active"));const n=document.getElementById(e);n&&n.classList.remove("hidden"),t&&t.classList.add("active")};window.previewLogo=async function(e){if(e.files&&e.files[0])try{const t=await window.compressImage(e.files[0],400,400,.8);document.getElementById("logo-preview-img").src=t,document.getElementById("set-logo-b64").value=t}catch(t){console.error("Logo compression failed",t)}};window.removeBlackFromLogo=function(){const e=document.getElementById("logo-preview-img"),t=document.getElementById("set-logo-b64");if(!t||!t.value){window.showLuxuryToast("الرجاء رفع شعار أولاً");return}const n=document.createElement("canvas"),o=n.getContext("2d"),i=new Image;i.crossOrigin="Anonymous",i.onload=function(){n.width=i.width,n.height=i.height,o.drawImage(i,0,0);const a=o.getImageData(0,0,n.width,n.height),r=a.data,l=r[0],s=r[1],d=r[2],g=l<50&&s<50&&d<50;for(let c=0;c<r.length;c+=4){const m=r[c],$=r[c+1],b=r[c+2],y=r[c+3];if(y===0)continue;const w=Math.max(m,$,b);if(g){if(w<35)r[c+3]=0;else if(w<85){const x=(w-35)/50;r[c+3]=y*x;const f=Math.max(x,.1);r[c]=Math.min(255,m/f),r[c+1]=Math.min(255,$/f),r[c+2]=Math.min(255,b/f)}}else w<30&&(r[c+3]=0)}o.putImageData(a,0,0);const u=n.toDataURL("image/png");if(e.src=u,t.value=u,window.showLuxuryToast("تمت معالجة الشعار وتصفية الحواف بنجاح"),window.applySettings){let c=window.settings||{};c.logo=u,window.applySettings(c)}},i.src=t.value};window.saveAppSettings=async function(){var n,o,i,a,r,l,s,d,g,u,c,m,$,b,y,w,x,f,I,E,T,p,v,S,k,h,R,z,B,C,L,_,U,H,N,V,Z,ee,te,ne,oe,ie,ae,se,re,le;const e=document.querySelector('button[onclick="window.saveAppSettings()"]');e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const t={nameAr:((n=document.getElementById("set-name-ar"))==null?void 0:n.value)||"",nameEn:((o=document.getElementById("set-name-en"))==null?void 0:o.value)||"",logo:((i=document.getElementById("set-logo-b64"))==null?void 0:i.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((r=document.getElementById("set-color-secondary"))==null?void 0:r.value)||"",accentColor:((l=document.getElementById("set-color-accent"))==null?void 0:l.value)||"",bgColor:((s=document.getElementById("set-color-bg"))==null?void 0:s.value)||"",textColor:((d=document.getElementById("set-color-text"))==null?void 0:d.value)||"",hoverEffect:((g=document.getElementById("set-hover-effect"))==null?void 0:g.value)||"scale",cardStyle:((u=document.getElementById("set-card-style"))==null?void 0:u.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((m=document.getElementById("set-logo-blend"))==null?void 0:m.value)||"auto",logoScale:(($=document.getElementById("set-logo-scale"))==null?void 0:$.value)||"1",defaultTheme:((b=document.getElementById("set-default-theme"))==null?void 0:b.value)||"",fontFamily:((y=document.getElementById("set-font-family"))==null?void 0:y.value)||"",borderRadius:((w=document.getElementById("set-border-radius"))==null?void 0:w.value)||"",glassBlur:parseInt(((x=document.getElementById("set-glass-blur"))==null?void 0:x.value)||"20"),shadowDepth:parseInt(((f=document.getElementById("set-shadow-depth"))==null?void 0:f.value)||"40"),animSpeed:parseFloat(((I=document.getElementById("set-anim-speed"))==null?void 0:I.value)||"1"),enableAnimations:((E=document.getElementById("set-enable-animations"))==null?void 0:E.value)==="true",contactAdmin:((T=document.getElementById("set-contact-mgmt"))==null?void 0:T.value)||"",contactSales:((p=document.getElementById("set-contact-sales"))==null?void 0:p.value)||"",contactComplaints:((v=document.getElementById("set-contact-complaints"))==null?void 0:v.value)||"",contactEmail:((S=document.getElementById("set-contact-email"))==null?void 0:S.value)||"",aboutUs:((k=document.getElementById("set-about-text"))==null?void 0:k.value)||"",locationUrl:((h=document.getElementById("set-location-link"))==null?void 0:h.value)||"",location:((R=document.getElementById("set-location-text"))==null?void 0:R.value)||"",socialInsta:((z=document.getElementById("set-insta-link"))==null?void 0:z.value)||"",socialSnap:((B=document.getElementById("set-snap-link"))==null?void 0:B.value)||"",socialTwitter:((C=document.getElementById("set-twitter-link"))==null?void 0:C.value)||"",maintenanceMode:((L=document.getElementById("set-maintenance-mode"))==null?void 0:L.checked)||!1,enableTextGradient:(_=document.getElementById("set-enable-text-grad"))==null?void 0:_.checked,textGradColor1:(U=document.getElementById("set-text-grad-1"))==null?void 0:U.value,textGradColor2:(H=document.getElementById("set-text-grad-2"))==null?void 0:H.value,enableTopbarGradient:(N=document.getElementById("set-enable-topbar-grad"))==null?void 0:N.checked,topbarGradColor1:(V=document.getElementById("set-topbar-grad-1"))==null?void 0:V.value,topbarGradColor2:(Z=document.getElementById("set-topbar-grad-2"))==null?void 0:Z.value,enablePrimaryGradient:(ee=document.getElementById("set-enable-primary-grad"))==null?void 0:ee.checked,primaryGradColor1:(te=document.getElementById("set-primary-grad-1"))==null?void 0:te.value,primaryGradColor2:(ne=document.getElementById("set-primary-grad-2"))==null?void 0:ne.value,enableSecondaryGradient:(oe=document.getElementById("set-enable-secondary-grad"))==null?void 0:oe.checked,secondaryGradColor1:(ie=document.getElementById("set-secondary-grad-1"))==null?void 0:ie.value,secondaryGradColor2:(ae=document.getElementById("set-secondary-grad-2"))==null?void 0:ae.value,enableAccentGradient:(se=document.getElementById("set-enable-accent-grad"))==null?void 0:se.checked,accentGradColor1:(re=document.getElementById("set-accent-grad-1"))==null?void 0:re.value,accentGradColor2:(le=document.getElementById("set-accent-grad-2"))==null?void 0:le.value,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await q(A(M,"settings"),t),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.toggleDesignPreview=function(){const e=document.getElementById("design-preview-widget");e&&e.classList.toggle("minimized")};window.makeDraggable=function(e){if(!e||e.dataset.draggable)return;e.dataset.draggable="true";let t=0,n=0,o=0,i=0;const a=e.querySelector("div");if(!a)return;a.onmousedown=r,a.ontouchstart=r;function r(d){if(d.target.tagName==="BUTTON"||d.target.tagName==="I")return;const g=d.clientX||d.touches&&d.touches[0].clientX,u=d.clientY||d.touches&&d.touches[0].clientY;o=g,i=u,document.onmouseup=s,document.ontouchend=s,document.onmousemove=l,document.ontouchmove=l,e.classList.add("dragging")}function l(d){const g=d.clientX||d.touches&&d.touches[0].clientX,u=d.clientY||d.touches&&d.touches[0].clientY;t=o-g,n=i-u,o=g,i=u;const c=e.getBoundingClientRect(),m=c.top-n,$=c.left-t;e.style.top=m+"px",e.style.left=$+"px",e.style.bottom="auto",e.style.right="auto",e.style.margin="0"}function s(){document.onmouseup=null,document.onmousemove=null,document.ontouchend=null,document.ontouchmove=null,e.classList.remove("dragging")}};window.filterUsersByRole=function(e,t){t&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(n=>n.classList.remove("active")),t.classList.add("active")),window.state.userRoleFilter=e,window.syncAdminTables("users")};window.syncAdminTables=function(e){var i,a,r,l,s,d,g,u,c,m,$,b,y,w,x;if(e==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(I=>window.syncAdminTables(I));return}if(e==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(e==="quick-replies"||e==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const t=document.getElementById(`admin-${e}-table`);if(!t)return;let n=window.state[e]||[];const o=(((i=document.getElementById(`admin-${e}-search`))==null?void 0:i.value)||((a=document.getElementById(`${e}-search`))==null?void 0:a.value)||((r=document.getElementById(`${e.slice(0,-1)}-search`))==null?void 0:r.value)||"").toLowerCase();if(o&&(n=n.filter(f=>(f.make||f.title||f.name||f.model||f.phone||f.carRequested||f.carOrCompany||f.subtitle||"").toLowerCase().includes(o))),e==="notifications"&&!(((l=window.state.userProfile)==null?void 0:l.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")&&window.state.user&&(n=n.filter(I=>I.userId===window.state.user.uid||I.assignedTo===window.state.user.uid)),e==="cars"){const f=document.getElementById("admin-filter-car-make");f&&f.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(p=>p.make))].sort().forEach(p=>{const v=document.createElement("option");v.value=p,v.textContent=p,f.appendChild(v)});const I=((d=document.getElementById("admin-filter-car-status"))==null?void 0:d.value)||"all",E=((g=document.getElementById("admin-filter-car-make"))==null?void 0:g.value)||"all";I!=="all"&&(n=n.filter(T=>T.status===I)),E!=="all"&&(n=n.filter(T=>T.make===E))}if(e==="bookings"){const f=document.getElementById("filter-booking-staff");f&&f.options.length<=1&&window.state.users&&window.state.users.forEach(k=>{if(k.email!=="zyrozyro98@gmail.com"&&(k.role==="admin"||k.role==="supervisor"||k.role==="staff")){const h=document.createElement("option");h.value=k.id,h.textContent=k.name||k.email||"مستخدم غير محدد",f.appendChild(h)}});const I=document.getElementById("filter-booking-sub-status");if(I&&I.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const E=((u=document.getElementById("filter-booking-status"))==null?void 0:u.value)||window.state.bookingFilter||"all",T=((c=document.getElementById("filter-booking-sub-status"))==null?void 0:c.value)||window.state.bookingSubStatusFilter||"all",p=((m=document.getElementById("filter-booking-staff"))==null?void 0:m.value)||"all",v=(($=document.getElementById("filter-booking-type"))==null?void 0:$.value)||"all";window.state.bookingFilter=E,window.state.bookingSubStatusFilter=T,E!=="all"&&(n=n.filter(k=>{let h=k.status||"new";return E==="cancelled"&&(h==="rejected"||h==="cancelled")?!0:h===E})),T!=="all"&&(n=n.filter(k=>k.subStatus===T)),p!=="all"&&(n=n.filter(k=>k.assignedTo===p)),v!=="all"&&(n=n.filter(k=>(k.customerType||"individual")===v)),!(((b=window.state.userProfile)==null?void 0:b.role)==="admin"||((y=window.state.userProfile)==null?void 0:y.role)==="supervisor")&&window.state.user&&(n=n.filter(k=>k.assignedTo===window.state.user.uid))}if(e==="users"){n=n.filter(p=>p.email!=="zyrozyro98@gmail.com");const f=window.state.userRoleFilter||"all";f!=="all"&&(n=n.filter(p=>p.role===f));const I=document.getElementById("stat-users-total"),E=document.getElementById("stat-users-active"),T=document.getElementById("stat-users-admins");if(I&&(I.innerText=n.length),E){E.innerText=n.filter(v=>v.isAvailable).length;const p=E.nextElementSibling;p&&(p.innerText="متواجد حالياً")}if(T){const p=T.nextElementSibling;if(f==="all")T.innerText=n.filter(v=>v.role==="admin").length,p&&(p.innerText="مدراء النظام");else{T.innerText=n.length;const v={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};p&&(p.innerText="إجمالي الـ "+(v[f]||""))}}}if(e==="bookings"?(((w=document.getElementById("filter-booking-sort"))==null?void 0:w.value)||"newest")==="oldest"?n.sort((I,E)=>new Date(I.createdAt||0)-new Date(E.createdAt||0)):n.sort((I,E)=>new Date(E.createdAt||0)-new Date(I.createdAt||0)):n.sort((f,I)=>new Date(I.createdAt||0)-new Date(f.createdAt||0)),n.length===0){t.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(e==="users"){const f=window.state.bookings||[],I=((x=window.state.userProfile)==null?void 0:x.role)==="admin";let E=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;n.forEach(T=>{const p=f.filter(L=>L.assignedTo===T.id),v=p.filter(L=>L.status==="sold"||L.status==="done").length,S=p.filter(L=>L.status==="new"||L.status==="waiting"||L.status==="inquiry"||!L.status).length,k=p.filter(L=>L.status==="cancelled").length,R={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[T.role]||"مندوب",z=T.image||"logo.jpg",B=T.phone||"";let C="";if(B){let L=B.replace(/\D/g,"");L=window.normalizePhone(L),C=`<a href="https://wa.me/${L}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}E+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
              ...
              <td style="padding:15px; text-align:center;"><span style="color:#e02424; font-weight:bold; font-size:15px;">${k}</span></td>
        ...
        `;if(e==="notifications"){const f=!!t.read,I=t.type||"system",E=((y=window.state.userProfile)==null?void 0:y.role)==="admin"||((w=window.state.userProfile)==null?void 0:w.role)==="supervisor",T=t.userId||t.assignedTo,p=(x=window.state.users)==null?void 0:x.find(k=>k.id===T),v=p?p.name||p.email:"نظام",S={wa_message:"fab fa-whatsapp",booking:"fas fa-calendar-check",system:"fas fa-info-circle",auth:"fas fa-shield-alt"};return`
    ...
    <div class="form-grid-v3">
      ${o.map(i=>{if(i.type==="custom")return i.html;let a=t[i.name]!==void 0&&t[i.name]!==null?t[i.name]:"";i.name==="desc"&&!a&&(a=t.description||t.details||"");const r=i.required?"required":"",l=i.placeholder||i.label;let s="";return i.type==="select"?s=`
  ...
  `;e.innerHTML=n};window.reorderCarImage=function(e,t){const n=window.state.carImages,o=e+t;if(o>=0&&o<n.length){const i=n[e];n[e]=n[o],n[o]=i,window.renderCarImageManager()}};window.removeCarImage=function(e){if(e<0||e>=window.state.carImages.length)return;const t=window.state.carImages[e].isMain;window.state.carImages.splice(e,1),t&&window.state.carImages.length>0&&(window.state.carImages[0].isMain=!0),window.renderCarImageManager()};window.handleImageDragStart=function(e,t){e.dataTransfer.setData("text/plain",t),e.currentTarget.classList.add("dragging")};window.handleImageDragOver=function(e){e.preventDefault(),e.currentTarget.classList.add("drag-over")};window.handleImageDragLeave=function(e){e.currentTarget.classList.remove("drag-over")};window.handleImageDragEnd=function(e){e.currentTarget.classList.remove("dragging")};window.handleImageDrop=function(e,t){e.preventDefault(),e.currentTarget.classList.remove("drag-over");const n=parseInt(e.dataTransfer.getData("text/plain"));if(n!==t){const o=window.state.carImages,i=o.splice(n,1)[0];o.splice(t,0,i),window.renderCarImageManager()}};window.setCarMainImage=function(e){window.state.carImages.forEach((t,n)=>t.isMain=n===e),window.renderCarImageManager()};window.saveLuxuryItem=async function(e){e&&e.preventDefault();const t=window.state.currentEdit;if(!t)return;const{type:n,id:o}=t,i=document.getElementById("item-form");if(!i)return;const a=i.querySelector('button[type="submit"]'),r=a.innerText;a&&(a.disabled=!0,a.innerText="جاري الحفظ والمعالجة...");const l=new FormData(i),s={};l.forEach((d,g)=>{if(g!=="main_img_file"&&g!=="gallery_files"){if(g==="password"&&!d)return;s[g]=d}});try{if(n==="cars"){const u=[];let c="";const m=window.state.carImages||[];for(let $=0;$<m.length;$++){const b=m[$];let y="";b.type==="url"?y=b.value:b.type==="file"&&(y=await window.compressImage(b.value,1e3,1e3,.6)),y&&(u.push(y),b.isMain&&(c=y))}!c&&u.length>0&&(c=u[0]),s.image=c,s.images=u}const d=["image","logo","avatar","poster"];for(const u of d)s[u]instanceof File&&s[u].size>0?s[u]=await window.compressImage(s[u],1e3,1e3,.7):s[u]instanceof File&&s[u].size===0&&delete s[u];if(["price","year","mileage","rating","installmentPeriod","monthlyInstallment"].forEach(u=>{s[u]!==void 0&&s[u]!==""&&s[u]!==null?s[u]=Number(s[u]):delete s[u]}),s.isFeatured!==void 0&&(s.isFeatured=s.isFeatured==="true"||s.isFeatured===!0),o||(s.createdAt=new Date().toISOString()),s.updatedAt=new Date().toISOString(),n==="users"&&!o){if(!s.password){window.showLuxuryToast("كلمة المرور مطلوبة للموظف الجديد","error"),a&&(a.disabled=!1,a.innerText=r);return}const u=pe(ge,"Secondary"),c=me(u);try{const $=(await Ee(c,s.email,s.password)).user.uid,b=A(M,`users/${$}`);await q(b,s),await de(u)}catch(m){throw await de(u),m}}else{if(n==="users"){const c=window._waServerActiveUrl||O;try{await fetch(`${c}/api/admin/update-user`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({adminUid:window.state.user.uid,targetUid:o,data:{password:s.password,email:s.email,name:s.name}})})}catch(m){console.warn("Backend Auth Sync failed:",m)}}const u=o?A(M,`${n}/${o}`):P(A(M,n));await(o?j(u,s):q(u,s)),n==="cars"&&(s.gearbox&&!(window.state.gearboxes||[]).some(c=>c.name===s.gearbox)&&(["عادي","أوتوماتيكي","CVT"].includes(s.gearbox)||await P(A(M,"gearboxes"),{name:s.gearbox})),s.bodyType&&!(window.state.bodyTypes||[]).some(c=>c.name===s.bodyType)&&(["sedan","suv","coupe","luxury","pickup"].includes(s.bodyType)||["سيدان","SUV","كوبيه","فاخرة","بيك آب"].includes(s.bodyType)||await P(A(M,"bodyTypes"),{name:s.bodyType})),s.make&&!(window.state.brands||[]).some(c=>c.name===s.make)&&await P(A(M,"brands"),{name:s.make}),s.engine&&!(window.state.engines||[]).some(c=>c.name===s.engine)&&(["4 سليندر","6 سليندر","8 سليندر"].includes(s.engine)||await P(A(M,"engines"),{name:s.engine})),s.color&&!(window.state.exteriorColors||[]).some(c=>c.name===s.color)&&(["أبيض","أسود","فضي","رمادي"].includes(s.color)||await P(A(M,"exteriorColors"),{name:s.color})),s.interiorColor&&!(window.state.interiorColors||[]).some(c=>c.name===s.interiorColor)&&(["بيج","أسود","جملي","أحمر"].includes(s.interiorColor)||await P(A(M,"interiorColors"),{name:s.interiorColor})),s.status&&!(window.state.stockStatuses||[]).some(c=>c.name===s.status)&&(["available","reserved","sold","incoming"].includes(s.status)||await P(A(M,"stockStatuses"),{name:s.status})))}window.showLuxuryToast(o?"تم تحديث البيانات بنجاح":"تم إضافة العنصر بنجاح"),window.closeModal("item-modal"),window.createLog(o?"تعديل":"إضافة",`${o?"تعديل":"إضافة"} في ${n} - ${s.make||s.title||o}`,"data")}catch(d){console.error("Save Error:",d),window.showLuxuryToast("حدث خطأ أثناء الحفظ: "+(d.message||"خطأ غير معروف"),"error")}finally{a&&(a.disabled=!1,a.innerText=r)}};window.openQuickReplyModal=function(){window.openCRUDModal("quickReplies")};window.renderQuickRepliesAdmin=function(){var o;const e=document.getElementById("quick-replies-list");if(!e)return;const t=(((o=document.getElementById("qr-search"))==null?void 0:o.value)||"").toLowerCase().trim(),n=(window.state.quickReplies||[]).filter(i=>(i.title||"").toLowerCase().includes(t)||(i.content||"").toLowerCase().includes(t));if(n.length===0){e.innerHTML='<div class="no-results-v2" style="grid-column:1/-1;"><p>لا توجد نتائج مطابقة لبحثك</p></div>';return}e.innerHTML=n.map(i=>`
    ...
    `).join(""),t&&(t.innerHTML=n.map((o,i)=>`<div class="dot ${i===0?"active":""}" onclick="window.goToLuxurySlide(${i})"></div>`).join("")),window.state.sliderIndex=0,window.moveLuxurySlider(0)};window.goToLuxurySlide=function(e){window.state.sliderIndex=e,window.moveLuxurySlider(0)};window.moveLuxurySlider=function(e){var r;const t=document.getElementById("slider-track");if(!t)return;const n=((r=window.state.ads)==null?void 0:r.length)||0;if(n<=1){t.style.transform="translateX(0)";return}window.state.sliderIndex=(window.state.sliderIndex+e+n)%n;const o=window.state.sliderIndex*100,i=document.body.dir==="rtl";t.style.transform=`translateX(${i?o:-o}%)`,document.querySelectorAll(".slider-dots .dot").forEach((l,s)=>{l.classList.toggle("active",s===window.state.sliderIndex)})};window.calculateLuxuryFinancing=function(){var s,d,g;const e=Number((s=document.getElementById("calc-car-price"))==null?void 0:s.value)||0,t=Number((d=document.getElementById("calc-down-pay"))==null?void 0:d.value)||0,n=Number((g=document.getElementById("calc-years"))==null?void 0:g.value)||5,o=document.getElementById("calc-result-val");if(!o)return;const i=e-t;if(i<=0){o.innerText="0 ريال";return}const r=i*(1+.045*n),l=Math.round(r/(n*12));o.innerText=l.toLocaleString()+" ريال"};window.renderSalesVideos=function(){const e=document.getElementById("sales-container");if(!e)return;const t=window.state.sales||[];if(t.length===0){e.innerHTML='<div class="no-results-v2"><p>لا توجد مقاطع فيديو متاحة حالياً</p></div>';return}e.innerHTML=t.map(n=>{const o=(n.url||"").trim();let i=o.includes("youtube.com")||o.includes("youtu.be")||o.includes("youtube-nocookie.com"),a=o.includes("tiktok.com"),r=o.includes("instagram.com"),l=o.includes("snapchat.com"),s=n.poster||n.image||null;if(i&&!s){let d="";try{o.includes("v=")?d=o.split("v=")[1].split("&")[0]:o.includes("youtu.be/")?d=o.split("youtu.be/")[1].split("?")[0]:o.includes("embed/")?d=o.split("embed/")[1].split("?")[0]:d=o.split("/").pop().split("?")[0]}catch{d=""}d&&(s=`https://img.youtube.com/vi/${d}/hqdefault.jpg`)}return s=s||"logo.jpg",`
