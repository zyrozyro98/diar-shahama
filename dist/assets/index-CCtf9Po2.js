...
`),t.borderRadius&&(e.style.setProperty("--border-radius-main",t.borderRadius+"px"),l+=`
    ...
    `;else{let b=t.glassOpacity!==void 0?t.glassOpacity:.75;l+=`
    ...
    `),d.innerHTML=l;const r=document.getElementById("about-text-display");r&&(r.innerText=t.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const u=document.getElementById("location-text-display");u&&(u.innerText=t.location||"الرياض - معارض القادسية");const f=document.getElementById("f-phone-admin");f&&(f.innerText=t.contactAdmin||"...");const c=document.getElementById("f-phone-sales");c&&(c.innerText=t.contactSales||"...");const w=document.getElementById("f-phone-info");w&&(w.innerText=t.contactComplaints||"...");const m=document.getElementById("f-email-display");m&&(m.innerText=t.contactEmail||"...");const y=document.getElementById("contact-location-link");y&&(y.href=t.locationUrl||"#");const k=document.getElementById("meta-title");k&&(k.innerText=`${o} | ${t.metaTitle||"الفخامة والجودة تليق بك"}`);const p=document.getElementById("meta-description");p&&p.setAttribute("content",t.metaDesc||"وجهتكم الرائدة للسيارات الفاخرة والمعتمدة.");const g={"f-insta":t.socialInsta,"f-snap":t.socialSnap,"f-twitter":t.socialTwitter};Object.entries(g).forEach(([b,E])=>{const h=document.getElementById(b);h&&(h.href=E||"#")});const x={"set-name-ar":t.nameAr||"","set-name-en":t.nameEn||"","set-color-primary":t.primaryColor||"#a11d21","set-color-secondary":t.secondaryColor||"#1c7c8c","set-color-accent":t.accentColor||"#b8860b","set-color-bg":t.bgColor||"#05080c","set-color-text":t.textColor||"#f8fafc","set-hover-effect":t.hoverEffect||"scale","set-card-style":t.cardStyle||"glass","set-glass-opacity":t.glassOpacity!==void 0?t.glassOpacity:.75,"set-logo-blend":t.logoBlend||"auto","set-logo-scale":t.logoScale||"1","set-default-theme":t.defaultTheme||"dark","set-font-family":t.fontFamily||"'Cairo', sans-serif","set-border-radius":t.borderRadius||"16","set-contact-mgmt":t.contactAdmin||"","set-contact-sales":t.contactSales||"","set-contact-complaints":t.contactComplaints||"","set-contact-email":t.contactEmail||"","set-about-text":t.aboutUs||"","set-location-link":t.locationUrl||"","set-location-text":t.location||"","set-insta-link":t.socialInsta||"","set-snap-link":t.socialSnap||"","set-twitter-link":t.socialTwitter||""};Object.entries(x).forEach(([b,E])=>{const h=document.getElementById(b);if(h&&(h.value=E,h.type==="range"||h.type==="color")){let B=document.createEvent("HTMLEvents");B.initEvent("input",!1,!0),h.dispatchEvent(B)}});const v=document.getElementById("set-maintenance-mode");v&&(v.checked=t.maintenanceMode||!1);const I=document.getElementById("logo-preview-img");I&&(I.src=i),localStorage.setItem("luxury-settings-cache",JSON.stringify(t))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const t={nameAr:"ون كار",nameEn:"ONE CAR",primaryColor:"#a11d21",secondaryColor:"#1c7c8c",accentColor:"#b8860b",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await _(S(T,"settings"),t),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const t=window.state.notifications.map(e=>R(S(T,`notifications/${e.id}`),{read:!0}));await Promise.all(t),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(t){console.error(t)}};window.switchSettingsTab=function(t,e){document.querySelectorAll(".set-pane").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(o=>o.classList.remove("active"));const i=document.getElementById(t);i&&i.classList.remove("hidden"),e&&e.classList.add("active")};window.previewLogo=async function(t){if(t.files&&t.files[0])try{const e=await window.compressImage(t.files[0],400,400,.8);document.getElementById("logo-preview-img").src=e,document.getElementById("set-logo-b64").value=e}catch(e){console.error("Logo compression failed",e)}};window.saveAppSettings=async function(){var i,o,n,a,s,d,l,r,u,f,c,w,m,y,k,p,g,x,v,I,b,E,h,B,M,z,A;const t=document.querySelector('button[onclick="window.saveAppSettings()"]');t&&(t.disabled=!0,t.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const e={nameAr:((i=document.getElementById("set-name-ar"))==null?void 0:i.value)||"",nameEn:((o=document.getElementById("set-name-en"))==null?void 0:o.value)||"",logo:((n=document.getElementById("set-logo-b64"))==null?void 0:n.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((s=document.getElementById("set-color-secondary"))==null?void 0:s.value)||"",accentColor:((d=document.getElementById("set-color-accent"))==null?void 0:d.value)||"",bgColor:((l=document.getElementById("set-color-bg"))==null?void 0:l.value)||"",textColor:((r=document.getElementById("set-color-text"))==null?void 0:r.value)||"",hoverEffect:((u=document.getElementById("set-hover-effect"))==null?void 0:u.value)||"scale",cardStyle:((f=document.getElementById("set-card-style"))==null?void 0:f.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((w=document.getElementById("set-logo-blend"))==null?void 0:w.value)||"auto",logoScale:((m=document.getElementById("set-logo-scale"))==null?void 0:m.value)||"1",defaultTheme:((y=document.getElementById("set-default-theme"))==null?void 0:y.value)||"",fontFamily:((k=document.getElementById("set-font-family"))==null?void 0:k.value)||"",borderRadius:((p=document.getElementById("set-border-radius"))==null?void 0:p.value)||"",contactAdmin:((g=document.getElementById("set-contact-mgmt"))==null?void 0:g.value)||"",contactSales:((x=document.getElementById("set-contact-sales"))==null?void 0:x.value)||"",contactComplaints:((v=document.getElementById("set-contact-complaints"))==null?void 0:v.value)||"",contactEmail:((I=document.getElementById("set-contact-email"))==null?void 0:I.value)||"",aboutUs:((b=document.getElementById("set-about-text"))==null?void 0:b.value)||"",locationUrl:((E=document.getElementById("set-location-link"))==null?void 0:E.value)||"",location:((h=document.getElementById("set-location-text"))==null?void 0:h.value)||"",socialInsta:((B=document.getElementById("set-insta-link"))==null?void 0:B.value)||"",socialSnap:((M=document.getElementById("set-snap-link"))==null?void 0:M.value)||"",socialTwitter:((z=document.getElementById("set-twitter-link"))==null?void 0:z.value)||"",maintenanceMode:((A=document.getElementById("set-maintenance-mode"))==null?void 0:A.checked)||!1,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await _(S(T,"settings"),e),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{t&&(t.disabled=!1,t.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.filterUsersByRole=function(t,e){e&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(i=>i.classList.remove("active")),e.classList.add("active")),window.state.userRoleFilter=t,window.syncAdminTables("users")};window.syncAdminTables=function(t){var n,a,s,d,l,r,u,f,c,w,m,y,k;if(t==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(g=>window.syncAdminTables(g));return}if(t==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(t==="quick-replies"||t==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const e=document.getElementById(`admin-${t}-table`);if(!e)return;let i=window.state[t]||[];const o=(((n=document.getElementById(`admin-${t}-search`))==null?void 0:n.value)||((a=document.getElementById(`${t}-search`))==null?void 0:a.value)||((s=document.getElementById(`${t.slice(0,-1)}-search`))==null?void 0:s.value)||"").toLowerCase();if(o&&(i=i.filter(p=>(p.make||p.title||p.name||p.model||p.phone||p.carRequested||p.carOrCompany||"").toLowerCase().includes(o))),t==="cars"){const p=document.getElementById("admin-filter-car-make");p&&p.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(I=>I.make))].sort().forEach(I=>{const b=document.createElement("option");b.value=I,b.textContent=I,p.appendChild(b)});const g=((d=document.getElementById("admin-filter-car-status"))==null?void 0:d.value)||"all",x=((l=document.getElementById("admin-filter-car-make"))==null?void 0:l.value)||"all";g!=="all"&&(i=i.filter(v=>v.status===g)),x!=="all"&&(i=i.filter(v=>v.make===x))}if(t==="bookings"){const p=document.getElementById("filter-booking-staff");p&&p.options.length<=1&&window.state.users&&window.state.users.forEach(h=>{if(h.email!=="zyrozyro98@gmail.com"&&(h.role==="admin"||h.role==="supervisor"||h.role==="staff")){const B=document.createElement("option");B.value=h.id,B.textContent=h.name||h.email||"مستخدم غير محدد",p.appendChild(B)}});const g=document.getElementById("filter-booking-sub-status");if(g&&g.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const x=((r=document.getElementById("filter-booking-status"))==null?void 0:r.value)||window.state.bookingFilter||"all",v=((u=document.getElementById("filter-booking-sub-status"))==null?void 0:u.value)||window.state.bookingSubStatusFilter||"all",I=((f=document.getElementById("filter-booking-staff"))==null?void 0:f.value)||"all",b=((c=document.getElementById("filter-booking-type"))==null?void 0:c.value)||"all";window.state.bookingFilter=x,window.state.bookingSubStatusFilter=v,x!=="all"&&(i=i.filter(h=>{let B=h.status||"new";return x==="cancelled"&&(B==="rejected"||B==="cancelled")?!0:B===x})),v!=="all"&&(i=i.filter(h=>h.subStatus===v)),I!=="all"&&(i=i.filter(h=>h.assignedTo===I)),b!=="all"&&(i=i.filter(h=>(h.customerType||"individual")===b)),!(((w=window.state.userProfile)==null?void 0:w.role)==="admin"||((m=window.state.userProfile)==null?void 0:m.role)==="supervisor")&&window.state.user&&(i=i.filter(h=>h.assignedTo===window.state.user.uid))}if(t==="users"){i=i.filter(I=>I.email!=="zyrozyro98@gmail.com");const p=window.state.userRoleFilter||"all";p!=="all"&&(i=i.filter(I=>I.role===p));const g=document.getElementById("stat-users-total"),x=document.getElementById("stat-users-active"),v=document.getElementById("stat-users-admins");if(g&&(g.innerText=i.length),x){x.innerText=i.filter(b=>b.isAvailable).length;const I=x.nextElementSibling;I&&(I.innerText="متواجد حالياً")}if(v){const I=v.nextElementSibling;if(p==="all")v.innerText=i.filter(b=>b.role==="admin").length,I&&(I.innerText="مدراء النظام");else{v.innerText=i.length;const b={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};I&&(I.innerText="إجمالي الـ "+(b[p]||""))}}}if(t==="bookings"?(((y=document.getElementById("filter-booking-sort"))==null?void 0:y.value)||"newest")==="oldest"?i.sort((g,x)=>new Date(g.createdAt||0)-new Date(x.createdAt||0)):i.sort((g,x)=>new Date(x.createdAt||0)-new Date(g.createdAt||0)):i.sort((p,g)=>new Date(g.createdAt||0)-new Date(p.createdAt||0)),i.length===0){e.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(t==="users"){const p=window.state.bookings||[],g=((k=window.state.userProfile)==null?void 0:k.role)==="admin";let x=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          <thead>
          ...
          <tbody>`;i.forEach(v=>{const I=p.filter(L=>L.assignedTo===v.id),b=I.filter(L=>L.status==="sold"||L.status==="done").length,E=I.filter(L=>L.status==="new"||L.status==="waiting"||L.status==="inquiry"||!L.status).length,h=I.filter(L=>L.status==="cancelled").length,M={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[v.role]||"مندوب",z=v.image||"logo.jpg",A=v.phone||"";let q="";if(A){let L=A.replace(/\D/g,"");L=window.normalizePhone(L),q=`<a href="https://wa.me/${L}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}x+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
              ...
              <td style="padding:15px; text-align:center;"><span style="color:#00a884; font-weight:bold; font-size:15px;">${b}</span></td>
  ...
  `;t.innerHTML=i};window.reorderCarImage=function(t,e){const i=window.state.carImages,o=t+e;if(o>=0&&o<i.length){const n=i[t];i[t]=i[o],i[o]=n,window.renderCarImageManager()}};window.removeCarImage=function(t){if(t<0||t>=window.state.carImages.length)return;const e=window.state.carImages[t].isMain;window.state.carImages.splice(t,1),e&&window.state.carImages.length>0&&(window.state.carImages[0].isMain=!0),window.renderCarImageManager()};window.setCarMainImage=function(t){window.state.carImages.forEach((e,i)=>e.isMain=i===t),window.renderCarImageManager()};window.saveLuxuryItem=async function(t){t&&t.preventDefault();const e=window.state.currentEdit;if(!e)return;const{type:i,id:o}=e,n=document.getElementById("item-form");if(!n)return;const a=n.querySelector('button[type="submit"]'),s=a.innerText;a&&(a.disabled=!0,a.innerText="جاري الحفظ والمعالجة...");const d=new FormData(n),l={};d.forEach((r,u)=>{if(u!=="main_img_file"&&u!=="gallery_files"){if(u==="password"&&!r)return;l[u]=r}});try{if(i==="cars"){const c=[];let w="";const m=window.state.carImages||[];for(let y=0;y<m.length;y++){const k=m[y];let p="";k.type==="url"?p=k.value:k.type==="file"&&(p=await window.compressImage(k.value,1e3,1e3,.6)),p&&(c.push(p),k.isMain&&(w=p))}!w&&c.length>0&&(w=c[0]),l.image=w,l.images=c}const r=["image","logo","avatar","poster"];for(const c of r)l[c]instanceof File&&l[c].size>0?l[c]=await window.compressImage(l[c],1e3,1e3,.7):l[c]instanceof File&&l[c].size===0&&delete l[c];["price","year","mileage","rating","installmentPeriod"].forEach(c=>{l[c]!==void 0&&l[c]!==""&&l[c]!==null&&(l[c]=Number(l[c]))}),l.isFeatured!==void 0&&(l.isFeatured=l.isFeatured==="true"||l.isFeatured===!0),o||(l.createdAt=new Date().toISOString()),l.updatedAt=new Date().toISOString();const f=o?S(T,`${i}/${o}`):j(S(T,i));await(o?R(f,l):_(f,l)),window.showLuxuryToast(o?"تم تحديث البيانات بنجاح":"تم إضافة العنصر بنجاح"),window.closeModal("item-modal"),window.createLog(o?"تعديل":"إضافة",`${o?"تعديل":"إضافة"} في ${i} - ${l.make||l.title||o}`,"data")}catch(r){console.error("Save Error:",r),window.showLuxuryToast("حدث خطأ أثناء الحفظ: "+(r.message||"خطأ غير معروف"),"error")}finally{a&&(a.disabled=!1,a.innerText=s)}};window.openQuickReplyModal=function(){window.openCRUDModal("quickReplies")};window.renderQuickRepliesAdmin=function(){var o;const t=document.getElementById("quick-replies-list");if(!t)return;const e=(((o=document.getElementById("qr-search"))==null?void 0:o.value)||"").toLowerCase().trim(),i=(window.state.quickReplies||[]).filter(n=>(n.title||"").toLowerCase().includes(e)||(n.content||"").toLowerCase().includes(e));if(i.length===0){t.innerHTML='<div class="no-results-v2" style="grid-column:1/-1;"><p>لا توجد نتائج مطابقة لبحثك</p></div>';return}t.innerHTML=i.map(n=>`
    ...
    `;const r=l.querySelector(".fa-times-btn");r.onmouseover=()=>r.style.color="#e02424",r.onmouseout=()=>r.style.color="#999";const u=async()=>{var w;try{await j(S(T,"notifications"),{userId:i||((w=window.state.userProfile)==null?void 0:w.id)||"admin",type:"wa_message",title:"رسالة واتساب من "+s,body:d,phone:t,read:!1,createdAt:new Date().toISOString()})}catch(m){console.warn("Could not save to notifications DB",m)}};let f=setTimeout(()=>{c(),u()},1e4);const c=()=>{l.style.transform="translateX(-120%)",l.style.opacity="0",l.style.marginTop=`-${l.offsetHeight}px`,setTimeout(()=>{l.parentNode&&l.parentNode.removeChild(l)},400)};r.onclick=w=>{w.stopPropagation(),clearTimeout(f),c()},l.onclick=()=>{clearTimeout(f),c(),a?(window.viewBookingDetails(a.id),setTimeout(()=>{const w=document.getElementById("details-modal").querySelector(".dash-tab.admin-only");w&&w.click()},100)):window.showLuxuryToast("الرسالة من رقم غير مسجل في أي طلب مفتوح","info")},o.insertBefore(l,o.firstChild),requestAnimationFrame(()=>{l.style.transform="translateX(0)",l.style.opacity="1"})};window.startCurrentWASession=function(){if(!window.state.user)return;const t=()=>{$.emit("start_session",{userId:window.state.user.uid});const e=document.getElementById("wa-my-status-title"),i=document.getElementById("wa-my-status-desc");e&&(e.innerText="جاري الاتصال..."),i&&(i.innerText="يتم الآن التواصل مع خادم الواتساب لتوليد رمز الاستجابة السريعة...")};$?$.connected?t():($.once("connect",t),$.connect()):window.initWhatsAppServer()};window.logoutCurrentWASession=function(){window.state.user&&confirm("هل أنت متأكد من تسجيل الخروج من واتساب؟ لن تتمكن من المراسلة من هنا.")&&$&&$.emit("logout_session",{userId:window.state.user.uid})};window._waMediaCache=window._waMediaCache||{};window.fetchServerWAChat=async function(t,e){var n,a,s;if(!t)return;const i=document.getElementById("wa-server-chat-box");if(!i)return;let o=(n=window.state.userProfile)==null?void 0:n.id;if(((a=window.state.userProfile)==null?void 0:a.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")if(e)o=e;else{const l=(window.state.bookings||[]).find(r=>r.phone&&window.normalizePhone(r.phone)===window.normalizePhone(t));if(l&&l.assignedTo)o=l.assignedTo;else{i.innerHTML=`
