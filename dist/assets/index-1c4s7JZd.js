import{i as pe,g as ye,a as be,b as me,c as ve,d as he,s as xe,o as ke,r as A,e as Y,u as j,f as W,h as q,j as K,k as Ie,l as $e,p as P,m as Ee,n as de,q as Se,t as Te}from"./firebase-BfvlcbVS.js";import"./emoji-picker-CeBMFWb3.js";import"./vendor-Bg_btqvK.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const ge={apiKey:"AIzaSyDQodWTn2wa0WzQuHqzZt2Ex6CdnQdrlUU",authDomain:"onecar1.firebaseapp.com",projectId:"onecar1",storageBucket:"onecar1.firebasestorage.app",messagingSenderId:"735648367644",appId:"1:735648367644:web:44ae368553280b14bdcbd9",measurementId:"G-RSTPV8SRXT",databaseURL:"https://onecar1-default-rtdb.firebaseio.com"},Q=pe(ge);ye(Q);const M=be(Q),G=me(Q);ve(Q);he(Q);window.state={cars:[],ads:[],bookings:[],users:[],notifications:[],logs:[],partners:[],locations:[],brands:[],agents:[],specs:[],packages:[],blogs:[],reviews:[],plates:[],sales:[],gearboxes:[],bodyTypes:[],engines:[],exteriorColors:[],interiorColors:[],stockStatuses:[],user:null,userProfile:null,settings:{enableTextGradient:!0,textGradColor1:"#c8a95e",textGradColor2:"#ffffff",enableTopbarGradient:!0,topbarGradColor1:"#907537",topbarGradColor2:"#05080c",enablePrimaryGradient:!0,primaryGradColor1:"#907537",primaryGradColor2:"#b39651",enableSecondaryGradient:!0,secondaryGradColor1:"#b39651",secondaryGradColor2:"#0f172a",enableAccentGradient:!0,accentGradColor1:"#c8a95e",accentGradColor2:"#ffd700"},lang:localStorage.getItem("luxury_lang")||"ar",soundEnabled:localStorage.getItem("luxury_sound_enabled")!=="false",tempImages:[],bookingFilter:"all",bookingSubStatusFilter:"all",currentReportPeriod:"day",firstLoadDone:!1,inventoryPage:1,inventorySize:8,sliderIndex:0};const Be={ar:{welcome:"مرحباً بك في عالم الفخامة",inventory:"مخزون السيارات المتاح",totalCars:"إجمالي السيارات",totalBookings:"إجمالي الطلبات",totalValue:"قيمة المخزون",searchPlaceholder:"ابحث عن سيارتك المثالية...",loading:"جاري التحميل...",noResults:"لم يتم العثور على نتائج تطابق بحثك",applyNow:"اطلبها الآن",details:"عرض التفاصيل",back:"رجوع",save:"حفظ",delete:"حذف",edit:"تعديل",cancel:"إلغاء",successMsg:"تمت العملية بنجاح",errorMsg:"حدث خطأ غير متوقع",staff:"قسم المبيعات والمتابعة",admin:"إدارة النظام",supervisor:"مشرف النظام"},en:{welcome:"Welcome to the World of Luxury",inventory:"Available Vehicle Inventory",totalCars:"Total Vehicles",totalBookings:"Total Bookings",totalValue:"Inventory Value",searchPlaceholder:"Search for your perfect car...",loading:"Loading...",noResults:"No results found matching your search",applyNow:"Request Now",details:"View Details",back:"Back",save:"Save",delete:"Delete",edit:"Edit",cancel:"Cancel",successMsg:"Operation successful",errorMsg:"An unexpected error occurred",staff:"Sales & Follow-up Department",admin:"System Administration",supervisor:"System Supervisor"}};window.showLuxuryToast=function(e,t="success"){const n=document.getElementById("toast-container");if(!n)return;const o=document.createElement("div");o.className=`toast-v2 ${t}`,o.style.cssText=`
  ...
  `;const i=t==="success"?"fa-check-circle":"fa-exclamation-circle";o.innerHTML=`<i class="fas ${i}"></i> <span>${e}</span>`,n.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateY(-20px)",o.style.transition="all 0.4s ease-in",setTimeout(()=>o.remove(),400)},4e3)};window.compressImage=function(e,t=1e3,n=1e3,o=.6){return new Promise((i,a)=>{if(!e||!(e instanceof File||e instanceof Blob)){i(e);return}const r=new FileReader;r.readAsDataURL(e),r.onload=d=>{const s=new Image;s.src=d.target.result,s.onload=()=>{const l=document.createElement("canvas");let g=s.width,u=s.height;g>u?g>t&&(u*=t/g,g=t):u>n&&(g*=n/u,u=n),l.width=g,l.height=u,l.getContext("2d").drawImage(s,0,0,g,u);const m=e.type==="image/png"||e.type==="image/webp"?"image/webp":"image/jpeg";i(l.toDataURL(m,o))},s.onerror=a},r.onerror=a})};window.openModal=function(e){const t=document.getElementById(e);if(t){t.classList.remove("hidden"),document.body.style.overflow="hidden";const n=document.querySelectorAll(".modal:not(.hidden)");t.style.zIndex=2e3+n.length*10,Le(`modal-${e}`)}};window.closeModal=function(e,t=!1){var o;const n=document.getElementById(e);n&&(n.classList.add("hidden"),n.style.zIndex="",!t&&((o=history.state)==null?void 0:o.type)===`modal-${e}`&&history.back(),document.querySelector(".modal:not(.hidden)")||(document.body.style.overflow="auto"))};window.setModalTitle=function(e,t){const n=document.getElementById(e+"-title");n&&(n.innerText=t)};window.switchLuxuryTab=function(e){const t=document.querySelectorAll(".pane, .admin-tab-content"),n=document.querySelectorAll(".dash-tab, .admin-sidebar-nav li");t.forEach(r=>{r.classList.add("hidden"),r.classList.remove("active")}),n.forEach(r=>r.classList.remove("active"));const o=document.getElementById(e),i=document.querySelector(`[data-tab="${e}"]`);o&&(o.classList.remove("hidden"),o.classList.add("active"),o.style.animation="fade-up 0.5s ease-out forwards"),i&&i.classList.add("active");const a=document.getElementById("bookings-submenu");if(a&&a.classList.toggle("active",e==="bookings-mgmt"||e==="all-bookings"),window.innerWidth<1024){const r=document.querySelector(".dash-sidebar, .admin-sidebar-v2");r&&r.classList.remove("active")}e==="whatsapp-monitor-mgmt"&&window.initWhatsAppServer&&window.initWhatsAppServer(),e==="whatsapp-mgmt"&&window.startCurrentWASession(),e==="ads-mgmt"&&window.syncAdminTables("ads"),e==="quick-replies-mgmt"&&window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin()};function Le(e){var t;((t=history.state)==null?void 0:t.type)!==e&&history.pushState({type:e},"")}window.normalizePhone=function(e){if(!e)return"";const t=e.toString().trim();if(t.includes("@s.whatsapp.net"))return t.split("@")[0].replace(/\D/g,"");if(t.includes("@lid"))return t;let n=t.replace(/\D/g,"");if(n.startsWith("9660")?n="966"+n.substring(4):n.startsWith("9670")&&(n="967"+n.substring(4)),n.startsWith("966")||n.startsWith("967"))return n;if(n.startsWith("05"))return"966"+n.substring(1);if(n.startsWith("07"))return"967"+n.substring(1);if(n.startsWith("0"))return"966"+n.substring(1);if(n.length===9){if(n.startsWith("7"))return"967"+n;if(n.startsWith("5"))return"966"+n}return n};document.addEventListener("DOMContentLoaded",()=>{Ae(),fe(),Me(),window.trackVisit(),Ce()});function Ce(){const e=document.querySelector(".mobile-btn"),t=document.querySelector(".nav-menu"),n=document.querySelector(".mobile-nav-overlay"),o=document.querySelector(".menu-close-btn"),i=(f=!1)=>{const k=f===!1?!t.classList.contains("active"):!1;t.classList.toggle("active",k),n.classList.toggle("active",k),document.body.style.overflow=k?"hidden":"";const w=e==null?void 0:e.querySelector("i");w&&(w.className=k?"fas fa-times":"fas fa-bars-staggered")};e&&(e.onclick=()=>i()),n&&(n.onclick=()=>i(!0)),o&&(o.onclick=()=>i(!0)),document.querySelectorAll(".nav-menu a").forEach(f=>{f.addEventListener("click",()=>i(!0))});const a=document.querySelector(".mobile-menu-header .dynamic-name-ar");a&&window.__DYNAMIC_NAME_AR__&&(a.innerText=window.__DYNAMIC_NAME_AR__);const r=document.getElementById("admin-trigger");r&&(r.onclick=f=>{f.preventDefault(),window.openModal("admin-modal")});const d=document.getElementById("theme-btn");d&&(d.onclick=()=>{const k=(document.body.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.body.setAttribute("data-theme",k),localStorage.setItem("luxury_theme",k),localStorage.setItem("theme_manually_overridden","true"),d.innerHTML=k==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>'});const s=document.getElementById("lang-btn");s&&(s.onclick=()=>{window.state.lang=window.state.lang==="ar"?"en":"ar",localStorage.setItem("luxury_lang",window.state.lang),fe(),window.applyInventoryFilters(),s.innerText=window.state.lang==="ar"?"EN":"AR"}),document.querySelectorAll(".dash-tab").forEach(f=>{f.onclick=()=>window.switchLuxuryTab(f.dataset.tab)});const l=document.getElementById("car-search-input");l&&(l.oninput=()=>window.applyInventoryFilters()),["filter-make","filter-type","filter-year","filter-sort"].forEach(f=>{const k=document.getElementById(f);k&&(k.onchange=()=>{window.state.inventoryPage=1,window.applyInventoryFilters()})});const u=document.getElementById("p-prev"),c=document.getElementById("p-next");u&&(u.onclick=()=>window.moveLuxurySlider(-1)),c&&(c.onclick=()=>window.moveLuxurySlider(1)),setInterval(()=>{const f=document.getElementById("luxury-splash");(!f||f.classList.contains("hidden"))&&window.moveLuxurySlider(1)},5e3),["calc-car-price","calc-down-pay","calc-years"].forEach(f=>{const k=document.getElementById(f);k&&(k.oninput=()=>window.calculateLuxuryFinancing()),k&&k.tagName==="SELECT"&&(k.onchange=()=>window.calculateLuxuryFinancing())}),document.querySelectorAll(".modal-close").forEach(f=>{f.onclick=k=>{k.stopPropagation();const w=f.closest(".modal");if(w){if(w.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(w.id)}}}),window.onclick=f=>{const k=document.getElementById("wa-emoji-picker");if(k&&k.style.display!=="none"){const I=f.target.closest(".fa-smile")!==null,E=k.contains(f.target);!I&&!E&&(k.style.display="none")}const w=Array.from(document.querySelectorAll(".modal:not(.hidden)"));if(w.length>0){const I=w[w.length-1];if(f.target===I){if(I.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(I.id)}}},window.addEventListener("popstate",f=>{const k=document.querySelectorAll(".modal:not(.hidden)");k.length>0&&k.forEach(w=>{var I;((I=f.state)==null?void 0:I.type)!==`modal-${w.id}`&&window.closeModal(w.id,!0)})}),window.onscroll=()=>{const f=document.getElementById("main-nav");f&&f.classList.toggle("scrolled",window.scrollY>50);const k=document.getElementById("scroll-jump");k&&k.classList.toggle("hidden",window.scrollY<500)},document.getElementById("scroll-jump")&&(document.getElementById("scroll-jump").onclick=()=>window.scrollTo({top:0,behavior:"smooth"}));const $=document.getElementById("login-form");$&&($.onsubmit=f=>window.loginAdmin(f));const b=document.getElementById("booking-form");b&&(b.onsubmit=f=>window.submitBooking(f));const y=document.getElementById("item-form");y&&(y.onsubmit=f=>window.saveLuxuryItem(f))}function Ae(){const e=JSON.parse(localStorage.getItem("luxury-settings-cache")||"{}"),t=localStorage.getItem("theme_manually_overridden")==="true",n=(t?localStorage.getItem("luxury_theme"):e.defaultTheme)||"dark";t||localStorage.setItem("luxury_theme",n),document.body.setAttribute("data-theme",n);const o=document.getElementById("theme-btn");o&&(o.innerHTML=n==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}function fe(){const e=window.state.lang;document.body.dir=e==="ar"?"rtl":"ltr",document.body.classList.toggle("en",e==="en");const t=Be[e];document.querySelectorAll("[data-i18n]").forEach(n=>{const o=n.getAttribute("data-i18n");t[o]&&(n.innerText=t[o])})}async function Me(){await xe(G,Te);const e=["settings","ads","cars"],t=["sales","partners","reviews","users","plates","locations","brands","agents","specs","packages","blogs","custom_presets","gearboxes","bodyTypes","engines","exteriorColors","interiorColors","stockStatuses"],n=["bookings","notifications","logs","quickReplies"],o={};function i(a){o[a]||(o[a]=Y(A(M,a),r=>{var s,l;const d=r.val();if(a==="settings")window.state.settings=d||{},window.applySettings(d);else{const g=window.state[a]||[],u=d?Object.entries(d).map(([c,m])=>({...m,id:c})):[];if(window.state[a]=u,a==="cars"&&window.applyInventoryFilters(),a==="ads"&&window.renderAdsSlider(),a==="sales"&&window.renderSalesVideos(),a==="partners"&&window.renderPartners(),a==="reviews"&&window.renderPublicReviews(),a==="custom_presets"&&window.renderCustomPresets(),a==="notifications"&&window.state.user&&window.state.firstLoadDone){const c=((s=window.state.userProfile)==null?void 0:s.role)==="admin"||((l=window.state.userProfile)==null?void 0:l.role)==="supervisor",m=y=>y.filter(f=>!f.read&&(c||f.userId===window.state.user.uid||f.assignedTo===window.state.user.uid)),$=m(g).length;m(u).length>$&&window.playNotificationSound&&window.playNotificationSound()}window.state.user&&(window.syncAdminTables(a),window.updateStatistics())}Re()},r=>{console.warn(`Listener for ${a} failed:`,r.message),delete o[a]}))}ke(G,async a=>{if(window.state.user=a,a){const r=A(M,`users/${a.uid}`);Y(r,d=>{window.state.userProfile={...d.val(),id:a.uid},ce(),window.initWhatsAppServer&&window.initWhatsAppServer()}),n.forEach(i)}else window.state.userProfile=null,ce(),n.forEach(r=>{o[r]&&delete o[r]})}),e.forEach(i),setTimeout(()=>{t.forEach(i)},1e3)}function Re(){var r,d;if(window.state.firstLoadDone)return;const e=window.state.settings,t=e==null?void 0:e.maintenanceMode,n=((r=window.state.userProfile)==null?void 0:r.role)==="admin"||((d=window.state.userProfile)==null?void 0:d.role)==="supervisor";if(t&&!n){const s=document.getElementById("luxury-splash");s&&(s.innerHTML=`
    ...
    `).join("")})};window.viewMonitorChat=function(e,t){const n=document.getElementById("monitor-chat-body"),o=document.getElementById("monitor-chat-header");if(!n||!o)return;o.innerText=`مراقبة: ${t}`,n.innerHTML='<div class="loading-v2">جاري تحميل الرسائل...</div>';const i=A(M,`messages/${e}`);Y(i,a=>{const r=[];a.forEach(d=>r.push(d.val())),n.innerHTML=r.map(d=>`
  ...
  `}).join("")}};window.renderCarGrid=function(e){const t=document.getElementById("cars-container");if(t){if(e.length===0){t.innerHTML='<div class="no-results-v2"><i class="fas fa-search"></i> <p>لم يتم العثور على سيارات تطابق بحثك</p></div>';return}t.innerHTML=e.map(n=>`
    <div class="car-card-premium" onclick="window.viewLuxuryCar('${n.id}')" data-aos="fade-up">
      <div class="car-img-wrap">
        <img src="${n.image||"logo.jpg"}" alt="${n.make}" loading="lazy" decoding="async" onerror="this.src='logo.jpg'">
                ...
                <div style="text-align:center; margin-top:auto; margin-bottom:auto;">
                    <div style="background:rgba(255,255,255,0.95); display:inline-block; padding:20px; border-radius:15px; font-size:13px; color:#555; box-shadow:0 10px 30px rgba(0,0,0,0.1); max-width:85%;">
                        ...
                        سجل المحادثات متاح فقط للحجوزات المسندة.
                                ...
                                <button id="${w}" class="btn-premium btn-sm" onclick="window.downloadWAMedia('${o}', '${e}', '${c.id}', '${I}', '${c.media.mimetype}', '${c.type}')" style="padding:4px 10px; min-width:40px;"><i class="fas fa-download"></i></button>
