        ...
        <div class="details-info-v4">
          <div class="specs-grid-v4-compact">
            <div class="spec-card-v5">
               <i class="fas fa-microchip"></i>
               <div class="s-info"><span>حجم المحرك</span><strong>${t.engineSize?t.engineSize+" cc":(Number(t.mileage)||0).toLocaleString()+" كم"}</strong></div>
            </div>
            <div class="spec-card-v5">
...
`),e.borderRadius&&(t.style.setProperty("--border-radius-main",e.borderRadius+"px"),s+=`
    ...
    `}d.innerHTML=s;const m=document.getElementById("about-text-display");m&&(m.innerText=e.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const I=document.getElementById("location-text-display");I&&(I.innerText=e.location||"الرياض - معارض القادسية");const b=document.getElementById("contact-location-link");b&&(b.href=e.locationUrl||"#");const w={"f-phone-admin":e.contactAdmin,"f-phone-sales":e.contactSales,"f-phone-info":e.contactComplaints,"f-email-display":e.contactEmail};Object.entries(w).forEach(([L,B])=>{const z=document.getElementById(L),P=document.getElementById(`contact-${L.split("-")[1]}-display`)||(z?z.closest("li"):null);z&&(z.innerText=B||"..."),P&&P.classList.toggle("hidden",!B)});const y=document.getElementById("float-call");if(y){const L=e.contactSales||"",B=window.normalizePhone(L);y.href=L?`tel:${B}`:"tel:"}const x=document.getElementById("meta-title"),f=`${o} | ${e.metaTitle||"تمويل وبيع أفضل السيارات المعتمدة في السعودية - الرياض"}`;x&&(x.innerText=f);const k=document.getElementById("meta-description"),E=e.metaDesc||"وجهتكم الأولى لتمويل وشراء وبيع السيارات الفاخرة في المملكة العربية السعودية. نوفر أفضل السيارات بأسعار تنافسية وجدولة تمويل مرنة وجودة مضمونة.";k&&k.setAttribute("content",E);const S=(L,B,z)=>{const P=document.querySelector(L);P&&P.setAttribute(B,z)};S('meta[property="og:title"]',"content",f),S('meta[property="og:description"]',"content",E),S('meta[property="twitter:title"]',"content",f),S('meta[property="twitter:description"]',"content",E);const p={"f-insta":e.socialInsta,"f-snap":e.socialSnap,"f-twitter":e.socialTwitter};Object.entries(p).forEach(([L,B])=>{const z=document.getElementById(L);z&&(z.href=B||"#")});const v={"set-name-ar":e.nameAr||"","set-name-en":e.nameEn||"","set-color-primary":e.primaryColor||"#907537","set-color-secondary":e.secondaryColor||"#b39651","set-color-accent":e.accentColor||"#c8a95e","set-color-bg":e.bgColor||"#05080c","set-color-text":e.textColor||"#f8fafc","set-hover-effect":e.hoverEffect||"scale","set-card-style":e.cardStyle||"glass","set-glass-opacity":e.glassOpacity!==void 0?e.glassOpacity:.75,"set-logo-blend":e.logoBlend||"auto","set-logo-scale":e.logoScale||"1","set-default-theme":e.defaultTheme||"dark","set-font-family":e.fontFamily||"'Cairo', sans-serif","set-border-radius":e.borderRadius||"16","set-glass-blur":e.glassBlur||20,"set-shadow-depth":e.shadowDepth||40,"set-anim-speed":e.animSpeed||1,"set-enable-animations":e.enableAnimations!==void 0?e.enableAnimations.toString():"true","set-contact-mgmt":e.contactAdmin||"","set-contact-sales":e.contactSales||"","set-contact-complaints":e.contactComplaints||"","set-contact-email":e.contactEmail||"","set-about-text":e.aboutUs||"","set-location-link":e.locationUrl||"","set-location-text":e.location||"","set-insta-link":e.socialInsta||"","set-snap-link":e.socialSnap||"","set-twitter-link":e.socialTwitter||"","set-text-grad-1":e.textGradColor1||"#c8a95e","set-text-grad-2":e.textGradColor2||"#ffffff","set-topbar-grad-1":e.topbarGradColor1||"#907537","set-topbar-grad-2":e.topbarGradColor2||"#05080c","set-primary-grad-1":e.primaryGradColor1||"#907537","set-primary-grad-2":e.primaryGradColor2||"#b39651"};Object.entries(v).forEach(([L,B])=>{const z=document.getElementById(L);if(z&&(z.value=B,z.type==="range"||z.type==="color")){let P=document.createEvent("HTMLEvents");P.initEvent("input",!1,!0),z.dispatchEvent(P)}});const T={"set-maintenance-mode":e.maintenanceMode||!1,"set-enable-text-grad":e.enableTextGradient!==void 0?e.enableTextGradient:!0,"set-enable-topbar-grad":e.enableTopbarGradient!==void 0?e.enableTopbarGradient:!0,"set-enable-primary-grad":e.enablePrimaryGradient!==void 0?e.enablePrimaryGradient:!0,"set-enable-secondary-grad":e.enableSecondaryGradient!==void 0?e.enableSecondaryGradient:!0,"set-enable-accent-grad":e.enableAccentGradient!==void 0?e.enableAccentGradient:!0};Object.entries(T).forEach(([L,B])=>{const z=document.getElementById(L);z&&(z.checked=B)});const h=document.getElementById("logo-preview-img");h&&(h.src=n),localStorage.setItem("luxury-settings-cache",JSON.stringify(e))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const e={nameAr:"ديار كار",nameEn:"DIAR CAR",primaryColor:"#907537",secondaryColor:"#b39651",accentColor:"#c8a95e",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await F(A(M,"settings"),e),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const e=window.state.notifications.map(t=>q(A(M,`notifications/${t.id}`),{read:!0}));await Promise.all(e),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(e){console.error(e)}};window.switchSettingsTab=function(e,t){document.querySelectorAll(".set-pane").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(o=>o.classList.remove("active"));const n=document.getElementById(e);n&&n.classList.remove("hidden"),t&&t.classList.add("active")};window.previewLogo=async function(e){if(e.files&&e.files[0])try{const t=await window.compressImage(e.files[0],400,400,.8);document.getElementById("logo-preview-img").src=t,document.getElementById("set-logo-b64").value=t}catch(t){console.error("Logo compression failed",t)}};window.removeBlackFromLogo=function(){const e=document.getElementById("logo-preview-img"),t=document.getElementById("set-logo-b64");if(!t||!t.value){window.showLuxuryToast("الرجاء رفع شعار أولاً");return}const n=document.createElement("canvas"),o=n.getContext("2d"),i=new Image;i.crossOrigin="Anonymous",i.onload=function(){n.width=i.width,n.height=i.height,o.drawImage(i,0,0);const a=o.getImageData(0,0,n.width,n.height),r=a.data,d=r[0],s=r[1],l=r[2],g=d<50&&s<50&&l<50;for(let c=0;c<r.length;c+=4){const m=r[c],I=r[c+1],b=r[c+2],w=r[c+3];if(w===0)continue;const y=Math.max(m,I,b);if(g){if(y<35)r[c+3]=0;else if(y<85){const x=(y-35)/50;r[c+3]=w*x;const f=Math.max(x,.1);r[c]=Math.min(255,m/f),r[c+1]=Math.min(255,I/f),r[c+2]=Math.min(255,b/f)}}else y<30&&(r[c+3]=0)}o.putImageData(a,0,0);const u=n.toDataURL("image/png");if(e.src=u,t.value=u,window.showLuxuryToast("تمت معالجة الشعار وتصفية الحواف بنجاح"),window.applySettings){let c=window.settings||{};c.logo=u,window.applySettings(c)}},i.src=t.value};window.saveAppSettings=async function(){var n,o,i,a,r,d,s,l,g,u,c,m,I,b,w,y,x,f,k,E,S,p,v,T,h,C,$,R,D,L,B,z,P,H,W,V,Z,ee,te,ne,oe,ie,ae,se,re,le;const e=document.querySelector('button[onclick="window.saveAppSettings()"]');e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const t={nameAr:((n=document.getElementById("set-name-ar"))==null?void 0:n.value)||"",nameEn:((o=document.getElementById("set-name-en"))==null?void 0:o.value)||"",logo:((i=document.getElementById("set-logo-b64"))==null?void 0:i.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((r=document.getElementById("set-color-secondary"))==null?void 0:r.value)||"",accentColor:((d=document.getElementById("set-color-accent"))==null?void 0:d.value)||"",bgColor:((s=document.getElementById("set-color-bg"))==null?void 0:s.value)||"",textColor:((l=document.getElementById("set-color-text"))==null?void 0:l.value)||"",hoverEffect:((g=document.getElementById("set-hover-effect"))==null?void 0:g.value)||"scale",cardStyle:((u=document.getElementById("set-card-style"))==null?void 0:u.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((m=document.getElementById("set-logo-blend"))==null?void 0:m.value)||"auto",logoScale:((I=document.getElementById("set-logo-scale"))==null?void 0:I.value)||"1",defaultTheme:((b=document.getElementById("set-default-theme"))==null?void 0:b.value)||"",fontFamily:((w=document.getElementById("set-font-family"))==null?void 0:w.value)||"",borderRadius:((y=document.getElementById("set-border-radius"))==null?void 0:y.value)||"",glassBlur:parseInt(((x=document.getElementById("set-glass-blur"))==null?void 0:x.value)||"20"),shadowDepth:parseInt(((f=document.getElementById("set-shadow-depth"))==null?void 0:f.value)||"40"),animSpeed:parseFloat(((k=document.getElementById("set-anim-speed"))==null?void 0:k.value)||"1"),enableAnimations:((E=document.getElementById("set-enable-animations"))==null?void 0:E.value)==="true",contactAdmin:((S=document.getElementById("set-contact-mgmt"))==null?void 0:S.value)||"",contactSales:((p=document.getElementById("set-contact-sales"))==null?void 0:p.value)||"",contactComplaints:((v=document.getElementById("set-contact-complaints"))==null?void 0:v.value)||"",contactEmail:((T=document.getElementById("set-contact-email"))==null?void 0:T.value)||"",aboutUs:((h=document.getElementById("set-about-text"))==null?void 0:h.value)||"",locationUrl:((C=document.getElementById("set-location-link"))==null?void 0:C.value)||"",location:(($=document.getElementById("set-location-text"))==null?void 0:$.value)||"",socialInsta:((R=document.getElementById("set-insta-link"))==null?void 0:R.value)||"",socialSnap:((D=document.getElementById("set-snap-link"))==null?void 0:D.value)||"",socialTwitter:((L=document.getElementById("set-twitter-link"))==null?void 0:L.value)||"",maintenanceMode:((B=document.getElementById("set-maintenance-mode"))==null?void 0:B.checked)||!1,enableTextGradient:(z=document.getElementById("set-enable-text-grad"))==null?void 0:z.checked,textGradColor1:(P=document.getElementById("set-text-grad-1"))==null?void 0:P.value,textGradColor2:(H=document.getElementById("set-text-grad-2"))==null?void 0:H.value,enableTopbarGradient:(W=document.getElementById("set-enable-topbar-grad"))==null?void 0:W.checked,topbarGradColor1:(V=document.getElementById("set-topbar-grad-1"))==null?void 0:V.value,topbarGradColor2:(Z=document.getElementById("set-topbar-grad-2"))==null?void 0:Z.value,enablePrimaryGradient:(ee=document.getElementById("set-enable-primary-grad"))==null?void 0:ee.checked,primaryGradColor1:(te=document.getElementById("set-primary-grad-1"))==null?void 0:te.value,primaryGradColor2:(ne=document.getElementById("set-primary-grad-2"))==null?void 0:ne.value,enableSecondaryGradient:(oe=document.getElementById("set-enable-secondary-grad"))==null?void 0:oe.checked,secondaryGradColor1:(ie=document.getElementById("set-secondary-grad-1"))==null?void 0:ie.value,secondaryGradColor2:(ae=document.getElementById("set-secondary-grad-2"))==null?void 0:ae.value,enableAccentGradient:(se=document.getElementById("set-enable-accent-grad"))==null?void 0:se.checked,accentGradColor1:(re=document.getElementById("set-accent-grad-1"))==null?void 0:re.value,accentGradColor2:(le=document.getElementById("set-accent-grad-2"))==null?void 0:le.value,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await F(A(M,"settings"),t),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.toggleDesignPreview=function(){const e=document.getElementById("design-preview-widget");e&&e.classList.toggle("minimized")};window.makeDraggable=function(e){if(!e||e.dataset.draggable)return;e.dataset.draggable="true";let t=0,n=0,o=0,i=0;const a=e.querySelector("div");if(!a)return;a.onmousedown=r,a.ontouchstart=r;function r(l){if(l.target.tagName==="BUTTON"||l.target.tagName==="I")return;const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;o=g,i=u,document.onmouseup=s,document.ontouchend=s,document.onmousemove=d,document.ontouchmove=d,e.classList.add("dragging")}function d(l){const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;t=o-g,n=i-u,o=g,i=u;const c=e.getBoundingClientRect(),m=c.top-n,I=c.left-t;e.style.top=m+"px",e.style.left=I+"px",e.style.bottom="auto",e.style.right="auto",e.style.margin="0"}function s(){document.onmouseup=null,document.onmousemove=null,document.ontouchend=null,document.ontouchmove=null,e.classList.remove("dragging")}};window.filterUsersByRole=function(e,t){t&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(n=>n.classList.remove("active")),t.classList.add("active")),window.state.userRoleFilter=e,window.syncAdminTables("users")};window.syncAdminTables=function(e){var i,a,r,d,s,l,g,u,c,m,I,b,w,y,x;if(e==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(k=>window.syncAdminTables(k));return}if(e==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(e==="quick-replies"||e==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const t=document.getElementById(`admin-${e}-table`);if(!t)return;let n=window.state[e]||[];const o=(((i=document.getElementById(`admin-${e}-search`))==null?void 0:i.value)||((a=document.getElementById(`${e}-search`))==null?void 0:a.value)||((r=document.getElementById(`${e.slice(0,-1)}-search`))==null?void 0:r.value)||"").toLowerCase();if(o&&(n=n.filter(f=>(f.make||f.title||f.name||f.model||f.phone||f.carRequested||f.carOrCompany||f.subtitle||"").toLowerCase().includes(o))),e==="notifications"&&!(((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")&&window.state.user&&(n=n.filter(k=>k.userId===window.state.user.uid||k.assignedTo===window.state.user.uid)),e==="cars"){const f=document.getElementById("admin-filter-car-make");f&&f.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(p=>p.make))].sort().forEach(p=>{const v=document.createElement("option");v.value=p,v.textContent=p,f.appendChild(v)});const k=((l=document.getElementById("admin-filter-car-status"))==null?void 0:l.value)||"all",E=((g=document.getElementById("admin-filter-car-make"))==null?void 0:g.value)||"all";k!=="all"&&(n=n.filter(S=>S.status===k)),E!=="all"&&(n=n.filter(S=>S.make===E))}if(e==="bookings"){const f=document.getElementById("filter-booking-staff");f&&f.options.length<=1&&window.state.users&&window.state.users.forEach(h=>{if(h.email!=="zyrozyro98@gmail.com"&&(h.role==="admin"||h.role==="supervisor"||h.role==="staff")){const C=document.createElement("option");C.value=h.id,C.textContent=h.name||h.email||"مستخدم غير محدد",f.appendChild(C)}});const k=document.getElementById("filter-booking-sub-status");if(k&&k.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const E=((u=document.getElementById("filter-booking-status"))==null?void 0:u.value)||window.state.bookingFilter||"all",S=((c=document.getElementById("filter-booking-sub-status"))==null?void 0:c.value)||window.state.bookingSubStatusFilter||"all",p=((m=document.getElementById("filter-booking-staff"))==null?void 0:m.value)||"all",v=((I=document.getElementById("filter-booking-type"))==null?void 0:I.value)||"all";window.state.bookingFilter=E,window.state.bookingSubStatusFilter=S,E!=="all"&&(n=n.filter(h=>{let C=h.status||"new";return E==="cancelled"&&(C==="rejected"||C==="cancelled")?!0:C===E})),S!=="all"&&(n=n.filter(h=>h.subStatus===S)),p!=="all"&&(n=n.filter(h=>h.assignedTo===p)),v!=="all"&&(n=n.filter(h=>(h.customerType||"individual")===v)),!(((b=window.state.userProfile)==null?void 0:b.role)==="admin"||((w=window.state.userProfile)==null?void 0:w.role)==="supervisor")&&window.state.user&&(n=n.filter(h=>h.assignedTo===window.state.user.uid))}if(e==="users"){n=n.filter(p=>p.email!=="zyrozyro98@gmail.com");const f=window.state.userRoleFilter||"all";f!=="all"&&(n=n.filter(p=>p.role===f));const k=document.getElementById("stat-users-total"),E=document.getElementById("stat-users-active"),S=document.getElementById("stat-users-admins");if(k&&(k.innerText=n.length),E){E.innerText=n.filter(v=>v.isAvailable).length;const p=E.nextElementSibling;p&&(p.innerText="متواجد حالياً")}if(S){const p=S.nextElementSibling;if(f==="all")S.innerText=n.filter(v=>v.role==="admin").length,p&&(p.innerText="مدراء النظام");else{S.innerText=n.length;const v={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};p&&(p.innerText="إجمالي الـ "+(v[f]||""))}}}if(e==="bookings"?(((y=document.getElementById("filter-booking-sort"))==null?void 0:y.value)||"newest")==="oldest"?n.sort((k,E)=>new Date(k.createdAt||0)-new Date(E.createdAt||0)):n.sort((k,E)=>new Date(E.createdAt||0)-new Date(k.createdAt||0)):n.sort((f,k)=>new Date(k.createdAt||0)-new Date(f.createdAt||0)),n.length===0){t.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(e==="users"){const f=window.state.bookings||[],k=((x=window.state.userProfile)==null?void 0:x.role)==="admin";let E=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;n.forEach(S=>{const p=f.filter(B=>B.assignedTo===S.id),v=p.filter(B=>B.status==="sold"||B.status==="done").length,T=p.filter(B=>B.status==="new"||B.status==="waiting"||B.status==="inquiry"||!B.status).length,h=p.filter(B=>B.status==="cancelled").length,$={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[S.role]||"مندوب",R=S.image||"logo.jpg",D=S.phone||"";let L="";if(D){let B=D.replace(/\D/g,"");B=window.normalizePhone(B),L=`<a href="https://wa.me/${B}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}E+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
              <td style="padding:15px;">
                  <div style="display:flex; align-items:center; gap:12px;">
                      ...
                      <div>
                          ...
                          ${D?`<span style="font-size:12px; color:var(--text-dim);">${D}</span>`:""}
                      </div>
                  </div>
              </td>
            ...
            <div class="admin-item-row car-admin-row" style="background:rgba(255,255,255,0.02); padding:12px; border-radius:16px; border:1px solid var(--glass-border); margin-bottom:12px; display:flex; align-items:center; gap:20px; transition:all 0.3s ease;">
                ...
                <div class="admin-item-info" style="flex-grow:1;">
                    ...
                    <div class="meta-row" style="font-size:12px; color:var(--text-dim); display:flex; gap:15px; flex-wrap:wrap;">
                        <span><i class="fas fa-microchip"></i> ${t.engineSize?t.engineSize+" cc":Number(t.mileage||0).toLocaleString()+" كم"}</span>
    ...
    `}if(e==="logs")return`
        ...
        `;if(e==="sales"){const f=(t.url||"").trim();let k=f.includes("youtube.com")||f.includes("youtu.be"),E=t.poster||t.image||null;if(k&&!E){let S="";try{f.includes("v=")?S=f.split("v=")[1].split("&")[0]:f.includes("youtu.be/")?S=f.split("youtu.be/")[1].split("?")[0]:f.includes("embed/")?S=f.split("embed/")[1].split("?")[0]:S=f.split("/").pop().split("?")[0]}catch{S=""}S&&(E=`https://img.youtube.com/vi/${S}/mqdefault.jpg`)}return E=E||"logo.jpg",`
        ...
        `}if(e==="reviews"){const f=Number(t.rating||5),k=t.text?t.text.length>60?t.text.substring(0,60)+"...":t.text:"لا يوجد نص",E=t.avatar||t.image||"";return`
        <div class="admin-item-row" style="background:rgba(255,255,255,0.02); padding:15px; border-radius:16px; border:1px solid var(--glass-border); margin-bottom:12px; display:flex; align-items:center; gap:20px;">
  ...
  `;e.innerHTML=n};window.reorderCarImage=function(e,t){const n=window.state.carImages,o=e+t;if(o>=0&&o<n.length){const i=n[e];n[e]=n[o],n[o]=i,window.renderCarImageManager()}};window.removeCarImage=function(e){if(e<0||e>=window.state.carImages.length)return;const t=window.state.carImages[e].isMain;window.state.carImages.splice(e,1),t&&window.state.carImages.length>0&&(window.state.carImages[0].isMain=!0),window.renderCarImageManager()};window.handleImageDragStart=function(e,t){e.dataTransfer.setData("text/plain",t),e.currentTarget.classList.add("dragging")};window.handleImageDragOver=function(e){e.preventDefault(),e.currentTarget.classList.add("drag-over")};window.handleImageDragLeave=function(e){e.currentTarget.classList.remove("drag-over")};window.handleImageDragEnd=function(e){e.currentTarget.classList.remove("dragging")};window.handleImageDrop=function(e,t){e.preventDefault(),e.currentTarget.classList.remove("drag-over");const n=parseInt(e.dataTransfer.getData("text/plain"));if(n!==t){const o=window.state.carImages,i=o.splice(n,1)[0];o.splice(t,0,i),window.renderCarImageManager()}};window.setCarMainImage=function(e){window.state.carImages.forEach((t,n)=>t.isMain=n===e),window.renderCarImageManager()};window.saveLuxuryItem=async function(e){e&&e.preventDefault();const t=window.state.currentEdit;if(!t)return;const{type:n,id:o}=t,i=document.getElementById("item-form");if(!i)return;const a=i.querySelector('button[type="submit"]'),r=a.innerText;a&&(a.disabled=!0,a.innerText="جاري الحفظ والمعالجة...");const d=new FormData(i),s={};d.forEach((l,g)=>{if(g!=="main_img_file"&&g!=="gallery_files"){if(g==="password"&&!l)return;s[g]=l}});try{if(n==="cars"){const u=[];let c="";const m=window.state.carImages||[];for(let I=0;I<m.length;I++){const b=m[I];let w="";b.type==="url"?w=b.value:b.type==="file"&&(w=await window.compressImage(b.value,1e3,1e3,.6)),w&&(u.push(w),b.isMain&&(c=w))}!c&&u.length>0&&(c=u[0]),s.image=c,s.images=u}const l=["image","logo","avatar","poster"];for(const u of l)s[u]instanceof File&&s[u].size>0?s[u]=await window.compressImage(s[u],1e3,1e3,.7):s[u]instanceof File&&s[u].size===0&&delete s[u];if(["price","year","mileage","rating","installmentPeriod","monthlyInstallment","engineSize"].forEach(u=>{s[u]!==void 0&&s[u]!==""&&s[u]!==null?s[u]=Number(s[u]):delete s[u]}),s.isFeatured!==void 0&&(s.isFeatured=s.isFeatured==="true"||s.isFeatured===!0),o||(s.createdAt=new Date().toISOString()),s.updatedAt=new Date().toISOString(),n==="users"&&!o){if(!s.password){window.showLuxuryToast("كلمة المرور مطلوبة للموظف الجديد","error"),a&&(a.disabled=!1,a.innerText=r);return}const u=pe(ge,"Secondary"),c=me(u);try{const I=(await Se(c,s.email,s.password)).user.uid,b=A(M,`users/${I}`);await F(b,s),await de(u)}catch(m){throw await de(u),m}}else{if(n==="users"){const c=window._waServerActiveUrl||G;try{await fetch(`${c}/api/admin/update-user`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({adminUid:window.state.user.uid,targetUid:o,data:{password:s.password,email:s.email,name:s.name}})})}catch(m){console.warn("Backend Auth Sync failed:",m)}}const u=o?A(M,`${n}/${o}`):j(A(M,n));await(o?q(u,s):F(u,s)),n==="cars"&&(s.gearbox&&!(window.state.gearboxes||[]).some(c=>c.name===s.gearbox)&&(["عادي","أوتوماتيكي","CVT"].includes(s.gearbox)||await j(A(M,"gearboxes"),{name:s.gearbox})),s.bodyType&&!(window.state.bodyTypes||[]).some(c=>c.name===s.bodyType)&&(["sedan","suv","coupe","luxury","pickup"].includes(s.bodyType)||["سيدان","SUV","كوبيه","فاخرة","بيك آب"].includes(s.bodyType)||await j(A(M,"bodyTypes"),{name:s.bodyType})),s.make&&!(window.state.brands||[]).some(c=>c.name===s.make)&&await j(A(M,"brands"),{name:s.make}),s.engine&&!(window.state.engines||[]).some(c=>c.name===s.engine)&&(["4 سليندر","6 سليندر","8 سليندر"].includes(s.engine)||await j(A(M,"engines"),{name:s.engine})),s.color&&!(window.state.exteriorColors||[]).some(c=>c.name===s.color)&&(["أبيض","أسود","فضي","رمادي"].includes(s.color)||await j(A(M,"exteriorColors"),{name:s.color})),s.interiorColor&&!(window.state.interiorColors||[]).some(c=>c.name===s.interiorColor)&&(["بيج","أسود","جملي","أحمر"].includes(s.interiorColor)||await j(A(M,"interiorColors"),{name:s.interiorColor})),s.status&&!(window.state.stockStatuses||[]).some(c=>c.name===s.status)&&(["available","reserved","sold","incoming"].includes(s.status)||await j(A(M,"stockStatuses"),{name:s.status})))}window.showLuxuryToast(o?"تم تحديث البيانات بنجاح":"تم إضافة العنصر بنجاح"),window.closeModal("item-modal"),window.createLog(o?"تعديل":"إضافة",`${o?"تعديل":"إضافة"} في ${n} - ${s.make||s.title||o}`,"data")}catch(l){console.error("Save Error:",l),window.showLuxuryToast("حدث خطأ أثناء الحفظ: "+(l.message||"خطأ غير معروف"),"error")}finally{a&&(a.disabled=!1,a.innerText=r)}};window.openQuickReplyModal=function(){window.openCRUDModal("quickReplies")};window.renderQuickRepliesAdmin=function(){var o;const e=document.getElementById("quick-replies-list");if(!e)return;const t=(((o=document.getElementById("qr-search"))==null?void 0:o.value)||"").toLowerCase().trim(),n=(window.state.quickReplies||[]).filter(i=>(i.title||"").toLowerCase().includes(t)||(i.content||"").toLowerCase().includes(t));if(n.length===0){e.innerHTML='<div class="no-results-v2" style="grid-column:1/-1;"><p>لا توجد نتائج مطابقة لبحثك</p></div>';return}e.innerHTML=n.map(i=>`
    ...
    `;const l=s.querySelector(".fa-times-btn");l.onmouseover=()=>l.style.color="#e02424",l.onmouseout=()=>l.style.color="#999";const g=async()=>{var m;try{await j(A(M,"notifications"),{userId:n||((m=window.state.userProfile)==null?void 0:m.id)||"admin",type:"wa_message",title:"رسالة واتساب من "+r,body:d,phone:e,read:!1,createdAt:new Date().toISOString()})}catch(I){console.warn("Could not save to notifications DB",I)}};let u=setTimeout(()=>{c(),g()},1e4);const c=()=>{s.style.transform="translateX(-120%)",s.style.opacity="0",s.style.marginTop=`-${s.offsetHeight}px`,setTimeout(()=>{s.parentNode&&s.parentNode.removeChild(s)},400)};l.onclick=m=>{m.stopPropagation(),clearTimeout(u),c()},s.onclick=()=>{clearTimeout(u),c(),a?(window.viewBookingDetails(a.id),setTimeout(()=>{const m=document.getElementById("details-modal").querySelector(".dash-tab.admin-only");m&&m.click()},100)):window.showLuxuryToast("الرسالة من رقم غير مسجل في أي طلب مفتوح","info")},o.insertBefore(s,o.firstChild),requestAnimationFrame(()=>{s.style.transform="translateX(0)",s.style.opacity="1"})};window.startCurrentWASession=function(){if(!window.state.user)return;const e=()=>{_.emit("start_session",{userId:window.state.user.uid});const t=document.getElementById("wa-my-status-title"),n=document.getElementById("wa-my-status-desc");t&&(t.innerText="جاري الاتصال..."),n&&(n.innerText="يتم الآن التواصل مع خادم الواتساب لتوليد رمز الاستجابة السريعة...")};_?_.connected?e():(_.once("connect",e),_.connect()):window.initWhatsAppServer()};window.logoutCurrentWASession=function(){window.state.user&&confirm("هل أنت متأكد من تسجيل الخروج من واتساب؟ لن تتمكن من المراسلة من هنا.")&&_&&_.emit("logout_session",{userId:window.state.user.uid})};window._waMediaCache=window._waMediaCache||{};window.fetchServerWAChat=async function(e,t){var i,a,r;if(!e)return;const n=document.getElementById("wa-server-chat-box");if(!n)return;let o=(i=window.state.userProfile)==null?void 0:i.id;if(((a=window.state.userProfile)==null?void 0:a.role)==="admin"||((r=window.state.userProfile)==null?void 0:r.role)==="supervisor")if(t)o=t;else{const s=(window.state.bookings||[]).find(l=>l.phone&&window.normalizePhone(l.phone)===window.normalizePhone(e));if(s&&s.assignedTo)o=s.assignedTo;else{n.innerHTML=`
                <div style="text-align:center; margin-top:auto; margin-bottom:auto;">
                    <div style="background:rgba(255,255,255,0.95); display:inline-block; padding:20px; border-radius:15px; font-size:13px; color:#555; box-shadow:0 10px 30px rgba(0,0,0,0.1); max-width:85%;">
                        ...
                        سجل المحادثات متاح فقط للحجوزات المسندة.
                                ...
                                <button id="${f}" class="btn-premium btn-sm" onclick="window.downloadWAMedia('${o}', '${e}', '${c.id}', '${k}', '${c.media.mimetype}', '${c.type}')" style="padding:4px 10px; min-width:40px;"><i class="fas fa-download"></i></button>
