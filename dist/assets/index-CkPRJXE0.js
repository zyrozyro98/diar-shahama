import{i as se,g as ue,a as pe,b as re,c as me,d as ge,s as fe,o as we,r as L,e as Y,u as q,f as O,h as j,j as K,k as ye,l as be,p as P,m as ve,n as ne,q as he,t as xe}from"./firebase-BfvlcbVS.js";import"./emoji-picker-CeBMFWb3.js";import"./vendor-Bg_btqvK.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function o(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(i){if(i.ep)return;i.ep=!0;const a=o(i);fetch(i.href,a)}})();const le={apiKey:"AIzaSyDQodWTn2wa0WzQuHqzZt2Ex6CdnQdrlUU",authDomain:"onecar1.firebaseapp.com",projectId:"onecar1",storageBucket:"onecar1.firebasestorage.app",messagingSenderId:"735648367644",appId:"1:735648367644:web:44ae368553280b14bdcbd9",measurementId:"G-RSTPV8SRXT",databaseURL:"https://onecar1-default-rtdb.firebaseio.com"},V=se(le);ue(V);const C=pe(V),Q=re(V);me(V);ge(V);window.state={cars:[],ads:[],bookings:[],users:[],notifications:[],logs:[],partners:[],locations:[],brands:[],agents:[],specs:[],packages:[],blogs:[],reviews:[],plates:[],sales:[],gearboxes:[],bodyTypes:[],engines:[],exteriorColors:[],interiorColors:[],stockStatuses:[],user:null,userProfile:null,settings:{enableTextGradient:!0,textGradColor1:"#b8860b",textGradColor2:"#ffffff",enableTopbarGradient:!0,topbarGradColor1:"#a11d21",topbarGradColor2:"#05080c",enablePrimaryGradient:!0,primaryGradColor1:"#a11d21",primaryGradColor2:"#1c7c8c"},lang:localStorage.getItem("luxury_lang")||"ar",soundEnabled:localStorage.getItem("luxury_sound_enabled")!=="false",tempImages:[],bookingFilter:"all",bookingSubStatusFilter:"all",currentReportPeriod:"day",firstLoadDone:!1,inventoryPage:1,inventorySize:8,sliderIndex:0};const ke={ar:{welcome:"مرحباً بك في عالم الفخامة",inventory:"مخزون السيارات المتاح",totalCars:"إجمالي السيارات",totalBookings:"إجمالي الطلبات",totalValue:"قيمة المخزون",searchPlaceholder:"ابحث عن سيارتك المثالية...",loading:"جاري التحميل...",noResults:"لم يتم العثور على نتائج تطابق بحثك",applyNow:"اطلبها الآن",details:"عرض التفاصيل",back:"رجوع",save:"حفظ",delete:"حذف",edit:"تعديل",cancel:"إلغاء",successMsg:"تمت العملية بنجاح",errorMsg:"حدث خطأ غير متوقع",staff:"قسم المبيعات والمتابعة",admin:"إدارة النظام",supervisor:"مشرف النظام"},en:{welcome:"Welcome to the World of Luxury",inventory:"Available Vehicle Inventory",totalCars:"Total Vehicles",totalBookings:"Total Bookings",totalValue:"Inventory Value",searchPlaceholder:"Search for your perfect car...",loading:"Loading...",noResults:"No results found matching your search",applyNow:"Request Now",details:"View Details",back:"Back",save:"Save",delete:"Delete",edit:"Edit",cancel:"Cancel",successMsg:"Operation successful",errorMsg:"An unexpected error occurred",staff:"Sales & Follow-up Department",admin:"System Administration",supervisor:"System Supervisor"}};window.showLuxuryToast=function(e,t="success"){const o=document.getElementById("toast-container");if(!o)return;const n=document.createElement("div");n.className=`toast-v2 ${t}`,n.style.cssText=`
  ...
  `;const i=t==="success"?"fa-check-circle":"fa-exclamation-circle";n.innerHTML=`<i class="fas ${i}"></i> <span>${e}</span>`,o.appendChild(n),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(-20px)",n.style.transition="all 0.4s ease-in",setTimeout(()=>n.remove(),400)},4e3)};window.compressImage=function(e,t=1e3,o=1e3,n=.6){return new Promise((i,a)=>{if(!e||!(e instanceof File||e instanceof Blob)){i(e);return}const r=new FileReader;r.readAsDataURL(e),r.onload=d=>{const s=new Image;s.src=d.target.result,s.onload=()=>{const l=document.createElement("canvas");let g=s.width,u=s.height;g>u?g>t&&(u*=t/g,g=t):u>o&&(g*=o/u,u=o),l.width=g,l.height=u,l.getContext("2d").drawImage(s,0,0,g,u);const m=e.type==="image/png"||e.type==="image/webp"?"image/webp":"image/jpeg";i(l.toDataURL(m,n))},s.onerror=a},r.onerror=a})};window.openModal=function(e){const t=document.getElementById(e);if(t){t.classList.remove("hidden"),document.body.style.overflow="hidden";const o=document.querySelectorAll(".modal:not(.hidden)");t.style.zIndex=2e3+o.length*10,Ie(`modal-${e}`)}};window.closeModal=function(e,t=!1){var n;const o=document.getElementById(e);o&&(o.classList.add("hidden"),o.style.zIndex="",!t&&((n=history.state)==null?void 0:n.type)===`modal-${e}`&&history.back(),document.querySelector(".modal:not(.hidden)")||(document.body.style.overflow="auto"))};window.setModalTitle=function(e,t){const o=document.getElementById(e+"-title");o&&(o.innerText=t)};window.switchLuxuryTab=function(e){const t=document.querySelectorAll(".pane, .admin-tab-content"),o=document.querySelectorAll(".dash-tab, .admin-sidebar-nav li");t.forEach(r=>r.classList.add("hidden")),o.forEach(r=>r.classList.remove("active"));const n=document.getElementById(e),i=document.querySelector(`[data-tab="${e}"]`);n&&(n.classList.remove("hidden"),n.classList.add("active"),n.style.animation="fade-up 0.5s ease-out forwards"),i&&i.classList.add("active");const a=document.getElementById("bookings-submenu");if(a&&a.classList.toggle("active",e==="bookings-mgmt"||e==="all-bookings"),window.innerWidth<1024){const r=document.querySelector(".dash-sidebar, .admin-sidebar-v2");r&&r.classList.remove("active")}e==="whatsapp-monitor-mgmt"&&window.initWhatsAppServer&&window.initWhatsAppServer(),e==="whatsapp-mgmt"&&window.startCurrentWASession(),e==="quick-replies-mgmt"&&window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin()};function Ie(e){var t;((t=history.state)==null?void 0:t.type)!==e&&history.pushState({type:e},"")}window.normalizePhone=function(e){if(!e)return"";const t=e.toString().trim();if(t.includes("@s.whatsapp.net"))return t.split("@")[0].replace(/\D/g,"");if(t.includes("@lid"))return t;let o=t.replace(/\D/g,"");if(o.startsWith("9660")?o="966"+o.substring(4):o.startsWith("9670")&&(o="967"+o.substring(4)),o.startsWith("966")||o.startsWith("967"))return o;if(o.startsWith("05"))return"966"+o.substring(1);if(o.startsWith("07"))return"967"+o.substring(1);if(o.startsWith("0"))return"966"+o.substring(1);if(o.length===9){if(o.startsWith("7"))return"967"+o;if(o.startsWith("5"))return"966"+o}return o};document.addEventListener("DOMContentLoaded",()=>{Ee(),de(),Se(),window.trackVisit(),$e()});function $e(){const e=document.querySelector(".mobile-btn"),t=document.querySelector(".nav-menu"),o=document.querySelector(".mobile-nav-overlay"),n=document.querySelector(".menu-close-btn"),i=(y=!1)=>{const b=y===!1?!t.classList.contains("active"):!1;t.classList.toggle("active",b),o.classList.toggle("active",b),document.body.style.overflow=b?"hidden":"";const x=e==null?void 0:e.querySelector("i");x&&(x.className=b?"fas fa-times":"fas fa-bars-staggered")};e&&(e.onclick=()=>i()),o&&(o.onclick=()=>i(!0)),n&&(n.onclick=()=>i(!0)),document.querySelectorAll(".nav-menu a").forEach(y=>{y.addEventListener("click",()=>i(!0))});const a=document.querySelector(".mobile-menu-header .dynamic-name-ar");a&&window.__DYNAMIC_NAME_AR__&&(a.innerText=window.__DYNAMIC_NAME_AR__);const r=document.getElementById("admin-trigger");r&&(r.onclick=y=>{y.preventDefault(),window.openModal("admin-modal")});const d=document.getElementById("theme-btn");d&&(d.onclick=()=>{const b=(document.body.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.body.setAttribute("data-theme",b),localStorage.setItem("luxury_theme",b),localStorage.setItem("theme_manually_overridden","true"),d.innerHTML=b==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>'});const s=document.getElementById("lang-btn");s&&(s.onclick=()=>{window.state.lang=window.state.lang==="ar"?"en":"ar",localStorage.setItem("luxury_lang",window.state.lang),de(),window.applyInventoryFilters(),s.innerText=window.state.lang==="ar"?"EN":"AR"}),document.querySelectorAll(".dash-tab").forEach(y=>{y.onclick=()=>window.switchLuxuryTab(y.dataset.tab)});const l=document.getElementById("car-search-input");l&&(l.oninput=()=>window.applyInventoryFilters()),["filter-make","filter-type","filter-year","filter-sort"].forEach(y=>{const b=document.getElementById(y);b&&(b.onchange=()=>{window.state.inventoryPage=1,window.applyInventoryFilters()})});const u=document.getElementById("p-prev"),c=document.getElementById("p-next");u&&(u.onclick=()=>window.moveLuxurySlider(-1)),c&&(c.onclick=()=>window.moveLuxurySlider(1)),setInterval(()=>{const y=document.getElementById("luxury-splash");(!y||y.classList.contains("hidden"))&&window.moveLuxurySlider(1)},5e3),["calc-car-price","calc-down-pay","calc-years"].forEach(y=>{const b=document.getElementById(y);b&&(b.oninput=()=>window.calculateLuxuryFinancing()),b&&b.tagName==="SELECT"&&(b.onchange=()=>window.calculateLuxuryFinancing())}),document.querySelectorAll(".modal-close").forEach(y=>{y.onclick=b=>{b.stopPropagation();const x=y.closest(".modal");if(x){if(x.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(x.id)}}}),window.onclick=y=>{const b=document.getElementById("wa-emoji-picker");if(b&&b.style.display!=="none"){const k=y.target.closest(".fa-smile")!==null,$=b.contains(y.target);!k&&!$&&(b.style.display="none")}const x=Array.from(document.querySelectorAll(".modal:not(.hidden)"));if(x.length>0){const k=x[x.length-1];if(y.target===k){if(k.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(k.id)}}},window.addEventListener("popstate",y=>{const b=document.querySelectorAll(".modal:not(.hidden)");b.length>0&&b.forEach(x=>{var k;((k=y.state)==null?void 0:k.type)!==`modal-${x.id}`&&window.closeModal(x.id,!0)})}),window.onscroll=()=>{const y=document.getElementById("main-nav");y&&y.classList.toggle("scrolled",window.scrollY>50);const b=document.getElementById("scroll-jump");b&&b.classList.toggle("hidden",window.scrollY<500)},document.getElementById("scroll-jump")&&(document.getElementById("scroll-jump").onclick=()=>window.scrollTo({top:0,behavior:"smooth"}));const I=document.getElementById("login-form");I&&(I.onsubmit=y=>window.loginAdmin(y));const v=document.getElementById("booking-form");v&&(v.onsubmit=y=>window.submitBooking(y));const w=document.getElementById("item-form");w&&(w.onsubmit=y=>window.saveLuxuryItem(y))}function Ee(){const e=JSON.parse(localStorage.getItem("luxury-settings-cache")||"{}"),t=localStorage.getItem("theme_manually_overridden")==="true",o=(t?localStorage.getItem("luxury_theme"):e.defaultTheme)||"dark";t||localStorage.setItem("luxury_theme",o),document.body.setAttribute("data-theme",o);const n=document.getElementById("theme-btn");n&&(n.innerHTML=o==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}function de(){const e=window.state.lang;document.body.dir=e==="ar"?"rtl":"ltr",document.body.classList.toggle("en",e==="en");const t=ke[e];document.querySelectorAll("[data-i18n]").forEach(o=>{const n=o.getAttribute("data-i18n");t[n]&&(o.innerText=t[n])})}async function Se(){await fe(Q,xe);const e=["users","plates","locations","brands","agents","specs","packages","blogs","reviews","cars","ads","sales","settings","partners","custom_presets","gearboxes","bodyTypes","engines","exteriorColors","interiorColors","stockStatuses"],t=["bookings","notifications","logs","quickReplies"],o={};function n(i){o[i]||(o[i]=Y(L(C,i),a=>{var d,s;const r=a.val();if(i==="settings")window.state.settings=r||{},window.applySettings(r);else{const l=window.state[i]||[],g=r?Object.entries(r).map(([u,c])=>({...c,id:u})):[];if(window.state[i]=g,i==="cars"&&window.applyInventoryFilters(),i==="ads"&&window.renderAdsSlider(),i==="sales"&&window.renderSalesVideos(),i==="partners"&&window.renderPartners(),i==="reviews"&&window.renderPublicReviews(),i==="custom_presets"&&window.renderCustomPresets(),i==="notifications"&&window.state.user&&window.state.firstLoadDone){const u=((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor",c=v=>v.filter(w=>!w.read&&(u||w.userId===window.state.user.uid||w.assignedTo===window.state.user.uid)),m=c(l).length;c(g).length>m&&window.playNotificationSound&&window.playNotificationSound()}window.state.user&&(window.syncAdminTables(i),window.updateStatistics())}Te()},a=>{console.warn(`Listener for ${i} failed:`,a.message),delete o[i]}))}we(Q,async i=>{if(window.state.user=i,i){const a=L(C,`users/${i.uid}`);Y(a,r=>{window.state.userProfile={...r.val(),id:i.uid},ie(),window.initWhatsAppServer&&window.initWhatsAppServer()}),t.forEach(n)}else window.state.userProfile=null,ie(),t.forEach(a=>{o[a]&&delete o[a]})}),e.forEach(n)}function Te(){var n,i;if(window.state.firstLoadDone)return;const e=window.state.settings,t=e==null?void 0:e.maintenanceMode,o=((n=window.state.userProfile)==null?void 0:n.role)==="admin"||((i=window.state.userProfile)==null?void 0:i.role)==="supervisor";if(t&&!o){const a=document.getElementById("luxury-splash");a&&(a.innerHTML=`
    ...
    `).join("")})};window.viewMonitorChat=function(e,t){const o=document.getElementById("monitor-chat-body"),n=document.getElementById("monitor-chat-header");if(!o||!n)return;n.innerText=`مراقبة: ${t}`,o.innerHTML='<div class="loading-v2">جاري تحميل الرسائل...</div>';const i=L(C,`messages/${e}`);Y(i,a=>{const r=[];a.forEach(d=>r.push(d.val())),o.innerHTML=r.map(d=>`
    ...
    `).join(""),o.scrollTop=o.scrollHeight})};window.renderSupervisorStaffList=function(){const e=document.getElementById("supervisor-staff-list-v2");if(!e)return;const t=(window.state.users||[]).filter(n=>n.role==="staff"),o=window.state.bookings||[];if(t.length===0){e.innerHTML='<tr><td colspan="6" style="text-align:center; padding:30px; opacity:0.5;">لا يوجد موظفين مسجلين حالياً</td></tr>';return}e.innerHTML=t.map((n,i)=>{const a=o.filter(g=>g.assignedTo===n.id),r=a.filter(g=>g.status==="sold"||g.status==="done").length,d=a.length>0?Math.round(r/a.length*100):0,l=(n.phone||"").replace(/\D/g,"");return`
  ...
  `).join(""),n.scrollIntoView({behavior:"smooth",block:"nearest"})};window.updateStaffName=async function(e){const t=prompt("أدخل الإسم الجديد للموظف:");if(t)try{await q(L(C,`users/${e}`),{name:t}),window.showLuxuryToast("تم تحديث الإسم بنجاح"),window.renderSupervisorStaffList()}catch{window.showLuxuryToast("خطأ في التحديث","error")}};window.deleteStaff=async function(e){if(confirm("هل أنت متأكد من حذف هذا الموظف؟ لن يتمكن من تسجيل الدخول بعد الآن."))try{await O(L(C,`users/${e}`)),window.showLuxuryToast("تم حذف الموظف من النظام"),window.renderSupervisorStaffList()}catch{window.showLuxuryToast("خطأ في الحذف","error")}};window.toggleAvailability=async function(){if(!window.state.userProfile)return;const e=window.state.userProfile.isAvailable||!1;try{await q(L(C,`users/${window.state.user.uid}`),{isAvailable:!e}),window.state.userProfile.isAvailable=!e,window.showLuxuryToast(e?"تم تعيين الحالة: غير متاح":"أنت متاح الآن لاستلام الطلبات"),window.updateStatistics()}catch{window.showLuxuryToast("فشل تحديث الحالة","error")}};window.toggleSound=function(){window.state.soundEnabled=!window.state.soundEnabled,localStorage.setItem("luxury_sound_enabled",window.state.soundEnabled);const e=document.getElementById("sound-toggle");e&&(e.checked=window.state.soundEnabled),window.showLuxuryToast(window.state.soundEnabled?"تم تفعيل التنبيهات الصوتية":"تم كتم التنبيهات")};window.setBookingFilter=function(e,t,o="all",n=null){window.state.bookingFilter=e,window.state.bookingSubStatusFilter=o;const i=document.getElementById("filter-booking-status");i&&i.value!==e&&(i.value=e);const a=document.getElementById("filter-booking-sub-status");if(a){const r={new:["not_contacted","contacted"],waiting:["docs_received","waiting_calc","waiting_docs","waiting_signature"],inquiry:["docs_not_received"],sold:["signed","delivered"],done:["done"],cancelled:["no_response","obligations","calc_rejected","ineligible","duplicate"]},d={not_contacted:"لم يتم التواصل",contacted:"تم التواصل",docs_received:"تم استلام الاوراق",waiting_calc:"انتظار رد العميل",waiting_docs:"إنتظار إكمال الاوراق",waiting_signature:"إنتظار توقيع العميل",docs_not_received:"لم يتم استلام الاوراق",signed:"تم التوقيع",delivered:"تم التسليم",done:"تم",no_response:"لم يتم رد العميل",obligations:"التزامات",calc_rejected:"رفض الحسبة",ineligible:"غير مسموح له",duplicate:"مكرر"};let s=e==="all"?Object.keys(d):r[e]||[];a.innerHTML='<option value="all">جميع الحالات الفرعية</option>',s.forEach(l=>{const g=document.createElement("option");g.value=l,g.textContent=d[l],a.appendChild(g)}),Array.from(a.options).some(l=>l.value===o)?a.value=o:(a.value="all",window.state.bookingSubStatusFilter="all",o="all")}document.querySelectorAll(".sub-tab.b-filter").forEach(r=>{if(r.getAttribute("onclick")&&r.getAttribute("onclick").includes(`'${e}'`)){document.querySelectorAll(".sub-tab.b-filter").forEach(s=>s.classList.remove("active")),r.classList.add("active"),document.querySelectorAll(".deep-submenu").forEach(s=>s.classList.remove("active"));const d=r.closest(".status-group");if(d){const s=d.querySelector(".deep-submenu");s&&s.classList.add("active")}}}),document.querySelectorAll(".deep-tab").forEach(r=>{r.classList.remove("active"),o!=="all"&&r.getAttribute("onclick")&&r.getAttribute("onclick").includes(`'${o}'`)&&r.classList.add("active")}),window.syncAdminTables("bookings")};window.applyInventoryFilters=function(){var w,y,b,x,k,$,T;if(!document.getElementById("cars-container"))return;const t=document.getElementById("filter-make"),o=document.getElementById("filter-year");t&&t.options.length<=1&&[...new Set(window.state.cars.map(h=>h.make))].sort().forEach(h=>{const E=document.createElement("option");E.value=h,E.textContent=h,t.appendChild(E)}),o&&o.options.length<=1&&[...new Set(window.state.cars.map(h=>h.year))].filter(Boolean).sort((h,E)=>E-h).forEach(h=>{const E=document.createElement("option");E.value=h,E.textContent=h,o.appendChild(E)});const n=document.getElementById("filter-type");if(n&&n.options.length<=1){const p={sedan:"سيدان",suv:"SUV",coupe:"كوبيه",luxury:"فاخرة",pickup:"بيك آب"};[...new Set(window.state.cars.map(E=>E.bodyType))].filter(Boolean).sort().forEach(E=>{const f=document.createElement("option");f.value=E,f.textContent=p[E]||E,n.appendChild(f)})}const i=(((w=document.getElementById("car-search-input"))==null?void 0:w.value)||"").toLowerCase(),a=((y=document.getElementById("filter-make"))==null?void 0:y.value)||"all",r=((b=document.getElementById("filter-type"))==null?void 0:b.value)||"all",d=((x=document.getElementById("filter-year"))==null?void 0:x.value)||"all",s=((k=document.getElementById("filter-sort"))==null?void 0:k.value)||"newest";let l=(($=window.state.cars)==null?void 0:$.filter(p=>{const h=!i||(p.make+" "+p.model).toLowerCase().includes(i),E=a==="all"||p.make===a,f=r==="all"||p.bodyType===r,S=d==="all"||p.year===d;return h&&E&&f&&S}))||[];s==="price-asc"?l.sort((p,h)=>(Number(p.price)||0)-(Number(h.price)||0)):s==="price-desc"?l.sort((p,h)=>(Number(h.price)||0)-(Number(p.price)||0)):s==="year-asc"?l.sort((p,h)=>(Number(p.year)||0)-(Number(h.year)||0)):l.sort((p,h)=>new Date(h.createdAt||0)-new Date(p.createdAt||0));const g=((T=window.state.cars)==null?void 0:T.filter(p=>p.isFeatured).slice(0,3))||[];Be(g.length>0?g:window.state.cars.slice(0,3));const u=l.length,c=window.state.inventoryPage||1,m=window.state.inventorySize||8,I=(c-1)*m,v=l.slice(I,I+m);renderCarGrid(v),Le(u,c,m)};function Be(e){const t=document.getElementById("featured-offers-container");if(!t||!e.length)return;const o=document.getElementById("featured-offers-section");o&&(o.style.display="block"),t.innerHTML=e.map(n=>`
  ...
  `}).join("")}};window.renderCarGrid=function(e){const t=document.getElementById("cars-container");if(t){if(e.length===0){t.innerHTML='<div class="no-results-v2"><i class="fas fa-search"></i> <p>لم يتم العثور على سيارات تطابق بحثك</p></div>';return}t.innerHTML=e.map(o=>`
...
*القسط الشهري يبدأ من:* ${Number(t.monthlyInstallment).toLocaleString()} ريال`:"";`${t.make}${t.model}${t.year}${i}${a}${window.location.origin}${t.id}`;const r=`
  ...
  `,d=document.getElementById("details-modal-body");if(d){d.innerHTML=r,d.scrollTop=0;const s=document.getElementById("details-modal");if(s){s.scrollTop=0;const l=s.querySelector(".modal-inner");l&&(l.scrollTop=0)}window.openModal("details-modal")}window.trackCarView(e)};window.bookCar=function(e){const t=window.state.cars.find(i=>i.id===e);if(!t)return;const o=document.getElementById("b-car");o&&(o.value=`${t.make} ${t.model} ${t.year}`),window.closeModal("details-modal");const n=document.getElementById("booking");n&&(n.scrollIntoView({behavior:"smooth"}),o&&(o.focus(),o.style.borderColor="var(--p-copper)",setTimeout(()=>o.style.borderColor="",2e3)))};window.viewBookingDetails=function(e){var a;const t=(window.state.bookings||[]).find(r=>r.id===e);if(!t)return;(a=window.state.users.find(r=>r.id===t.assignedTo))!=null&&a.name,t.status==="sold"||t.status==="available"||t.status==="rejected"||t.status,t.status==="sold"||t.status;const o={new:"جديد",waiting:"بالانتظار",inquiry:"استفسار",sold:"مكتمل",rejected:"مرفوض",available:"متاح"},n=`
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px; margin-bottom:15px;">
                <div class="f-group">
                    ...
                    <select id="update-booking-status" onchange="window.updateSubStatusOptions(this.value)" style="width:100%; border-radius:10px; padding:10px; background:var(--bg-alt); border:1px solid var(--glass-border); color:var(--text-main); font-family:inherit;">
                        ${Object.entries(o).map(([r,d])=>`<option value="${r}" ${r===(t.status||"new")?"selected":""}>${d}</option>`).join("")}
                    </select>
                </div>
                <div class="f-group">
  ...
  `).join("")};window.applySettings=function(e){var S,M,D,_;if(!e)return;const t=document.documentElement;if(e.defaultTheme&&!(localStorage.getItem("theme_manually_overridden")==="true")){document.body.setAttribute("data-theme",e.defaultTheme),localStorage.setItem("luxury_theme",e.defaultTheme);const B=document.getElementById("theme-btn");B&&(B.innerHTML=e.defaultTheme==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}e.primaryColor&&(t.style.setProperty("--p-red",e.primaryColor),t.style.setProperty("--p-red-glow",e.primaryColor+"66")),e.secondaryColor&&t.style.setProperty("--p-teal",e.secondaryColor),e.accentColor&&t.style.setProperty("--p-copper",e.accentColor);const o=e.logo||"logo.jpg";document.querySelectorAll(".logo-wrap img, .sidebar-brand img, .splash-logo img, #footer-logo-img, #nav-logo-img, #splash-logo-img").forEach(A=>{A.src=o});const n=e.nameAr||"ون كار",i=e.nameEn||"ONE CAR",a=window.state.lang==="ar"?n:i;document.querySelectorAll(".dynamic-name-ar").forEach(A=>A.innerText=n),document.querySelectorAll(".dynamic-name-en").forEach(A=>A.innerText=i),document.title=a+" | "+(window.state.lang==="ar"?"الفخامة في عالم السيارات":"Luxury Automotive"),e.fontFamily&&(t.style.setProperty("--font-main",e.fontFamily),document.body.style.fontFamily=e.fontFamily);const r="dynamic-design-styles";let d=document.getElementById(r);d||(d=document.createElement("style"),d.id=r,document.head.appendChild(d));let s="";const l=((S=e.dark)==null?void 0:S.bgColor)||e.bgColor,g=((M=e.dark)==null?void 0:M.textColor)||e.textColor,u=(D=e.light)==null?void 0:D.bgColor,c=(_=e.light)==null?void 0:_.textColor;if(l&&(s+=`body[data-theme="dark"] { --bg-main: ${l}; }
...
`),e.borderRadius&&(t.style.setProperty("--border-radius-main",e.borderRadius+"px"),s+=`
    ...
    `;else{let A=e.glassOpacity!==void 0?e.glassOpacity:.75,B=e.glassBlur!==void 0?e.glassBlur:20;s+=`
    ...
    `}if(e.logoBlend&&e.logoBlend!=="auto"){const A=e.logo||"logo.jpg";e.logoBlend==="mask"?s+=`
    ...
    `),e.enableTextGradient){const A=e.textGradColor1||"#b8860b",B=e.textGradColor2||"#ffffff";s+=`
    ...
    `}if(e.enableTopbarGradient){const A=e.topbarGradColor1||"#a11d21",B=e.topbarGradColor2||"#05080c";s+=`
      .top-bar-luxury {
        background: linear-gradient(90deg, ${A}, ${B}) !important;
      }
    `}if(e.enablePrimaryGradient){const A=e.primaryGradColor1||"#a11d21",B=e.primaryGradColor2||"#1c7c8c";s+=`
    ...
    `}d.innerHTML=s;const m=document.getElementById("about-text-display");m&&(m.innerText=e.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const I=document.getElementById("location-text-display");I&&(I.innerText=e.location||"الرياض - معارض القادسية");const v=document.getElementById("f-phone-admin");v&&(v.innerText=e.contactAdmin||"...");const w=document.getElementById("f-phone-sales");w&&(w.innerText=e.contactSales||"...");const y=document.getElementById("f-phone-info");y&&(y.innerText=e.contactComplaints||"...");const b=document.getElementById("f-email-display");b&&(b.innerText=e.contactEmail||"...");const x=document.getElementById("contact-location-link");x&&(x.href=e.locationUrl||"#");const k=document.getElementById("meta-title");k&&(k.innerText=`${n} | ${e.metaTitle||"الفخامة والجودة تليق بك"}`);const $=document.getElementById("meta-description");$&&$.setAttribute("content",e.metaDesc||"وجهتكم الرائدة للسيارات الفاخرة والمعتمدة.");const T={"f-insta":e.socialInsta,"f-snap":e.socialSnap,"f-twitter":e.socialTwitter};Object.entries(T).forEach(([A,B])=>{const R=document.getElementById(A);R&&(R.href=B||"#")});const p={"set-name-ar":e.nameAr||"","set-name-en":e.nameEn||"","set-color-primary":e.primaryColor||"#a11d21","set-color-secondary":e.secondaryColor||"#1c7c8c","set-color-accent":e.accentColor||"#b8860b","set-color-bg":e.bgColor||"#05080c","set-color-text":e.textColor||"#f8fafc","set-hover-effect":e.hoverEffect||"scale","set-card-style":e.cardStyle||"glass","set-glass-opacity":e.glassOpacity!==void 0?e.glassOpacity:.75,"set-logo-blend":e.logoBlend||"auto","set-logo-scale":e.logoScale||"1","set-default-theme":e.defaultTheme||"dark","set-font-family":e.fontFamily||"'Cairo', sans-serif","set-border-radius":e.borderRadius||"16","set-glass-blur":e.glassBlur||20,"set-shadow-depth":e.shadowDepth||40,"set-anim-speed":e.animSpeed||1,"set-enable-animations":e.enableAnimations!==void 0?e.enableAnimations.toString():"true","set-contact-mgmt":e.contactAdmin||"","set-contact-sales":e.contactSales||"","set-contact-complaints":e.contactComplaints||"","set-contact-email":e.contactEmail||"","set-about-text":e.aboutUs||"","set-location-link":e.locationUrl||"","set-location-text":e.location||"","set-insta-link":e.socialInsta||"","set-snap-link":e.socialSnap||"","set-twitter-link":e.socialTwitter||"","set-text-grad-1":e.textGradColor1||"#b8860b","set-text-grad-2":e.textGradColor2||"#ffffff","set-topbar-grad-1":e.topbarGradColor1||"#a11d21","set-topbar-grad-2":e.topbarGradColor2||"#05080c","set-primary-grad-1":e.primaryGradColor1||"#a11d21","set-primary-grad-2":e.primaryGradColor2||"#1c7c8c"};Object.entries(p).forEach(([A,B])=>{const R=document.getElementById(A);if(R&&(R.value=B,R.type==="range"||R.type==="color")){let N=document.createEvent("HTMLEvents");N.initEvent("input",!1,!0),R.dispatchEvent(N)}});const h=document.getElementById("set-maintenance-mode");h&&(h.checked=e.maintenanceMode||!1);const E={"set-enable-text-grad":e.enableTextGradient!==void 0?e.enableTextGradient:!0,"set-enable-topbar-grad":e.enableTopbarGradient!==void 0?e.enableTopbarGradient:!0,"set-enable-primary-grad":e.enablePrimaryGradient!==void 0?e.enablePrimaryGradient:!0};Object.entries(E).forEach(([A,B])=>{const R=document.getElementById(A);R&&(R.checked=B)});const f=document.getElementById("logo-preview-img");f&&(f.src=o),localStorage.setItem("luxury-settings-cache",JSON.stringify(e))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const e={nameAr:"ون كار",nameEn:"ONE CAR",primaryColor:"#a11d21",secondaryColor:"#1c7c8c",accentColor:"#b8860b",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await j(L(C,"settings"),e),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const e=window.state.notifications.map(t=>q(L(C,`notifications/${t.id}`),{read:!0}));await Promise.all(e),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(e){console.error(e)}};window.switchSettingsTab=function(e,t){document.querySelectorAll(".set-pane").forEach(n=>n.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(n=>n.classList.remove("active"));const o=document.getElementById(e);o&&o.classList.remove("hidden"),t&&t.classList.add("active")};window.previewLogo=async function(e){if(e.files&&e.files[0])try{const t=await window.compressImage(e.files[0],400,400,.8);document.getElementById("logo-preview-img").src=t,document.getElementById("set-logo-b64").value=t}catch(t){console.error("Logo compression failed",t)}};window.saveAppSettings=async function(){var o,n,i,a,r,d,s,l,g,u,c,m,I,v,w,y,b,x,k,$,T,p,h,E,f,S,M,D,_,A,B,R,N,H,W,G,Z,ee,te,oe;const e=document.querySelector('button[onclick="window.saveAppSettings()"]');e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const t={nameAr:((o=document.getElementById("set-name-ar"))==null?void 0:o.value)||"",nameEn:((n=document.getElementById("set-name-en"))==null?void 0:n.value)||"",logo:((i=document.getElementById("set-logo-b64"))==null?void 0:i.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((r=document.getElementById("set-color-secondary"))==null?void 0:r.value)||"",accentColor:((d=document.getElementById("set-color-accent"))==null?void 0:d.value)||"",bgColor:((s=document.getElementById("set-color-bg"))==null?void 0:s.value)||"",textColor:((l=document.getElementById("set-color-text"))==null?void 0:l.value)||"",hoverEffect:((g=document.getElementById("set-hover-effect"))==null?void 0:g.value)||"scale",cardStyle:((u=document.getElementById("set-card-style"))==null?void 0:u.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((m=document.getElementById("set-logo-blend"))==null?void 0:m.value)||"auto",logoScale:((I=document.getElementById("set-logo-scale"))==null?void 0:I.value)||"1",defaultTheme:((v=document.getElementById("set-default-theme"))==null?void 0:v.value)||"",fontFamily:((w=document.getElementById("set-font-family"))==null?void 0:w.value)||"",borderRadius:((y=document.getElementById("set-border-radius"))==null?void 0:y.value)||"",glassBlur:parseInt(((b=document.getElementById("set-glass-blur"))==null?void 0:b.value)||"20"),shadowDepth:parseInt(((x=document.getElementById("set-shadow-depth"))==null?void 0:x.value)||"40"),animSpeed:parseFloat(((k=document.getElementById("set-anim-speed"))==null?void 0:k.value)||"1"),enableAnimations:(($=document.getElementById("set-enable-animations"))==null?void 0:$.value)==="true",contactAdmin:((T=document.getElementById("set-contact-mgmt"))==null?void 0:T.value)||"",contactSales:((p=document.getElementById("set-contact-sales"))==null?void 0:p.value)||"",contactComplaints:((h=document.getElementById("set-contact-complaints"))==null?void 0:h.value)||"",contactEmail:((E=document.getElementById("set-contact-email"))==null?void 0:E.value)||"",aboutUs:((f=document.getElementById("set-about-text"))==null?void 0:f.value)||"",locationUrl:((S=document.getElementById("set-location-link"))==null?void 0:S.value)||"",location:((M=document.getElementById("set-location-text"))==null?void 0:M.value)||"",socialInsta:((D=document.getElementById("set-insta-link"))==null?void 0:D.value)||"",socialSnap:((_=document.getElementById("set-snap-link"))==null?void 0:_.value)||"",socialTwitter:((A=document.getElementById("set-twitter-link"))==null?void 0:A.value)||"",maintenanceMode:((B=document.getElementById("set-maintenance-mode"))==null?void 0:B.checked)||!1,enableTextGradient:(R=document.getElementById("set-enable-text-grad"))==null?void 0:R.checked,textGradColor1:(N=document.getElementById("set-text-grad-1"))==null?void 0:N.value,textGradColor2:(H=document.getElementById("set-text-grad-2"))==null?void 0:H.value,enableTopbarGradient:(W=document.getElementById("set-enable-topbar-grad"))==null?void 0:W.checked,topbarGradColor1:(G=document.getElementById("set-topbar-grad-1"))==null?void 0:G.value,topbarGradColor2:(Z=document.getElementById("set-topbar-grad-2"))==null?void 0:Z.value,enablePrimaryGradient:(ee=document.getElementById("set-enable-primary-grad"))==null?void 0:ee.checked,primaryGradColor1:(te=document.getElementById("set-primary-grad-1"))==null?void 0:te.value,primaryGradColor2:(oe=document.getElementById("set-primary-grad-2"))==null?void 0:oe.value,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await j(L(C,"settings"),t),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.toggleDesignPreview=function(){const e=document.getElementById("design-preview-widget");e&&e.classList.toggle("minimized")};window.makeDraggable=function(e){if(!e||e.dataset.draggable)return;e.dataset.draggable="true";let t=0,o=0,n=0,i=0;const a=e.querySelector("div");if(!a)return;a.onmousedown=r;function r(l){l.target.tagName==="BUTTON"||l.target.tagName==="I"||(l.preventDefault(),n=l.clientX,i=l.clientY,document.onmouseup=s,document.onmousemove=d)}function d(l){l.preventDefault(),t=n-l.clientX,o=i-l.clientY,n=l.clientX,i=l.clientY,e.style.top=e.offsetTop-o+"px",e.style.left=e.offsetLeft-t+"px",e.style.bottom="auto",e.style.right="auto"}function s(){document.onmouseup=null,document.onmousemove=null}};window.filterUsersByRole=function(e,t){t&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(o=>o.classList.remove("active")),t.classList.add("active")),window.state.userRoleFilter=e,window.syncAdminTables("users")};window.syncAdminTables=function(e){var i,a,r,d,s,l,g,u,c,m,I,v,w,y,b;if(e==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(k=>window.syncAdminTables(k));return}if(e==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(e==="quick-replies"||e==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const t=document.getElementById(`admin-${e}-table`);if(!t)return;let o=window.state[e]||[];const n=(((i=document.getElementById(`admin-${e}-search`))==null?void 0:i.value)||((a=document.getElementById(`${e}-search`))==null?void 0:a.value)||((r=document.getElementById(`${e.slice(0,-1)}-search`))==null?void 0:r.value)||"").toLowerCase();if(n&&(o=o.filter(x=>(x.make||x.title||x.name||x.model||x.phone||x.carRequested||x.carOrCompany||"").toLowerCase().includes(n))),e==="notifications"&&!(((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")&&window.state.user&&(o=o.filter(k=>k.userId===window.state.user.uid||k.assignedTo===window.state.user.uid)),e==="cars"){const x=document.getElementById("admin-filter-car-make");x&&x.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(p=>p.make))].sort().forEach(p=>{const h=document.createElement("option");h.value=p,h.textContent=p,x.appendChild(h)});const k=((l=document.getElementById("admin-filter-car-status"))==null?void 0:l.value)||"all",$=((g=document.getElementById("admin-filter-car-make"))==null?void 0:g.value)||"all";k!=="all"&&(o=o.filter(T=>T.status===k)),$!=="all"&&(o=o.filter(T=>T.make===$))}if(e==="bookings"){const x=document.getElementById("filter-booking-staff");x&&x.options.length<=1&&window.state.users&&window.state.users.forEach(f=>{if(f.email!=="zyrozyro98@gmail.com"&&(f.role==="admin"||f.role==="supervisor"||f.role==="staff")){const S=document.createElement("option");S.value=f.id,S.textContent=f.name||f.email||"مستخدم غير محدد",x.appendChild(S)}});const k=document.getElementById("filter-booking-sub-status");if(k&&k.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const $=((u=document.getElementById("filter-booking-status"))==null?void 0:u.value)||window.state.bookingFilter||"all",T=((c=document.getElementById("filter-booking-sub-status"))==null?void 0:c.value)||window.state.bookingSubStatusFilter||"all",p=((m=document.getElementById("filter-booking-staff"))==null?void 0:m.value)||"all",h=((I=document.getElementById("filter-booking-type"))==null?void 0:I.value)||"all";window.state.bookingFilter=$,window.state.bookingSubStatusFilter=T,$!=="all"&&(o=o.filter(f=>{let S=f.status||"new";return $==="cancelled"&&(S==="rejected"||S==="cancelled")?!0:S===$})),T!=="all"&&(o=o.filter(f=>f.subStatus===T)),p!=="all"&&(o=o.filter(f=>f.assignedTo===p)),h!=="all"&&(o=o.filter(f=>(f.customerType||"individual")===h)),!(((v=window.state.userProfile)==null?void 0:v.role)==="admin"||((w=window.state.userProfile)==null?void 0:w.role)==="supervisor")&&window.state.user&&(o=o.filter(f=>f.assignedTo===window.state.user.uid))}if(e==="users"){o=o.filter(p=>p.email!=="zyrozyro98@gmail.com");const x=window.state.userRoleFilter||"all";x!=="all"&&(o=o.filter(p=>p.role===x));const k=document.getElementById("stat-users-total"),$=document.getElementById("stat-users-active"),T=document.getElementById("stat-users-admins");if(k&&(k.innerText=o.length),$){$.innerText=o.filter(h=>h.isAvailable).length;const p=$.nextElementSibling;p&&(p.innerText="متواجد حالياً")}if(T){const p=T.nextElementSibling;if(x==="all")T.innerText=o.filter(h=>h.role==="admin").length,p&&(p.innerText="مدراء النظام");else{T.innerText=o.length;const h={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};p&&(p.innerText="إجمالي الـ "+(h[x]||""))}}}if(e==="bookings"?(((y=document.getElementById("filter-booking-sort"))==null?void 0:y.value)||"newest")==="oldest"?o.sort((k,$)=>new Date(k.createdAt||0)-new Date($.createdAt||0)):o.sort((k,$)=>new Date($.createdAt||0)-new Date(k.createdAt||0)):o.sort((x,k)=>new Date(k.createdAt||0)-new Date(x.createdAt||0)),o.length===0){t.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(e==="users"){const x=window.state.bookings||[],k=((b=window.state.userProfile)==null?void 0:b.role)==="admin";let $=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;o.forEach(T=>{const p=x.filter(B=>B.assignedTo===T.id),h=p.filter(B=>B.status==="sold"||B.status==="done").length,E=p.filter(B=>B.status==="new"||B.status==="waiting"||B.status==="inquiry"||!B.status).length,f=p.filter(B=>B.status==="cancelled").length,M={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[T.role]||"مندوب",D=T.image||"logo.jpg",_=T.phone||"";let A="";if(_){let B=_.replace(/\D/g,"");B=window.normalizePhone(B),A=`<a href="https://wa.me/${B}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}$+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
          ...
          </tr>`}),$+="</tbody></table>",t.innerHTML=$;return}t.innerHTML=o.map(x=>Ce(e,x)).join("")};function Ce(e,t){var g,u,c,m,I,v,w,y;((g=window.state.userProfile)==null?void 0:g.role)==="admin"||((u=window.state.userProfile)==null||u.role);const o=((c=window.state.userProfile)==null?void 0:c.role)==="admin",n=((m=window.state.userProfile)==null?void 0:m.role)==="supervisor",a=o||n&&["bookings","notifications"].includes(e),r=t.status==="sold"?"danger":t.status==="available"?"success":"warning",d=t.status==="sold"?"مباع":t.status==="available"?"متاح":"محجوز";if(e==="bookings"){const b=((I=window.state.users.find(p=>p.id===t.assignedTo))==null?void 0:I.name)||"غير محدد",x={new:"جديد",waiting:"بالانتظار",inquiry:"استفسار",sold:"مكتمل",done:"تم",cancelled:"مرفوض",rejected:"مرفوض"},k={not_contacted:"لم يتم التواصل",contacted:"تم التواصل",docs_received:"تم استلام الاوراق",waiting_calc:"انتظار رد العميل",waiting_docs:"إنتظار إكمال الاوراق",waiting_signature:"إنتظار توقيع العميل",docs_not_received:"لم يتم استلام الاوراق",signed:"تم التوقيع",delivered:"تم التسليم",done:"تم",no_response:"لم يتم رد العميل",obligations:"التزامات",calc_rejected:"رفض الحسبة",ineligible:"غير مسموح له",duplicate:"مكرر"},$=t.status==="cancelled"||t.status==="rejected"?"danger":t.status==="sold"||t.status==="done"?"success":"warning",T=t.subStatus?k[t.subStatus]||t.subStatus:"";return`
            <div class="admin-item-row" style="background:rgba(255,255,255,0.02); padding:15px; border-radius:12px; border:1px solid var(--glass-border); margin-bottom:10px; display:flex; justify-content:space-between; align-items:center;">
                ...
                <div class="admin-actions" style="display:flex; gap:10px; align-items:center;">
                    <span class="badge-${$}" style="font-size:10px; padding:3px 8px; border-radius:5px;">${x[t.status]||t.status||"جديد"}</span>
        ...
        `;if(e==="notifications"){const b=!!t.read,x=t.type||"system",k=((v=window.state.userProfile)==null?void 0:v.role)==="admin"||((w=window.state.userProfile)==null?void 0:w.role)==="supervisor",$=t.userId||t.assignedTo,T=(y=window.state.users)==null?void 0:y.find(E=>E.id===$),p=T?T.name||T.email:"نظام",h={wa_message:"fab fa-whatsapp",booking:"fas fa-calendar-check",system:"fas fa-info-circle",auth:"fas fa-shield-alt"};return`
    ...
    `}if(e==="logs")return`
        ...
        `;if(e==="sales"){const b=(t.url||"").trim();let x=b.includes("youtube.com")||b.includes("youtu.be"),k=t.poster||t.image||null;if(x&&!k){let $="";try{b.includes("v=")?$=b.split("v=")[1].split("&")[0]:b.includes("youtu.be/")?$=b.split("youtu.be/")[1].split("?")[0]:b.includes("embed/")?$=b.split("embed/")[1].split("?")[0]:$=b.split("/").pop().split("?")[0]}catch{$=""}$&&(k=`https://img.youtube.com/vi/${$}/mqdefault.jpg`)}return k=k||"logo.jpg",`
        ...
        `}if(e==="reviews"){const b=Number(t.rating||5),x=t.text?t.text.length>60?t.text.substring(0,60)+"...":t.text:"لا يوجد نص",k=t.avatar||t.image||"";return`
    ...
    <div class="form-grid-v3">
      ${n.map(i=>{if(i.type==="custom")return i.html;let a=t[i.name]!==void 0&&t[i.name]!==null?t[i.name]:"";i.name==="desc"&&!a&&(a=t.description||t.details||"");const r=i.required?"required":"",d=i.placeholder||i.label;let s="";return i.type==="select"?s=`
                ...
                <div style="text-align:center; margin-top:auto; margin-bottom:auto;">
                    <div style="background:rgba(255,255,255,0.95); display:inline-block; padding:20px; border-radius:15px; font-size:13px; color:#555; box-shadow:0 10px 30px rgba(0,0,0,0.1); max-width:85%;">
                        ...
                        سجل المحادثات متاح فقط للحجوزات المسندة.
                                ...
                                <button id="${x}" class="btn-premium btn-sm" onclick="window.downloadWAMedia('${n}', '${e}', '${c.id}', '${k}', '${c.media.mimetype}', '${c.type}')" style="padding:4px 10px; min-width:40px;"><i class="fas fa-download"></i></button>
