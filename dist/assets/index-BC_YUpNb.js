...
`),e.borderRadius&&(t.style.setProperty("--border-radius-main",e.borderRadius+"px"),s+=`
    ...
    `),e.enableTextGradient){const L=e.textGradColor1||"#b8860b",B=e.textGradColor2||"#ffffff";s+=`
    ...
    `}if(e.enableTopbarGradient){const L=e.topbarGradColor1||"#a11d21",B=e.topbarGradColor2||"#05080c";s+=`
      .top-bar-luxury {
        background: linear-gradient(90deg, ${L}, ${B}) !important;
      }
    `}if(e.enablePrimaryGradient){const L=e.primaryGradColor1||"#a11d21",B=e.primaryGradColor2||"#1c7c8c";s+=`
    ...
    `}if(e.enableSecondaryGradient){const L=e.secondaryGradColor1||"#1c7c8c",B=e.secondaryGradColor2||"#0f172a";s+=`
      .btn-secondary, .secondary-badge, .p-tab.active, .bullet-point, .nav-item.active, .dash-tab.active {
        background: linear-gradient(135deg, ${L}, ${B}) !important;
        color: white !important;
        border: none !important;
      }
    `}if(e.enableAccentGradient){const L=e.accentGradColor1||"#b8860b",B=e.accentGradColor2||"#ffd700";s+=`
    ...
    `}d.innerHTML=s;const p=document.getElementById("about-text-display");p&&(p.innerText=e.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const I=document.getElementById("location-text-display");I&&(I.innerText=e.location||"الرياض - معارض القادسية");const v=document.getElementById("f-phone-admin");v&&(v.innerText=e.contactAdmin||"...");const w=document.getElementById("f-phone-sales");w&&(w.innerText=e.contactSales||"...");const y=document.getElementById("f-phone-info");y&&(y.innerText=e.contactComplaints||"...");const b=document.getElementById("f-email-display");b&&(b.innerText=e.contactEmail||"...");const h=document.getElementById("contact-location-link");h&&(h.href=e.locationUrl||"#");const k=document.getElementById("meta-title");k&&(k.innerText=`${o} | ${e.metaTitle||"الفخامة والجودة تليق بك"}`);const $=document.getElementById("meta-description");$&&$.setAttribute("content",e.metaDesc||"وجهتكم الرائدة للسيارات الفاخرة والمعتمدة.");const T={"f-insta":e.socialInsta,"f-snap":e.socialSnap,"f-twitter":e.socialTwitter};Object.entries(T).forEach(([L,B])=>{const R=document.getElementById(L);R&&(R.href=B||"#")});const m={"set-name-ar":e.nameAr||"","set-name-en":e.nameEn||"","set-color-primary":e.primaryColor||"#a11d21","set-color-secondary":e.secondaryColor||"#1c7c8c","set-color-accent":e.accentColor||"#b8860b","set-color-bg":e.bgColor||"#05080c","set-color-text":e.textColor||"#f8fafc","set-hover-effect":e.hoverEffect||"scale","set-card-style":e.cardStyle||"glass","set-glass-opacity":e.glassOpacity!==void 0?e.glassOpacity:.75,"set-logo-blend":e.logoBlend||"auto","set-logo-scale":e.logoScale||"1","set-default-theme":e.defaultTheme||"dark","set-font-family":e.fontFamily||"'Cairo', sans-serif","set-border-radius":e.borderRadius||"16","set-glass-blur":e.glassBlur||20,"set-shadow-depth":e.shadowDepth||40,"set-anim-speed":e.animSpeed||1,"set-enable-animations":e.enableAnimations!==void 0?e.enableAnimations.toString():"true","set-contact-mgmt":e.contactAdmin||"","set-contact-sales":e.contactSales||"","set-contact-complaints":e.contactComplaints||"","set-contact-email":e.contactEmail||"","set-about-text":e.aboutUs||"","set-location-link":e.locationUrl||"","set-location-text":e.location||"","set-insta-link":e.socialInsta||"","set-snap-link":e.socialSnap||"","set-twitter-link":e.socialTwitter||"","set-text-grad-1":e.textGradColor1||"#b8860b","set-text-grad-2":e.textGradColor2||"#ffffff","set-topbar-grad-1":e.topbarGradColor1||"#a11d21","set-topbar-grad-2":e.topbarGradColor2||"#05080c","set-primary-grad-1":e.primaryGradColor1||"#a11d21","set-primary-grad-2":e.primaryGradColor2||"#1c7c8c"};Object.entries(m).forEach(([L,B])=>{const R=document.getElementById(L);if(R&&(R.value=B,R.type==="range"||R.type==="color")){let N=document.createEvent("HTMLEvents");N.initEvent("input",!1,!0),R.dispatchEvent(N)}});const x=document.getElementById("set-maintenance-mode");x&&(x.checked=e.maintenanceMode||!1);const E={"set-enable-text-grad":e.enableTextGradient!==void 0?e.enableTextGradient:!0,"set-enable-topbar-grad":e.enableTopbarGradient!==void 0?e.enableTopbarGradient:!0,"set-enable-primary-grad":e.enablePrimaryGradient!==void 0?e.enablePrimaryGradient:!0};Object.entries(E).forEach(([L,B])=>{const R=document.getElementById(L);R&&(R.checked=B)});const f=document.getElementById("logo-preview-img");f&&(f.src=n),localStorage.setItem("luxury-settings-cache",JSON.stringify(e))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const e={nameAr:"ون كار",nameEn:"ONE CAR",primaryColor:"#a11d21",secondaryColor:"#1c7c8c",accentColor:"#b8860b",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await j(C(A,"settings"),e),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const e=window.state.notifications.map(t=>q(C(A,`notifications/${t.id}`),{read:!0}));await Promise.all(e),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(e){console.error(e)}};window.switchSettingsTab=function(e,t){document.querySelectorAll(".set-pane").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(o=>o.classList.remove("active"));const n=document.getElementById(e);n&&n.classList.remove("hidden"),t&&t.classList.add("active")};window.previewLogo=async function(e){if(e.files&&e.files[0])try{const t=await window.compressImage(e.files[0],400,400,.8);document.getElementById("logo-preview-img").src=t,document.getElementById("set-logo-b64").value=t}catch(t){console.error("Logo compression failed",t)}};window.removeBlackFromLogo=function(){const e=document.getElementById("logo-preview-img"),t=document.getElementById("set-logo-b64");if(!t||!t.value){window.showLuxuryToast("الرجاء رفع شعار أولاً");return}const n=document.createElement("canvas"),o=n.getContext("2d"),i=new Image;i.crossOrigin="Anonymous",i.onload=function(){n.width=i.width,n.height=i.height,o.drawImage(i,0,0);const a=o.getImageData(0,0,n.width,n.height),r=a.data,d=r[0],s=r[1],l=r[2],g=d<50&&s<50&&l<50;for(let c=0;c<r.length;c+=4){const p=r[c],I=r[c+1],v=r[c+2],w=r[c+3];if(w===0)continue;const y=Math.max(p,I,v);if(g){if(y<35)r[c+3]=0;else if(y<85){const b=(y-35)/50;r[c+3]=w*b;const h=Math.max(b,.1);r[c]=Math.min(255,p/h),r[c+1]=Math.min(255,I/h),r[c+2]=Math.min(255,v/h)}}else y<30&&(r[c+3]=0)}o.putImageData(a,0,0);const u=n.toDataURL("image/png");if(e.src=u,t.value=u,window.showLuxuryToast("تمت معالجة الشعار وتصفية الحواف بنجاح"),window.applySettings){let c=window.settings||{};c.logo=u,window.applySettings(c)}},i.src=t.value};window.saveAppSettings=async function(){var n,o,i,a,r,d,s,l,g,u,c,p,I,v,w,y,b,h,k,$,T,m,x,E,f,S,M,D,_,L,B,R,N,H,W,V,Z,ee,te,ne,oe,ie,ae,se,re,le;const e=document.querySelector('button[onclick="window.saveAppSettings()"]');e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const t={nameAr:((n=document.getElementById("set-name-ar"))==null?void 0:n.value)||"",nameEn:((o=document.getElementById("set-name-en"))==null?void 0:o.value)||"",logo:((i=document.getElementById("set-logo-b64"))==null?void 0:i.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((r=document.getElementById("set-color-secondary"))==null?void 0:r.value)||"",accentColor:((d=document.getElementById("set-color-accent"))==null?void 0:d.value)||"",bgColor:((s=document.getElementById("set-color-bg"))==null?void 0:s.value)||"",textColor:((l=document.getElementById("set-color-text"))==null?void 0:l.value)||"",hoverEffect:((g=document.getElementById("set-hover-effect"))==null?void 0:g.value)||"scale",cardStyle:((u=document.getElementById("set-card-style"))==null?void 0:u.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((p=document.getElementById("set-logo-blend"))==null?void 0:p.value)||"auto",logoScale:((I=document.getElementById("set-logo-scale"))==null?void 0:I.value)||"1",defaultTheme:((v=document.getElementById("set-default-theme"))==null?void 0:v.value)||"",fontFamily:((w=document.getElementById("set-font-family"))==null?void 0:w.value)||"",borderRadius:((y=document.getElementById("set-border-radius"))==null?void 0:y.value)||"",glassBlur:parseInt(((b=document.getElementById("set-glass-blur"))==null?void 0:b.value)||"20"),shadowDepth:parseInt(((h=document.getElementById("set-shadow-depth"))==null?void 0:h.value)||"40"),animSpeed:parseFloat(((k=document.getElementById("set-anim-speed"))==null?void 0:k.value)||"1"),enableAnimations:(($=document.getElementById("set-enable-animations"))==null?void 0:$.value)==="true",contactAdmin:((T=document.getElementById("set-contact-mgmt"))==null?void 0:T.value)||"",contactSales:((m=document.getElementById("set-contact-sales"))==null?void 0:m.value)||"",contactComplaints:((x=document.getElementById("set-contact-complaints"))==null?void 0:x.value)||"",contactEmail:((E=document.getElementById("set-contact-email"))==null?void 0:E.value)||"",aboutUs:((f=document.getElementById("set-about-text"))==null?void 0:f.value)||"",locationUrl:((S=document.getElementById("set-location-link"))==null?void 0:S.value)||"",location:((M=document.getElementById("set-location-text"))==null?void 0:M.value)||"",socialInsta:((D=document.getElementById("set-insta-link"))==null?void 0:D.value)||"",socialSnap:((_=document.getElementById("set-snap-link"))==null?void 0:_.value)||"",socialTwitter:((L=document.getElementById("set-twitter-link"))==null?void 0:L.value)||"",maintenanceMode:((B=document.getElementById("set-maintenance-mode"))==null?void 0:B.checked)||!1,enableTextGradient:(R=document.getElementById("set-enable-text-grad"))==null?void 0:R.checked,textGradColor1:(N=document.getElementById("set-text-grad-1"))==null?void 0:N.value,textGradColor2:(H=document.getElementById("set-text-grad-2"))==null?void 0:H.value,enableTopbarGradient:(W=document.getElementById("set-enable-topbar-grad"))==null?void 0:W.checked,topbarGradColor1:(V=document.getElementById("set-topbar-grad-1"))==null?void 0:V.value,topbarGradColor2:(Z=document.getElementById("set-topbar-grad-2"))==null?void 0:Z.value,enablePrimaryGradient:(ee=document.getElementById("set-enable-primary-grad"))==null?void 0:ee.checked,primaryGradColor1:(te=document.getElementById("set-primary-grad-1"))==null?void 0:te.value,primaryGradColor2:(ne=document.getElementById("set-primary-grad-2"))==null?void 0:ne.value,enableSecondaryGradient:(oe=document.getElementById("set-enable-secondary-grad"))==null?void 0:oe.checked,secondaryGradColor1:(ie=document.getElementById("set-secondary-grad-1"))==null?void 0:ie.value,secondaryGradColor2:(ae=document.getElementById("set-secondary-grad-2"))==null?void 0:ae.value,enableAccentGradient:(se=document.getElementById("set-enable-accent-grad"))==null?void 0:se.checked,accentGradColor1:(re=document.getElementById("set-accent-grad-1"))==null?void 0:re.value,accentGradColor2:(le=document.getElementById("set-accent-grad-2"))==null?void 0:le.value,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await j(C(A,"settings"),t),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.toggleDesignPreview=function(){const e=document.getElementById("design-preview-widget");e&&e.classList.toggle("minimized")};window.makeDraggable=function(e){if(!e||e.dataset.draggable)return;e.dataset.draggable="true";let t=0,n=0,o=0,i=0;const a=e.querySelector("div");if(!a)return;a.onmousedown=r,a.ontouchstart=r;function r(l){if(l.target.tagName==="BUTTON"||l.target.tagName==="I")return;const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;o=g,i=u,document.onmouseup=s,document.ontouchend=s,document.onmousemove=d,document.ontouchmove=d,e.classList.add("dragging")}function d(l){const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;t=o-g,n=i-u,o=g,i=u;const c=e.getBoundingClientRect(),p=c.top-n,I=c.left-t;e.style.top=p+"px",e.style.left=I+"px",e.style.bottom="auto",e.style.right="auto",e.style.margin="0"}function s(){document.onmouseup=null,document.onmousemove=null,document.ontouchend=null,document.ontouchmove=null,e.classList.remove("dragging")}};window.filterUsersByRole=function(e,t){t&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(n=>n.classList.remove("active")),t.classList.add("active")),window.state.userRoleFilter=e,window.syncAdminTables("users")};window.syncAdminTables=function(e){var i,a,r,d,s,l,g,u,c,p,I,v,w,y,b;if(e==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(k=>window.syncAdminTables(k));return}if(e==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(e==="quick-replies"||e==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const t=document.getElementById(`admin-${e}-table`);if(!t)return;let n=window.state[e]||[];const o=(((i=document.getElementById(`admin-${e}-search`))==null?void 0:i.value)||((a=document.getElementById(`${e}-search`))==null?void 0:a.value)||((r=document.getElementById(`${e.slice(0,-1)}-search`))==null?void 0:r.value)||"").toLowerCase();if(o&&(n=n.filter(h=>(h.make||h.title||h.name||h.model||h.phone||h.carRequested||h.carOrCompany||"").toLowerCase().includes(o))),e==="notifications"&&!(((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")&&window.state.user&&(n=n.filter(k=>k.userId===window.state.user.uid||k.assignedTo===window.state.user.uid)),e==="cars"){const h=document.getElementById("admin-filter-car-make");h&&h.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(m=>m.make))].sort().forEach(m=>{const x=document.createElement("option");x.value=m,x.textContent=m,h.appendChild(x)});const k=((l=document.getElementById("admin-filter-car-status"))==null?void 0:l.value)||"all",$=((g=document.getElementById("admin-filter-car-make"))==null?void 0:g.value)||"all";k!=="all"&&(n=n.filter(T=>T.status===k)),$!=="all"&&(n=n.filter(T=>T.make===$))}if(e==="bookings"){const h=document.getElementById("filter-booking-staff");h&&h.options.length<=1&&window.state.users&&window.state.users.forEach(f=>{if(f.email!=="zyrozyro98@gmail.com"&&(f.role==="admin"||f.role==="supervisor"||f.role==="staff")){const S=document.createElement("option");S.value=f.id,S.textContent=f.name||f.email||"مستخدم غير محدد",h.appendChild(S)}});const k=document.getElementById("filter-booking-sub-status");if(k&&k.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const $=((u=document.getElementById("filter-booking-status"))==null?void 0:u.value)||window.state.bookingFilter||"all",T=((c=document.getElementById("filter-booking-sub-status"))==null?void 0:c.value)||window.state.bookingSubStatusFilter||"all",m=((p=document.getElementById("filter-booking-staff"))==null?void 0:p.value)||"all",x=((I=document.getElementById("filter-booking-type"))==null?void 0:I.value)||"all";window.state.bookingFilter=$,window.state.bookingSubStatusFilter=T,$!=="all"&&(n=n.filter(f=>{let S=f.status||"new";return $==="cancelled"&&(S==="rejected"||S==="cancelled")?!0:S===$})),T!=="all"&&(n=n.filter(f=>f.subStatus===T)),m!=="all"&&(n=n.filter(f=>f.assignedTo===m)),x!=="all"&&(n=n.filter(f=>(f.customerType||"individual")===x)),!(((v=window.state.userProfile)==null?void 0:v.role)==="admin"||((w=window.state.userProfile)==null?void 0:w.role)==="supervisor")&&window.state.user&&(n=n.filter(f=>f.assignedTo===window.state.user.uid))}if(e==="users"){n=n.filter(m=>m.email!=="zyrozyro98@gmail.com");const h=window.state.userRoleFilter||"all";h!=="all"&&(n=n.filter(m=>m.role===h));const k=document.getElementById("stat-users-total"),$=document.getElementById("stat-users-active"),T=document.getElementById("stat-users-admins");if(k&&(k.innerText=n.length),$){$.innerText=n.filter(x=>x.isAvailable).length;const m=$.nextElementSibling;m&&(m.innerText="متواجد حالياً")}if(T){const m=T.nextElementSibling;if(h==="all")T.innerText=n.filter(x=>x.role==="admin").length,m&&(m.innerText="مدراء النظام");else{T.innerText=n.length;const x={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};m&&(m.innerText="إجمالي الـ "+(x[h]||""))}}}if(e==="bookings"?(((y=document.getElementById("filter-booking-sort"))==null?void 0:y.value)||"newest")==="oldest"?n.sort((k,$)=>new Date(k.createdAt||0)-new Date($.createdAt||0)):n.sort((k,$)=>new Date($.createdAt||0)-new Date(k.createdAt||0)):n.sort((h,k)=>new Date(k.createdAt||0)-new Date(h.createdAt||0)),n.length===0){t.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(e==="users"){const h=window.state.bookings||[],k=((b=window.state.userProfile)==null?void 0:b.role)==="admin";let $=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;n.forEach(T=>{const m=h.filter(B=>B.assignedTo===T.id),x=m.filter(B=>B.status==="sold"||B.status==="done").length,E=m.filter(B=>B.status==="new"||B.status==="waiting"||B.status==="inquiry"||!B.status).length,f=m.filter(B=>B.status==="cancelled").length,M={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[T.role]||"مندوب",D=T.image||"logo.jpg",_=T.phone||"";let L="";if(_){let B=_.replace(/\D/g,"");B=window.normalizePhone(B),L=`<a href="https://wa.me/${B}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}$+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
    ...
    `}if(e==="logs")return`
        ...
        `;if(e==="sales"){const b=(t.url||"").trim();let h=b.includes("youtube.com")||b.includes("youtu.be"),k=t.poster||t.image||null;if(h&&!k){let $="";try{b.includes("v=")?$=b.split("v=")[1].split("&")[0]:b.includes("youtu.be/")?$=b.split("youtu.be/")[1].split("?")[0]:b.includes("embed/")?$=b.split("embed/")[1].split("?")[0]:$=b.split("/").pop().split("?")[0]}catch{$=""}$&&(k=`https://img.youtube.com/vi/${$}/mqdefault.jpg`)}return k=k||"logo.jpg",`
        ...
        `}if(e==="reviews"){const b=Number(t.rating||5),h=t.text?t.text.length>60?t.text.substring(0,60)+"...":t.text:"لا يوجد نص",k=t.avatar||t.image||"";return`
    ...
    `).join("")}const y=document.getElementById("status-donut-chart");if(y){const m=r.sold+r.done,x=r.new+r.waiting+r.inquiry,E=r.cancelled,f=m+x+E||1,S=Math.round(m/f*100),M=Math.round(x/f*100);y.style.background=`conic-gradient(
      #00a884 0% ${S}%, 
      var(--p-gold) ${S}% ${S+M}%, 
      #e02424 ${S+M}% 100%
    )`,y.setAttribute("data-pct",`${S}% ناجح`)}const b=document.getElementById("supervisor-leaderboard");if(b&&window.state.users&&window.state.bookings){const m=new Date,x=window.state.bookings.filter(f=>{const S=new Date(f.createdAt||0);return S.getMonth()===m.getMonth()&&S.getFullYear()===m.getFullYear()}),E=window.state.users.filter(f=>f.role==="staff"||f.role==="supervisor").map(f=>{const S=x.filter(D=>D.assignedTo===f.id&&(D.status==="sold"||D.status==="done")).length,M=x.filter(D=>D.assignedTo===f.id).length;return{...f,soldCount:S,totalAssigned:M}}).sort((f,S)=>S.soldCount-f.soldCount).slice(0,5);b.innerHTML=E.map((f,S)=>`
