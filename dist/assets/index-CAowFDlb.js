import{i as me,g as ye,a as be,b as pe,c as ve,d as he,s as xe,o as ke,r as C,e as Y,u as j,f as O,h as q,j as K,k as Ie,l as $e,p as P,m as Ee,n as de,q as Se,t as Te}from"./firebase-BfvlcbVS.js";import"./emoji-picker-CeBMFWb3.js";import"./vendor-Bg_btqvK.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const ge={apiKey:"AIzaSyDQodWTn2wa0WzQuHqzZt2Ex6CdnQdrlUU",authDomain:"onecar1.firebaseapp.com",projectId:"onecar1",storageBucket:"onecar1.firebasestorage.app",messagingSenderId:"735648367644",appId:"1:735648367644:web:44ae368553280b14bdcbd9",measurementId:"G-RSTPV8SRXT",databaseURL:"https://onecar1-default-rtdb.firebaseio.com"},Q=me(ge);ye(Q);const A=be(Q),G=pe(Q);ve(Q);he(Q);window.state={cars:[],ads:[],bookings:[],users:[],notifications:[],logs:[],partners:[],locations:[],brands:[],agents:[],specs:[],packages:[],blogs:[],reviews:[],plates:[],sales:[],gearboxes:[],bodyTypes:[],engines:[],exteriorColors:[],interiorColors:[],stockStatuses:[],user:null,userProfile:null,settings:{enableTextGradient:!0,textGradColor1:"#c8a95e",textGradColor2:"#ffffff",enableTopbarGradient:!0,topbarGradColor1:"#907537",topbarGradColor2:"#05080c",enablePrimaryGradient:!0,primaryGradColor1:"#907537",primaryGradColor2:"#b39651",enableSecondaryGradient:!0,secondaryGradColor1:"#b39651",secondaryGradColor2:"#0f172a",enableAccentGradient:!0,accentGradColor1:"#c8a95e",accentGradColor2:"#ffd700"},lang:localStorage.getItem("luxury_lang")||"ar",soundEnabled:localStorage.getItem("luxury_sound_enabled")!=="false",tempImages:[],bookingFilter:"all",bookingSubStatusFilter:"all",currentReportPeriod:"day",firstLoadDone:!1,inventoryPage:1,inventorySize:8,sliderIndex:0};const Be={ar:{welcome:"مرحباً بك في عالم الفخامة",inventory:"مخزون السيارات المتاح",totalCars:"إجمالي السيارات",totalBookings:"إجمالي الطلبات",totalValue:"قيمة المخزون",searchPlaceholder:"ابحث عن سيارتك المثالية...",loading:"جاري التحميل...",noResults:"لم يتم العثور على نتائج تطابق بحثك",applyNow:"اطلبها الآن",details:"عرض التفاصيل",back:"رجوع",save:"حفظ",delete:"حذف",edit:"تعديل",cancel:"إلغاء",successMsg:"تمت العملية بنجاح",errorMsg:"حدث خطأ غير متوقع",staff:"قسم المبيعات والمتابعة",admin:"إدارة النظام",supervisor:"مشرف النظام"},en:{welcome:"Welcome to the World of Luxury",inventory:"Available Vehicle Inventory",totalCars:"Total Vehicles",totalBookings:"Total Bookings",totalValue:"Inventory Value",searchPlaceholder:"Search for your perfect car...",loading:"Loading...",noResults:"No results found matching your search",applyNow:"Request Now",details:"View Details",back:"Back",save:"Save",delete:"Delete",edit:"Edit",cancel:"Cancel",successMsg:"Operation successful",errorMsg:"An unexpected error occurred",staff:"Sales & Follow-up Department",admin:"System Administration",supervisor:"System Supervisor"}};window.showLuxuryToast=function(e,t="success"){const n=document.getElementById("toast-container");if(!n)return;const o=document.createElement("div");o.className=`toast-v2 ${t}`,o.style.cssText=`
  ...
  `;const i=t==="success"?"fa-check-circle":"fa-exclamation-circle";o.innerHTML=`<i class="fas ${i}"></i> <span>${e}</span>`,n.appendChild(o),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateY(-20px)",o.style.transition="all 0.4s ease-in",setTimeout(()=>o.remove(),400)},4e3)};window.compressImage=function(e,t=1e3,n=1e3,o=.6){return new Promise((i,a)=>{if(!e||!(e instanceof File||e instanceof Blob)){i(e);return}const r=new FileReader;r.readAsDataURL(e),r.onload=d=>{const s=new Image;s.src=d.target.result,s.onload=()=>{const l=document.createElement("canvas");let g=s.width,u=s.height;g>u?g>t&&(u*=t/g,g=t):u>n&&(g*=n/u,u=n),l.width=g,l.height=u,l.getContext("2d").drawImage(s,0,0,g,u);const p=e.type==="image/png"||e.type==="image/webp"?"image/webp":"image/jpeg";i(l.toDataURL(p,o))},s.onerror=a},r.onerror=a})};window.openModal=function(e){const t=document.getElementById(e);if(t){t.classList.remove("hidden"),document.body.style.overflow="hidden";const n=document.querySelectorAll(".modal:not(.hidden)");t.style.zIndex=2e3+n.length*10,Le(`modal-${e}`)}};window.closeModal=function(e,t=!1){var o;const n=document.getElementById(e);n&&(n.classList.add("hidden"),n.style.zIndex="",!t&&((o=history.state)==null?void 0:o.type)===`modal-${e}`&&history.back(),document.querySelector(".modal:not(.hidden)")||(document.body.style.overflow="auto"))};window.setModalTitle=function(e,t){const n=document.getElementById(e+"-title");n&&(n.innerText=t)};window.switchLuxuryTab=function(e){const t=document.querySelectorAll(".pane, .admin-tab-content"),n=document.querySelectorAll(".dash-tab, .admin-sidebar-nav li");t.forEach(r=>{r.classList.add("hidden"),r.classList.remove("active")}),n.forEach(r=>r.classList.remove("active"));const o=document.getElementById(e),i=document.querySelector(`[data-tab="${e}"]`);o&&(o.classList.remove("hidden"),o.classList.add("active"),o.style.animation="fade-up 0.5s ease-out forwards"),i&&i.classList.add("active");const a=document.getElementById("bookings-submenu");if(a&&a.classList.toggle("active",e==="bookings-mgmt"||e==="all-bookings"),window.innerWidth<1024){const r=document.querySelector(".dash-sidebar, .admin-sidebar-v2");r&&r.classList.remove("active")}e==="whatsapp-monitor-mgmt"&&window.initWhatsAppServer&&window.initWhatsAppServer(),e==="whatsapp-mgmt"&&window.startCurrentWASession(),e==="ads-mgmt"&&window.syncAdminTables("ads"),e==="quick-replies-mgmt"&&window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin()};function Le(e){var t;((t=history.state)==null?void 0:t.type)!==e&&history.pushState({type:e},"")}window.normalizePhone=function(e){if(!e)return"";const t=e.toString().trim();if(t.includes("@s.whatsapp.net"))return t.split("@")[0].replace(/\D/g,"");if(t.includes("@lid"))return t;let n=t.replace(/\D/g,"");if(n.startsWith("9660")?n="966"+n.substring(4):n.startsWith("9670")&&(n="967"+n.substring(4)),n.startsWith("966")||n.startsWith("967"))return n;if(n.startsWith("05"))return"966"+n.substring(1);if(n.startsWith("07"))return"967"+n.substring(1);if(n.startsWith("0"))return"966"+n.substring(1);if(n.length===9){if(n.startsWith("7"))return"967"+n;if(n.startsWith("5"))return"966"+n}return n};document.addEventListener("DOMContentLoaded",()=>{Ae(),fe(),Me(),window.trackVisit(),Ce()});function Ce(){const e=document.querySelector(".mobile-btn"),t=document.querySelector(".nav-menu"),n=document.querySelector(".mobile-nav-overlay"),o=document.querySelector(".menu-close-btn"),i=(b=!1)=>{const x=b===!1?!t.classList.contains("active"):!1;t.classList.toggle("active",x),n.classList.toggle("active",x),document.body.style.overflow=x?"hidden":"";const w=e==null?void 0:e.querySelector("i");w&&(w.className=x?"fas fa-times":"fas fa-bars-staggered")};e&&(e.onclick=()=>i()),n&&(n.onclick=()=>i(!0)),o&&(o.onclick=()=>i(!0)),document.querySelectorAll(".nav-menu a").forEach(b=>{b.addEventListener("click",()=>i(!0))});const a=document.querySelector(".mobile-menu-header .dynamic-name-ar");a&&window.__DYNAMIC_NAME_AR__&&(a.innerText=window.__DYNAMIC_NAME_AR__);const r=document.getElementById("admin-trigger");r&&(r.onclick=b=>{b.preventDefault(),window.openModal("admin-modal")});const d=document.getElementById("theme-btn");d&&(d.onclick=()=>{const x=(document.body.getAttribute("data-theme")||"dark")==="dark"?"light":"dark";document.body.setAttribute("data-theme",x),localStorage.setItem("luxury_theme",x),localStorage.setItem("theme_manually_overridden","true"),d.innerHTML=x==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>'});const s=document.getElementById("lang-btn");s&&(s.onclick=()=>{window.state.lang=window.state.lang==="ar"?"en":"ar",localStorage.setItem("luxury_lang",window.state.lang),fe(),window.applyInventoryFilters(),s.innerText=window.state.lang==="ar"?"EN":"AR"}),document.querySelectorAll(".dash-tab").forEach(b=>{b.onclick=()=>window.switchLuxuryTab(b.dataset.tab)});const l=document.getElementById("car-search-input");l&&(l.oninput=()=>window.applyInventoryFilters()),["filter-make","filter-type","filter-year","filter-sort"].forEach(b=>{const x=document.getElementById(b);x&&(x.onchange=()=>{window.state.inventoryPage=1,window.applyInventoryFilters()})});const u=document.getElementById("p-prev"),c=document.getElementById("p-next");u&&(u.onclick=()=>window.moveLuxurySlider(-1)),c&&(c.onclick=()=>window.moveLuxurySlider(1)),setInterval(()=>{const b=document.getElementById("luxury-splash");(!b||b.classList.contains("hidden"))&&window.moveLuxurySlider(1)},5e3),["calc-car-price","calc-down-pay","calc-years"].forEach(b=>{const x=document.getElementById(b);x&&(x.oninput=()=>window.calculateLuxuryFinancing()),x&&x.tagName==="SELECT"&&(x.onchange=()=>window.calculateLuxuryFinancing())}),document.querySelectorAll(".modal-close").forEach(b=>{b.onclick=x=>{x.stopPropagation();const w=b.closest(".modal");if(w){if(w.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(w.id)}}}),window.onclick=b=>{const x=document.getElementById("wa-emoji-picker");if(x&&x.style.display!=="none"){const k=b.target.closest(".fa-smile")!==null,$=x.contains(b.target);!k&&!$&&(x.style.display="none")}const w=Array.from(document.querySelectorAll(".modal:not(.hidden)"));if(w.length>0){const k=w[w.length-1];if(b.target===k){if(k.id==="admin-modal"&&window.state.user&&!confirm("هل تريد الخروج من لوحة التحكم؟"))return;window.closeModal(k.id)}}},window.addEventListener("popstate",b=>{const x=document.querySelectorAll(".modal:not(.hidden)");x.length>0&&x.forEach(w=>{var k;((k=b.state)==null?void 0:k.type)!==`modal-${w.id}`&&window.closeModal(w.id,!0)})}),window.onscroll=()=>{const b=document.getElementById("main-nav");b&&b.classList.toggle("scrolled",window.scrollY>50);const x=document.getElementById("scroll-jump");x&&x.classList.toggle("hidden",window.scrollY<500)},document.getElementById("scroll-jump")&&(document.getElementById("scroll-jump").onclick=()=>window.scrollTo({top:0,behavior:"smooth"}));const I=document.getElementById("login-form");I&&(I.onsubmit=b=>window.loginAdmin(b));const v=document.getElementById("booking-form");v&&(v.onsubmit=b=>window.submitBooking(b));const y=document.getElementById("item-form");y&&(y.onsubmit=b=>window.saveLuxuryItem(b))}function Ae(){const e=JSON.parse(localStorage.getItem("luxury-settings-cache")||"{}"),t=localStorage.getItem("theme_manually_overridden")==="true",n=(t?localStorage.getItem("luxury_theme"):e.defaultTheme)||"dark";t||localStorage.setItem("luxury_theme",n),document.body.setAttribute("data-theme",n);const o=document.getElementById("theme-btn");o&&(o.innerHTML=n==="dark"?'<i class="fas fa-sun"></i>':'<i class="fas fa-moon"></i>')}function fe(){const e=window.state.lang;document.body.dir=e==="ar"?"rtl":"ltr",document.body.classList.toggle("en",e==="en");const t=Be[e];document.querySelectorAll("[data-i18n]").forEach(n=>{const o=n.getAttribute("data-i18n");t[o]&&(n.innerText=t[o])})}async function Me(){await xe(G,Te);const e=["users","plates","locations","brands","agents","specs","packages","blogs","reviews","cars","ads","sales","settings","partners","custom_presets","gearboxes","bodyTypes","engines","exteriorColors","interiorColors","stockStatuses"],t=["bookings","notifications","logs","quickReplies"],n={};function o(i){n[i]||(n[i]=Y(C(A,i),a=>{var d,s;const r=a.val();if(i==="settings")window.state.settings=r||{},window.applySettings(r);else{const l=window.state[i]||[],g=r?Object.entries(r).map(([u,c])=>({...c,id:u})):[];if(window.state[i]=g,i==="cars"&&window.applyInventoryFilters(),i==="ads"&&window.renderAdsSlider(),i==="sales"&&window.renderSalesVideos(),i==="partners"&&window.renderPartners(),i==="reviews"&&window.renderPublicReviews(),i==="custom_presets"&&window.renderCustomPresets(),i==="notifications"&&window.state.user&&window.state.firstLoadDone){const u=((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor",c=v=>v.filter(y=>!y.read&&(u||y.userId===window.state.user.uid||y.assignedTo===window.state.user.uid)),p=c(l).length;c(g).length>p&&window.playNotificationSound&&window.playNotificationSound()}window.state.user&&(window.syncAdminTables(i),window.updateStatistics())}Re()},a=>{console.warn(`Listener for ${i} failed:`,a.message),delete n[i]}))}ke(G,async i=>{if(window.state.user=i,i){const a=C(A,`users/${i.uid}`);Y(a,r=>{window.state.userProfile={...r.val(),id:i.uid},ce(),window.initWhatsAppServer&&window.initWhatsAppServer()}),t.forEach(o)}else window.state.userProfile=null,ce(),t.forEach(a=>{n[a]&&delete n[a]})}),e.forEach(o)}function Re(){var o,i;if(window.state.firstLoadDone)return;const e=window.state.settings,t=e==null?void 0:e.maintenanceMode,n=((o=window.state.userProfile)==null?void 0:o.role)==="admin"||((i=window.state.userProfile)==null?void 0:i.role)==="supervisor";if(t&&!n){const a=document.getElementById("luxury-splash");a&&(a.innerHTML=`
      ...
      <table style="width:100%; border-collapse:collapse; text-align:right; font-size:10px;">
        <thead>
          <tr style="background:#a11d21; color:white;">
            ${b.map(k=>`<th style="padding:10px 5px; border:1px solid #a11d21; white-space:nowrap;">${k}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${l.map((k,$)=>`
            <tr style="background:${$%2===0?"#fff":"#fcfcfc"};">
              ${b.map(S=>`<td style="padding:8px 5px; border:1px solid #eee;">${k[S]}</td>`).join("")}
            </tr>
          `).join("")}
        </tbody>
      </table>
    ...
    `;p.innerHTML=x,document.body.appendChild(p);const w={margin:[10,10],filename:`تقرير_${t}_${new Date().toLocaleDateString("ar-EG").replace(/\//g,"-")}.pdf`,image:{type:"jpeg",quality:1},html2canvas:{scale:2,useCORS:!0,letterRendering:!0},jsPDF:{unit:"mm",format:"a4",orientation:"landscape"}};html2pdf().set(w).from(p).save().then(()=>{document.body.removeChild(p),window.showLuxuryToast("تم استخراج التقرير بنجاح"),window.createLog("تصدير بيانات",`تصدير تقرير ${t} بصيغة PDF`,"data")}).catch(k=>{console.error(k),window.showLuxuryToast("خطأ أثناء استخراج PDF","error"),p.parentNode&&document.body.removeChild(p)})}};window.populateStaffMonitorSelect=function(){const e=document.getElementById("sup-monitor-staff-select");if(!e)return;const t=window.state.users.filter(n=>n.role==="staff");e.innerHTML='<option value="">-- اختر موظف --</option>'+t.map(n=>`<option value="${n.id}">${n.name||n.email}</option>`).join("")};window.monitorStaffChats=function(e){const t=document.getElementById("monitor-active-chats-list"),n=document.getElementById("monitor-chat-body"),o=document.getElementById("monitor-chat-header");if(!t||!n||!o)return;if(!e){t.innerHTML="",n.innerHTML="",o.innerText="اختر محادثة لبدء المراقبة";return}t.innerHTML='<div class="loading-v2">جاري جلب المحادثات...</div>';const i=C(A,"chats"),a=query(i,orderByChild("assignedTo"),equalTo(e));Y(a,r=>{const d=[];if(r.forEach(s=>{d.push({id:s.key,...s.val()})}),d.length===0){t.innerHTML='<div class="no-data">لا توجد محادثات نشطة لهذا الموظف</div>';return}t.innerHTML=d.map(s=>`
    ...
    `).join("")})};window.viewMonitorChat=function(e,t){const n=document.getElementById("monitor-chat-body"),o=document.getElementById("monitor-chat-header");if(!n||!o)return;o.innerText=`مراقبة: ${t}`,n.innerHTML='<div class="loading-v2">جاري تحميل الرسائل...</div>';const i=C(A,`messages/${e}`);Y(i,a=>{const r=[];a.forEach(d=>r.push(d.val())),n.innerHTML=r.map(d=>`
  ...
  `).join(""),o.scrollIntoView({behavior:"smooth",block:"nearest"})};window.updateStaffName=async function(e){const t=prompt("أدخل الإسم الجديد للموظف:");if(t)try{await j(C(A,`users/${e}`),{name:t}),window.showLuxuryToast("تم تحديث الإسم بنجاح"),window.renderSupervisorStaffList()}catch{window.showLuxuryToast("خطأ في التحديث","error")}};window.deleteStaff=async function(e){if(confirm("هل أنت متأكد من حذف هذا الموظف؟ لن يتمكن من تسجيل الدخول بعد الآن."))try{await O(C(A,`users/${e}`)),window.showLuxuryToast("تم حذف الموظف من النظام"),window.renderSupervisorStaffList()}catch{window.showLuxuryToast("خطأ في الحذف","error")}};window.toggleAvailability=async function(){if(!window.state.userProfile)return;const e=window.state.userProfile.isAvailable||!1;try{await j(C(A,`users/${window.state.user.uid}`),{isAvailable:!e}),window.state.userProfile.isAvailable=!e,window.showLuxuryToast(e?"تم تعيين الحالة: غير متاح":"أنت متاح الآن لاستلام الطلبات"),window.updateStatistics()}catch{window.showLuxuryToast("فشل تحديث الحالة","error")}};window.toggleSound=function(){window.state.soundEnabled=!window.state.soundEnabled,localStorage.setItem("luxury_sound_enabled",window.state.soundEnabled);const e=document.getElementById("sound-toggle");e&&(e.checked=window.state.soundEnabled),window.showLuxuryToast(window.state.soundEnabled?"تم تفعيل التنبيهات الصوتية":"تم كتم التنبيهات")};window.setBookingFilter=function(e,t,n="all",o=null){window.state.bookingFilter=e,window.state.bookingSubStatusFilter=n;const i=document.getElementById("filter-booking-status");i&&i.value!==e&&(i.value=e);const a=document.getElementById("filter-booking-sub-status");if(a){const r={new:["not_contacted","contacted"],waiting:["docs_received","waiting_calc","waiting_docs","waiting_signature"],inquiry:["docs_not_received"],sold:["signed","delivered"],done:["done"],cancelled:["no_response","obligations","calc_rejected","ineligible","duplicate"]},d={not_contacted:"لم يتم التواصل",contacted:"تم التواصل",docs_received:"تم استلام الاوراق",waiting_calc:"انتظار رد العميل",waiting_docs:"إنتظار إكمال الاوراق",waiting_signature:"إنتظار توقيع العميل",docs_not_received:"لم يتم استلام الاوراق",signed:"تم التوقيع",delivered:"تم التسليم",done:"تم",no_response:"لم يتم رد العميل",obligations:"التزامات",calc_rejected:"رفض الحسبة",ineligible:"غير مسموح له",duplicate:"مكرر"};let s=e==="all"?Object.keys(d):r[e]||[];a.innerHTML='<option value="all">جميع الحالات الفرعية</option>',s.forEach(l=>{const g=document.createElement("option");g.value=l,g.textContent=d[l],a.appendChild(g)}),Array.from(a.options).some(l=>l.value===n)?a.value=n:(a.value="all",window.state.bookingSubStatusFilter="all",n="all")}document.querySelectorAll(".sub-tab.b-filter").forEach(r=>{if(r.getAttribute("onclick")&&r.getAttribute("onclick").includes(`'${e}'`)){document.querySelectorAll(".sub-tab.b-filter").forEach(s=>s.classList.remove("active")),r.classList.add("active"),document.querySelectorAll(".deep-submenu").forEach(s=>s.classList.remove("active"));const d=r.closest(".status-group");if(d){const s=d.querySelector(".deep-submenu");s&&s.classList.add("active")}}}),document.querySelectorAll(".deep-tab").forEach(r=>{r.classList.remove("active"),n!=="all"&&r.getAttribute("onclick")&&r.getAttribute("onclick").includes(`'${n}'`)&&r.classList.add("active")}),window.syncAdminTables("bookings")};window.applyInventoryFilters=function(){var y,b,x,w,k,$,S;if(!document.getElementById("cars-container"))return;const t=document.getElementById("filter-make"),n=document.getElementById("filter-year");t&&t.options.length<=1&&[...new Set(window.state.cars.map(h=>h.make))].sort().forEach(h=>{const E=document.createElement("option");E.value=h,E.textContent=h,t.appendChild(E)}),n&&n.options.length<=1&&[...new Set(window.state.cars.map(h=>h.year))].filter(Boolean).sort((h,E)=>E-h).forEach(h=>{const E=document.createElement("option");E.value=h,E.textContent=h,n.appendChild(E)});const o=document.getElementById("filter-type");if(o&&o.options.length<=1){const m={sedan:"سيدان",suv:"SUV",coupe:"كوبيه",luxury:"فاخرة",pickup:"بيك آب"};[...new Set(window.state.cars.map(E=>E.bodyType))].filter(Boolean).sort().forEach(E=>{const f=document.createElement("option");f.value=E,f.textContent=m[E]||E,o.appendChild(f)})}const i=(((y=document.getElementById("car-search-input"))==null?void 0:y.value)||"").toLowerCase(),a=((b=document.getElementById("filter-make"))==null?void 0:b.value)||"all",r=((x=document.getElementById("filter-type"))==null?void 0:x.value)||"all",d=((w=document.getElementById("filter-year"))==null?void 0:w.value)||"all",s=((k=document.getElementById("filter-sort"))==null?void 0:k.value)||"newest";let l=(($=window.state.cars)==null?void 0:$.filter(m=>{const h=!i||(m.make+" "+m.model).toLowerCase().includes(i),E=a==="all"||m.make===a,f=r==="all"||m.bodyType===r,T=d==="all"||m.year===d;return h&&E&&f&&T}))||[];s==="price-asc"?l.sort((m,h)=>(Number(m.price)||0)-(Number(h.price)||0)):s==="price-desc"?l.sort((m,h)=>(Number(h.price)||0)-(Number(m.price)||0)):s==="year-asc"?l.sort((m,h)=>(Number(m.year)||0)-(Number(h.year)||0)):l.sort((m,h)=>new Date(h.createdAt||0)-new Date(m.createdAt||0));const g=((S=window.state.cars)==null?void 0:S.filter(m=>m.isFeatured).slice(0,3))||[];ze(g.length>0?g:window.state.cars.slice(0,3));const u=l.length,c=window.state.inventoryPage||1,p=window.state.inventorySize||8,I=(c-1)*p,v=l.slice(I,I+p);renderCarGrid(v),De(u,c,p)};function ze(e){const t=document.getElementById("featured-offers-container");if(!t||!e.length)return;const n=document.getElementById("featured-offers-section");n&&(n.style.display="block"),t.innerHTML=e.map(o=>`
...
`),e.borderRadius&&(t.style.setProperty("--border-radius-main",e.borderRadius+"px"),s+=`
    ...
    `;else{let L=e.glassOpacity!==void 0?e.glassOpacity:.75,B=e.glassBlur!==void 0?e.glassBlur:20;s+=`
    ...
    `}if(e.logoBlend&&e.logoBlend!=="auto"){const L=e.logo||"logo.jpg";e.logoBlend==="mask"?s+=`
    ...
    `),e.enableTextGradient){const L=e.textGradColor1||"#c8a95e",B=e.textGradColor2||"#ffffff";s+=`
    ...
    `}if(e.enableTopbarGradient){const L=e.topbarGradColor1||"#907537",B=e.topbarGradColor2||"#05080c";s+=`
      .top-bar-luxury {
        background: linear-gradient(90deg, ${L}, ${B}) !important;
      }
    `}if(e.enablePrimaryGradient){const L=e.primaryGradColor1||"#907537",B=e.primaryGradColor2||"#b39651";s+=`
    ...
    `}if(e.enableSecondaryGradient){const L=e.secondaryGradColor1||"#b39651",B=e.secondaryGradColor2||"#0f172a";s+=`
      .btn-secondary, .secondary-badge, .p-tab.active, .bullet-point, .nav-item.active, .dash-tab.active {
        background: linear-gradient(135deg, ${L}, ${B}) !important;
        color: white !important;
        border: none !important;
      }
    `}if(e.enableAccentGradient){const L=e.accentGradColor1||"#c8a95e",B=e.accentGradColor2||"#ffd700";s+=`
    ...
    `}d.innerHTML=s;const p=document.getElementById("about-text-display");p&&(p.innerText=e.aboutUs||"نقدم لكم تجربة استثنائية في عالم السيارات...");const I=document.getElementById("location-text-display");I&&(I.innerText=e.location||"الرياض - معارض القادسية");const v=document.getElementById("f-phone-admin");v&&(v.innerText=e.contactAdmin||"...");const y=document.getElementById("f-phone-sales");y&&(y.innerText=e.contactSales||"...");const b=document.getElementById("f-phone-info");b&&(b.innerText=e.contactComplaints||"...");const x=document.getElementById("f-email-display");x&&(x.innerText=e.contactEmail||"...");const w=document.getElementById("contact-location-link");w&&(w.href=e.locationUrl||"#");const k=document.getElementById("meta-title");k&&(k.innerText=`${o} | ${e.metaTitle||"الفخامة والجودة تليق بك"}`);const $=document.getElementById("meta-description");$&&$.setAttribute("content",e.metaDesc||"وجهتكم الرائدة للسيارات الفاخرة والمعتمدة.");const S={"f-insta":e.socialInsta,"f-snap":e.socialSnap,"f-twitter":e.socialTwitter};Object.entries(S).forEach(([L,B])=>{const R=document.getElementById(L);R&&(R.href=B||"#")});const m={"set-name-ar":e.nameAr||"","set-name-en":e.nameEn||"","set-color-primary":e.primaryColor||"#907537","set-color-secondary":e.secondaryColor||"#b39651","set-color-accent":e.accentColor||"#c8a95e","set-color-bg":e.bgColor||"#05080c","set-color-text":e.textColor||"#f8fafc","set-hover-effect":e.hoverEffect||"scale","set-card-style":e.cardStyle||"glass","set-glass-opacity":e.glassOpacity!==void 0?e.glassOpacity:.75,"set-logo-blend":e.logoBlend||"auto","set-logo-scale":e.logoScale||"1","set-default-theme":e.defaultTheme||"dark","set-font-family":e.fontFamily||"'Cairo', sans-serif","set-border-radius":e.borderRadius||"16","set-glass-blur":e.glassBlur||20,"set-shadow-depth":e.shadowDepth||40,"set-anim-speed":e.animSpeed||1,"set-enable-animations":e.enableAnimations!==void 0?e.enableAnimations.toString():"true","set-contact-mgmt":e.contactAdmin||"","set-contact-sales":e.contactSales||"","set-contact-complaints":e.contactComplaints||"","set-contact-email":e.contactEmail||"","set-about-text":e.aboutUs||"","set-location-link":e.locationUrl||"","set-location-text":e.location||"","set-insta-link":e.socialInsta||"","set-snap-link":e.socialSnap||"","set-twitter-link":e.socialTwitter||"","set-text-grad-1":e.textGradColor1||"#c8a95e","set-text-grad-2":e.textGradColor2||"#ffffff","set-topbar-grad-1":e.topbarGradColor1||"#907537","set-topbar-grad-2":e.topbarGradColor2||"#05080c","set-primary-grad-1":e.primaryGradColor1||"#907537","set-primary-grad-2":e.primaryGradColor2||"#b39651"};Object.entries(m).forEach(([L,B])=>{const R=document.getElementById(L);if(R&&(R.value=B,R.type==="range"||R.type==="color")){let H=document.createEvent("HTMLEvents");H.initEvent("input",!1,!0),R.dispatchEvent(H)}});const h=document.getElementById("set-maintenance-mode");h&&(h.checked=e.maintenanceMode||!1);const E={"set-enable-text-grad":e.enableTextGradient!==void 0?e.enableTextGradient:!0,"set-enable-topbar-grad":e.enableTopbarGradient!==void 0?e.enableTopbarGradient:!0,"set-enable-primary-grad":e.enablePrimaryGradient!==void 0?e.enablePrimaryGradient:!0};Object.entries(E).forEach(([L,B])=>{const R=document.getElementById(L);R&&(R.checked=B)});const f=document.getElementById("logo-preview-img");f&&(f.src=n),localStorage.setItem("luxury-settings-cache",JSON.stringify(e))};window.resetToDefaultSettings=async function(){if(confirm("هل أنت متأكد من إعادة ضبط كافة الإعدادات؟ سيتم فقدان الشعارات والألوان المخصصة.")){const e={nameAr:"ديار كار",nameEn:"DIAR CAR",primaryColor:"#907537",secondaryColor:"#b39651",accentColor:"#c8a95e",defaultTheme:"dark",borderRadius:"16px",logo:"logo.jpg",aboutUs:"تجربة استثنائية في عالم السيارات",location:"الرياض - معارض القادسية"};await q(C(A,"settings"),e),window.showLuxuryToast("تمت إعادة الضبط بنجاح")}};window.markAllNotificationsRead=async function(){try{const e=window.state.notifications.map(t=>j(C(A,`notifications/${t.id}`),{read:!0}));await Promise.all(e),window.showLuxuryToast("تم تحديد الكل كمقروء")}catch(e){console.error(e)}};window.switchSettingsTab=function(e,t){document.querySelectorAll(".set-pane").forEach(o=>o.classList.add("hidden")),document.querySelectorAll(".set-tab").forEach(o=>o.classList.remove("active"));const n=document.getElementById(e);n&&n.classList.remove("hidden"),t&&t.classList.add("active")};window.previewLogo=async function(e){if(e.files&&e.files[0])try{const t=await window.compressImage(e.files[0],400,400,.8);document.getElementById("logo-preview-img").src=t,document.getElementById("set-logo-b64").value=t}catch(t){console.error("Logo compression failed",t)}};window.removeBlackFromLogo=function(){const e=document.getElementById("logo-preview-img"),t=document.getElementById("set-logo-b64");if(!t||!t.value){window.showLuxuryToast("الرجاء رفع شعار أولاً");return}const n=document.createElement("canvas"),o=n.getContext("2d"),i=new Image;i.crossOrigin="Anonymous",i.onload=function(){n.width=i.width,n.height=i.height,o.drawImage(i,0,0);const a=o.getImageData(0,0,n.width,n.height),r=a.data,d=r[0],s=r[1],l=r[2],g=d<50&&s<50&&l<50;for(let c=0;c<r.length;c+=4){const p=r[c],I=r[c+1],v=r[c+2],y=r[c+3];if(y===0)continue;const b=Math.max(p,I,v);if(g){if(b<35)r[c+3]=0;else if(b<85){const x=(b-35)/50;r[c+3]=y*x;const w=Math.max(x,.1);r[c]=Math.min(255,p/w),r[c+1]=Math.min(255,I/w),r[c+2]=Math.min(255,v/w)}}else b<30&&(r[c+3]=0)}o.putImageData(a,0,0);const u=n.toDataURL("image/png");if(e.src=u,t.value=u,window.showLuxuryToast("تمت معالجة الشعار وتصفية الحواف بنجاح"),window.applySettings){let c=window.settings||{};c.logo=u,window.applySettings(c)}},i.src=t.value};window.saveAppSettings=async function(){var n,o,i,a,r,d,s,l,g,u,c,p,I,v,y,b,x,w,k,$,S,m,h,E,f,T,M,D,_,L,B,R,H,N,W,V,Z,ee,te,ne,oe,ie,ae,se,re,le;const e=document.querySelector('button[onclick="window.saveAppSettings()"]');e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...');const t={nameAr:((n=document.getElementById("set-name-ar"))==null?void 0:n.value)||"",nameEn:((o=document.getElementById("set-name-en"))==null?void 0:o.value)||"",logo:((i=document.getElementById("set-logo-b64"))==null?void 0:i.value)||window.state.settings.logo||"logo.jpg",primaryColor:((a=document.getElementById("set-color-primary"))==null?void 0:a.value)||"",secondaryColor:((r=document.getElementById("set-color-secondary"))==null?void 0:r.value)||"",accentColor:((d=document.getElementById("set-color-accent"))==null?void 0:d.value)||"",bgColor:((s=document.getElementById("set-color-bg"))==null?void 0:s.value)||"",textColor:((l=document.getElementById("set-color-text"))==null?void 0:l.value)||"",hoverEffect:((g=document.getElementById("set-hover-effect"))==null?void 0:g.value)||"scale",cardStyle:((u=document.getElementById("set-card-style"))==null?void 0:u.value)||"glass",glassOpacity:parseFloat(((c=document.getElementById("set-glass-opacity"))==null?void 0:c.value)||"0.75"),logoBlend:((p=document.getElementById("set-logo-blend"))==null?void 0:p.value)||"auto",logoScale:((I=document.getElementById("set-logo-scale"))==null?void 0:I.value)||"1",defaultTheme:((v=document.getElementById("set-default-theme"))==null?void 0:v.value)||"",fontFamily:((y=document.getElementById("set-font-family"))==null?void 0:y.value)||"",borderRadius:((b=document.getElementById("set-border-radius"))==null?void 0:b.value)||"",glassBlur:parseInt(((x=document.getElementById("set-glass-blur"))==null?void 0:x.value)||"20"),shadowDepth:parseInt(((w=document.getElementById("set-shadow-depth"))==null?void 0:w.value)||"40"),animSpeed:parseFloat(((k=document.getElementById("set-anim-speed"))==null?void 0:k.value)||"1"),enableAnimations:(($=document.getElementById("set-enable-animations"))==null?void 0:$.value)==="true",contactAdmin:((S=document.getElementById("set-contact-mgmt"))==null?void 0:S.value)||"",contactSales:((m=document.getElementById("set-contact-sales"))==null?void 0:m.value)||"",contactComplaints:((h=document.getElementById("set-contact-complaints"))==null?void 0:h.value)||"",contactEmail:((E=document.getElementById("set-contact-email"))==null?void 0:E.value)||"",aboutUs:((f=document.getElementById("set-about-text"))==null?void 0:f.value)||"",locationUrl:((T=document.getElementById("set-location-link"))==null?void 0:T.value)||"",location:((M=document.getElementById("set-location-text"))==null?void 0:M.value)||"",socialInsta:((D=document.getElementById("set-insta-link"))==null?void 0:D.value)||"",socialSnap:((_=document.getElementById("set-snap-link"))==null?void 0:_.value)||"",socialTwitter:((L=document.getElementById("set-twitter-link"))==null?void 0:L.value)||"",maintenanceMode:((B=document.getElementById("set-maintenance-mode"))==null?void 0:B.checked)||!1,enableTextGradient:(R=document.getElementById("set-enable-text-grad"))==null?void 0:R.checked,textGradColor1:(H=document.getElementById("set-text-grad-1"))==null?void 0:H.value,textGradColor2:(N=document.getElementById("set-text-grad-2"))==null?void 0:N.value,enableTopbarGradient:(W=document.getElementById("set-enable-topbar-grad"))==null?void 0:W.checked,topbarGradColor1:(V=document.getElementById("set-topbar-grad-1"))==null?void 0:V.value,topbarGradColor2:(Z=document.getElementById("set-topbar-grad-2"))==null?void 0:Z.value,enablePrimaryGradient:(ee=document.getElementById("set-enable-primary-grad"))==null?void 0:ee.checked,primaryGradColor1:(te=document.getElementById("set-primary-grad-1"))==null?void 0:te.value,primaryGradColor2:(ne=document.getElementById("set-primary-grad-2"))==null?void 0:ne.value,enableSecondaryGradient:(oe=document.getElementById("set-enable-secondary-grad"))==null?void 0:oe.checked,secondaryGradColor1:(ie=document.getElementById("set-secondary-grad-1"))==null?void 0:ie.value,secondaryGradColor2:(ae=document.getElementById("set-secondary-grad-2"))==null?void 0:ae.value,enableAccentGradient:(se=document.getElementById("set-enable-accent-grad"))==null?void 0:se.checked,accentGradColor1:(re=document.getElementById("set-accent-grad-1"))==null?void 0:re.value,accentGradColor2:(le=document.getElementById("set-accent-grad-2"))==null?void 0:le.value,updatedAt:new Date().toISOString()};try{localStorage.removeItem("theme_manually_overridden"),await q(C(A,"settings"),t),window.showLuxuryToast("تم حفظ الإعدادات بنجاح"),window.createLog("تعديل إعدادات","تحديث شامل لإعدادات الموقع والمنصة","settings")}catch{window.showLuxuryToast("فشل الحفظ، تأكد من الصلاحيات","error")}finally{e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> حفظ التغييرات')}};window.toggleDesignPreview=function(){const e=document.getElementById("design-preview-widget");e&&e.classList.toggle("minimized")};window.makeDraggable=function(e){if(!e||e.dataset.draggable)return;e.dataset.draggable="true";let t=0,n=0,o=0,i=0;const a=e.querySelector("div");if(!a)return;a.onmousedown=r,a.ontouchstart=r;function r(l){if(l.target.tagName==="BUTTON"||l.target.tagName==="I")return;const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;o=g,i=u,document.onmouseup=s,document.ontouchend=s,document.onmousemove=d,document.ontouchmove=d,e.classList.add("dragging")}function d(l){const g=l.clientX||l.touches&&l.touches[0].clientX,u=l.clientY||l.touches&&l.touches[0].clientY;t=o-g,n=i-u,o=g,i=u;const c=e.getBoundingClientRect(),p=c.top-n,I=c.left-t;e.style.top=p+"px",e.style.left=I+"px",e.style.bottom="auto",e.style.right="auto",e.style.margin="0"}function s(){document.onmouseup=null,document.onmousemove=null,document.ontouchend=null,document.ontouchmove=null,e.classList.remove("dragging")}};window.filterUsersByRole=function(e,t){t&&(document.querySelectorAll("#users-roles-tabs .p-tab").forEach(n=>n.classList.remove("active")),t.classList.add("active")),window.state.userRoleFilter=e,window.syncAdminTables("users")};window.syncAdminTables=function(e){var i,a,r,d,s,l,g,u,c,p,I,v,y,b,x;if(e==="all"){["cars","ads","sales","bookings","users","plates","reviews","partners","brands","locations","blogs","whatsapp-monitor","quick-replies"].forEach(k=>window.syncAdminTables(k));return}if(e==="whatsapp-monitor"){window.renderWhatsAppMonitor();return}if(e==="quick-replies"||e==="quickReplies"){window.renderQuickRepliesAdmin&&window.renderQuickRepliesAdmin(),window.renderQuickRepliesBar&&window.renderQuickRepliesBar();return}const t=document.getElementById(`admin-${e}-table`);if(!t)return;let n=window.state[e]||[];const o=(((i=document.getElementById(`admin-${e}-search`))==null?void 0:i.value)||((a=document.getElementById(`${e}-search`))==null?void 0:a.value)||((r=document.getElementById(`${e.slice(0,-1)}-search`))==null?void 0:r.value)||"").toLowerCase();if(o&&(n=n.filter(w=>(w.make||w.title||w.name||w.model||w.phone||w.carRequested||w.carOrCompany||w.subtitle||"").toLowerCase().includes(o))),e==="notifications"&&!(((d=window.state.userProfile)==null?void 0:d.role)==="admin"||((s=window.state.userProfile)==null?void 0:s.role)==="supervisor")&&window.state.user&&(n=n.filter(k=>k.userId===window.state.user.uid||k.assignedTo===window.state.user.uid)),e==="cars"){const w=document.getElementById("admin-filter-car-make");w&&w.options.length<=1&&window.state.cars.length>0&&[...new Set(window.state.cars.map(m=>m.make))].sort().forEach(m=>{const h=document.createElement("option");h.value=m,h.textContent=m,w.appendChild(h)});const k=((l=document.getElementById("admin-filter-car-status"))==null?void 0:l.value)||"all",$=((g=document.getElementById("admin-filter-car-make"))==null?void 0:g.value)||"all";k!=="all"&&(n=n.filter(S=>S.status===k)),$!=="all"&&(n=n.filter(S=>S.make===$))}if(e==="bookings"){const w=document.getElementById("filter-booking-staff");w&&w.options.length<=1&&window.state.users&&window.state.users.forEach(f=>{if(f.email!=="zyrozyro98@gmail.com"&&(f.role==="admin"||f.role==="supervisor"||f.role==="staff")){const T=document.createElement("option");T.value=f.id,T.textContent=f.name||f.email||"مستخدم غير محدد",w.appendChild(T)}});const k=document.getElementById("filter-booking-sub-status");if(k&&k.options.length<=1){window.setBookingFilter(window.state.bookingFilter||"all",null,window.state.bookingSubStatusFilter||"all");return}const $=((u=document.getElementById("filter-booking-status"))==null?void 0:u.value)||window.state.bookingFilter||"all",S=((c=document.getElementById("filter-booking-sub-status"))==null?void 0:c.value)||window.state.bookingSubStatusFilter||"all",m=((p=document.getElementById("filter-booking-staff"))==null?void 0:p.value)||"all",h=((I=document.getElementById("filter-booking-type"))==null?void 0:I.value)||"all";window.state.bookingFilter=$,window.state.bookingSubStatusFilter=S,$!=="all"&&(n=n.filter(f=>{let T=f.status||"new";return $==="cancelled"&&(T==="rejected"||T==="cancelled")?!0:T===$})),S!=="all"&&(n=n.filter(f=>f.subStatus===S)),m!=="all"&&(n=n.filter(f=>f.assignedTo===m)),h!=="all"&&(n=n.filter(f=>(f.customerType||"individual")===h)),!(((v=window.state.userProfile)==null?void 0:v.role)==="admin"||((y=window.state.userProfile)==null?void 0:y.role)==="supervisor")&&window.state.user&&(n=n.filter(f=>f.assignedTo===window.state.user.uid))}if(e==="users"){n=n.filter(m=>m.email!=="zyrozyro98@gmail.com");const w=window.state.userRoleFilter||"all";w!=="all"&&(n=n.filter(m=>m.role===w));const k=document.getElementById("stat-users-total"),$=document.getElementById("stat-users-active"),S=document.getElementById("stat-users-admins");if(k&&(k.innerText=n.length),$){$.innerText=n.filter(h=>h.isAvailable).length;const m=$.nextElementSibling;m&&(m.innerText="متواجد حالياً")}if(S){const m=S.nextElementSibling;if(w==="all")S.innerText=n.filter(h=>h.role==="admin").length,m&&(m.innerText="مدراء النظام");else{S.innerText=n.length;const h={admin:"مدراء النظام",supervisor:"مشرفين",staff:"المندوبين"};m&&(m.innerText="إجمالي الـ "+(h[w]||""))}}}if(e==="bookings"?(((b=document.getElementById("filter-booking-sort"))==null?void 0:b.value)||"newest")==="oldest"?n.sort((k,$)=>new Date(k.createdAt||0)-new Date($.createdAt||0)):n.sort((k,$)=>new Date($.createdAt||0)-new Date(k.createdAt||0)):n.sort((w,k)=>new Date(k.createdAt||0)-new Date(w.createdAt||0)),n.length===0){t.innerHTML='<div class="no-data-admin" style="padding:40px; text-align:center; opacity:0.5;">لا توجد بيانات لهذه الفئة</div>';return}if(e==="users"){const w=window.state.bookings||[],k=((x=window.state.userProfile)==null?void 0:x.role)==="admin";let $=`<table class="admin-table-v2" style="width:100%; border-collapse:collapse; min-width:800px; font-size:14px;">
          ...
          <tbody>`;n.forEach(S=>{const m=w.filter(B=>B.assignedTo===S.id),h=m.filter(B=>B.status==="sold"||B.status==="done").length,E=m.filter(B=>B.status==="new"||B.status==="waiting"||B.status==="inquiry"||!B.status).length,f=m.filter(B=>B.status==="cancelled").length,M={admin:"مسؤول",supervisor:"مشرف",staff:"مندوب"}[S.role]||"مندوب",D=S.image||"logo.jpg",_=S.phone||"";let L="";if(_){let B=_.replace(/\D/g,"");B=window.normalizePhone(B),L=`<a href="https://wa.me/${B}" target="_blank" class="icon-btn-lite success" title="مراسلة واتساب"><i class="fab fa-whatsapp"></i></a>`}$+=`<tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
          ...
          </tr>`}),$+="</tbody></table>",t.innerHTML=$;return}t.innerHTML=n.map(w=>_e(e,w)).join("")};function _e(e,t){var u,c,p,I,v,y,b,x;((u=window.state.userProfile)==null?void 0:u.role)==="admin"||((c=window.state.userProfile)==null||c.role);const n=((p=window.state.userProfile)==null?void 0:p.role)==="admin",o=((I=window.state.userProfile)==null?void 0:I.role)==="supervisor",a=n||o&&["bookings","notifications"].includes(e),r=(t.status||"available").toLowerCase(),d=r==="sold"||r==="مباع"?"danger":r==="available"||r==="متاح"?"success":"warning",s=r==="sold"||r==="مباع"?"مباع":r==="available"||r==="متاح"?"متاح":"محجوز";if(e==="bookings"){const w=((v=window.state.users.find(h=>h.id===t.assignedTo))==null?void 0:v.name)||"غير محدد",k={new:"جديد",waiting:"بالانتظار",inquiry:"استفسار",sold:"مكتمل",done:"تم",cancelled:"مرفوض",rejected:"مرفوض"},$={not_contacted:"لم يتم التواصل",contacted:"تم التواصل",docs_received:"تم استلام الاوراق",waiting_calc:"انتظار رد العميل",waiting_docs:"إنتظار إكمال الاوراق",waiting_signature:"إنتظار توقيع العميل",docs_not_received:"لم يتم استلام الاوراق",signed:"تم التوقيع",delivered:"تم التسليم",done:"تم",no_response:"لم يتم رد العميل",obligations:"التزامات",calc_rejected:"رفض الحسبة",ineligible:"غير مسموح له",duplicate:"مكرر"},S=t.status==="cancelled"||t.status==="rejected"?"danger":t.status==="sold"||t.status==="done"?"success":"warning",m=t.subStatus?$[t.subStatus]||t.subStatus:"";return`
            <div class="admin-item-row" style="background:rgba(255,255,255,0.02); padding:15px; border-radius:12px; border:1px solid var(--glass-border); margin-bottom:10px; display:flex; justify-content:space-between; align-items:center;">
                ...
                <div class="admin-actions" style="display:flex; gap:10px; align-items:center;">
                    <span class="badge-${S}" style="font-size:10px; padding:3px 8px; border-radius:5px;">${k[t.status]||t.status||"جديد"}</span>
        ...
        `;if(e==="notifications"){const w=!!t.read,k=t.type||"system",$=((y=window.state.userProfile)==null?void 0:y.role)==="admin"||((b=window.state.userProfile)==null?void 0:b.role)==="supervisor",S=t.userId||t.assignedTo,m=(x=window.state.users)==null?void 0:x.find(f=>f.id===S),h=m?m.name||m.email:"نظام",E={wa_message:"fab fa-whatsapp",booking:"fas fa-calendar-check",system:"fas fa-info-circle",auth:"fas fa-shield-alt"};return`
      <div class="notification-premium-item ${w?"":"unread"}" onclick="window.handleNotificationClick('${t.id}', '${t.link||""}')">
          <div class="notif-icon-wrap">
              <i class="${E[k]||E.system}"></i>
          </div>
          <div class="notif-content">
              <div class="notif-header">
                  <div style="display:flex; flex-direction:column; gap:2px;">
                      <span class="notif-title">${t.title||"تنبيه بالنظام"}</span>
                      ${$?`<span style="font-size:11px; color:var(--p-gold); font-weight:bold;">الموظف: ${h}</span>`:""}
                  </div>
    ...
    `}if(e==="logs")return`
        ...
        `;if(e==="sales"){const w=(t.url||"").trim();let k=w.includes("youtube.com")||w.includes("youtu.be"),$=t.poster||t.image||null;if(k&&!$){let S="";try{w.includes("v=")?S=w.split("v=")[1].split("&")[0]:w.includes("youtu.be/")?S=w.split("youtu.be/")[1].split("?")[0]:w.includes("embed/")?S=w.split("embed/")[1].split("?")[0]:S=w.split("/").pop().split("?")[0]}catch{S=""}S&&($=`https://img.youtube.com/vi/${S}/mqdefault.jpg`)}return $=$||"logo.jpg",`
            <div class="admin-item-row" style="background:rgba(255,255,255,0.02); padding:12px; border-radius:16px; border:1px solid var(--glass-border); margin-bottom:12px; display:flex; align-items:center; gap:20px;">
                <div class="admin-item-thumb" style="width:80px; height:50px; border-radius:10px; overflow:hidden; flex-shrink:0; background:#000;">
                    <img src="${$}" style="width:100%; height:100%; object-fit:cover;" onerror="this.src='logo.jpg'">
                </div>
                <div class="admin-item-info" style="flex-grow:1;">
        ...
        `}if(e==="reviews"){const w=Number(t.rating||5),k=t.text?t.text.length>60?t.text.substring(0,60)+"...":t.text:"لا يوجد نص",$=t.avatar||t.image||"";return`
        <div class="admin-item-row" style="background:rgba(255,255,255,0.02); padding:15px; border-radius:16px; border:1px solid var(--glass-border); margin-bottom:12px; display:flex; align-items:center; gap:20px;">
            <div class="admin-item-avatar" style="width:50px; height:50px; border-radius:50%; overflow:hidden; flex-shrink:0; background:var(--bg-alt); border:2px solid var(--p-copper); display:flex; align-items:center; justify-content:center; color:var(--p-copper); font-weight:900;">
                ${$?`<img src="${$}" style="width:100%; height:100%; object-fit:cover;">`:(t.name||"U").charAt(0)}
            </div>
            <div class="admin-item-info" style="flex-grow:1;">
                <div style="display:flex; align-items:center; gap:10px; margin-bottom:4px;">
    ...
    `}window.updateStatistics=function(){var w,k,$,S;const e=document.getElementById("stat-cars-count-v2"),t=document.getElementById("stat-bookings-count-v2"),n=document.getElementById("stat-total-value-v2"),o=window.state.cars||[];let i=window.state.bookings||[];if(!(((w=window.state.userProfile)==null?void 0:w.role)==="admin"||((k=window.state.userProfile)==null?void 0:k.role)==="supervisor")&&window.state.user&&(i=i.filter(m=>m.assignedTo===window.state.user.uid)),e&&(e.innerText=o.length),t&&(t.innerText=i.length),n){const m=o.reduce((h,E)=>h+(parseFloat(E.price)||0),0);n.innerText=m.toLocaleString()+" ريال"}const r={all:i.length,new:i.filter(m=>m.status==="new"||!m.status).length,waiting:i.filter(m=>m.status==="waiting").length,inquiry:i.filter(m=>m.status==="inquiry").length,sold:i.filter(m=>m.status==="sold").length,done:i.filter(m=>m.status==="done").length,cancelled:i.filter(m=>m.status==="cancelled"||m.status==="rejected").length,sub:{not_contacted:i.filter(m=>m.subStatus==="not_contacted").length,contacted:i.filter(m=>m.subStatus==="contacted").length,docs_received:i.filter(m=>m.subStatus==="docs_received").length,waiting_calc:i.filter(m=>m.subStatus==="waiting_calc").length,waiting_docs:i.filter(m=>m.subStatus==="waiting_docs").length,waiting_signature:i.filter(m=>m.subStatus==="waiting_signature").length,docs_not_received:i.filter(m=>m.subStatus==="docs_not_received").length,signed:i.filter(m=>m.subStatus==="signed").length,delivered:i.filter(m=>m.subStatus==="delivered").length,done:i.filter(m=>m.subStatus==="done").length,no_response:i.filter(m=>m.subStatus==="no_response").length,obligations:i.filter(m=>m.subStatus==="obligations").length,calc_rejected:i.filter(m=>m.subStatus==="calc_rejected").length,ineligible:i.filter(m=>m.subStatus==="ineligible").length,duplicate:i.filter(m=>m.subStatus==="duplicate").length}};Object.entries(r).forEach(([m,h])=>{const E=document.getElementById(`count-${m}`);E&&(E.innerText=h)}),Object.entries(r.sub).forEach(([m,h])=>{const E=document.getElementById(`count-sub-${m}`);E&&(E.innerText=h)});const d=document.getElementById("bookings-badge");d&&(d.innerText=r.new,d.classList.toggle("hidden",r.new===0));const s=($=window.state.user)==null?void 0:$.uid;if(((S=window.state.userProfile)==null?void 0:S.role)==="staff"&&s){const m=document.getElementById("staff-quick-stats");m&&m.classList.remove("hidden");const h=(window.state.bookings||[]).filter(R=>R.assignedTo===s),E=h.filter(R=>R.status==="new"||!R.status).length,f=h.length,T=h.filter(R=>R.status==="sold").length,M=f>0?Math.round(T/f*100):0,D=document.getElementById("staff-waiting-count"),_=document.getElementById("staff-total-assigned"),L=document.getElementById("staff-conversion-rate"),B=document.getElementById("availability-toggle");D&&(D.innerText=E),_&&(_.innerText=f),L&&(L.innerText=M+"%"),B&&(B.checked=window.state.userProfile.isAvailable!==!1)}const g=document.getElementById("total-inventory-value"),u=document.getElementById("overall-conversion-rate"),c=document.getElementById("active-bookings-count"),p=document.getElementById("conversion-bar");if(g){const m=(window.state.cars||[]).reduce((h,E)=>h+(parseFloat(E.price)||0),0);g.innerText=m.toLocaleString()+" ريال"}if(c&&(c.innerText=r.new+r.waiting+r.inquiry),u){const m=(window.state.bookings||[]).length,h=(window.state.bookings||[]).filter(f=>f.status==="sold"||f.status==="done").length,E=m>0?Math.round(h/m*100):0;u.innerText=E+"%",p&&(p.style.width=E+"%")}const I=document.getElementById("monthly-goal-percent"),v=document.getElementById("monthly-goal-fill");if(I&&v){const m=(window.state.bookings||[]).filter(f=>{if(f.status!=="sold"&&f.status!=="done")return!1;const T=new Date(f.createdAt||0),M=new Date;return T.getMonth()===M.getMonth()&&T.getFullYear()===M.getFullYear()}).length,E=Math.min(100,Math.round(m/50*100));I.innerText=E+"%",v.style.width=E+"%"}const y=document.getElementById("supervisor-recent-logs");if(y&&window.state.logs){const m=[...window.state.logs].sort((h,E)=>new Date(E.timestamp)-new Date(h.timestamp)).slice(0,10);y.innerHTML=m.map(h=>`
    ...
    `).join("")}const b=document.getElementById("status-donut-chart");if(b){const m=r.sold+r.done,h=r.new+r.waiting+r.inquiry,E=r.cancelled,f=m+h+E||1,T=Math.round(m/f*100),M=Math.round(h/f*100);b.style.background=`conic-gradient(
      #00a884 0% ${T}%, 
      var(--p-gold) ${T}% ${T+M}%, 
      #e02424 ${T+M}% 100%
    )`,b.setAttribute("data-pct",`${T}% ناجح`)}const x=document.getElementById("supervisor-leaderboard");if(x&&window.state.users&&window.state.bookings){const m=new Date,h=window.state.bookings.filter(f=>{const T=new Date(f.createdAt||0);return T.getMonth()===m.getMonth()&&T.getFullYear()===m.getFullYear()}),E=window.state.users.filter(f=>f.role==="staff"||f.role==="supervisor").map(f=>{const T=h.filter(D=>D.assignedTo===f.id&&(D.status==="sold"||D.status==="done")).length,M=h.filter(D=>D.assignedTo===f.id).length;return{...f,soldCount:T,totalAssigned:M}}).sort((f,T)=>T.soldCount-f.soldCount).slice(0,5);x.innerHTML=E.map((f,T)=>`
                ...
                <div style="text-align:center; margin-top:auto; margin-bottom:auto;">
                    <div style="background:rgba(255,255,255,0.95); display:inline-block; padding:20px; border-radius:15px; font-size:13px; color:#555; box-shadow:0 10px 30px rgba(0,0,0,0.1); max-width:85%;">
                        ...
                        سجل المحادثات متاح فقط للحجوزات المسندة.
                                ...
                                <button id="${w}" class="btn-premium btn-sm" onclick="window.downloadWAMedia('${o}', '${e}', '${c.id}', '${k}', '${c.media.mimetype}', '${c.type}')" style="padding:4px 10px; min-width:40px;"><i class="fas fa-download"></i></button>
                            </div>`+(v?`<div>${v}</div>`:"")}else c.media.mimetype.startsWith("image/")?b=`<div style="margin:-4px -6px 4px -8px; background:rgba(0,0,0,0.02); border-radius:10px 10px 0 0; overflow:hidden; text-align:center;"><img src="data:${c.media.mimetype};base64,${c.media.data}" style="max-width:100%; max-height:220px; border-radius:8px; display:inline-block; cursor:pointer; object-fit:cover;" onclick="window.viewFullImage(this.src)"></div>`+(v?`<div>${v}</div>`:""):c.media.mimetype.startsWith("audio/")||c.type==="ptt"?b=`<div style="display:flex; align-items:center; gap:10px;"><div style="background:#00a884; width:40px; height:40px; border-radius:50%; display:flex; justify-content:center; align-items:center; flex-shrink:0;"><i class="fas fa-play" style="color:white; margin-right:-2px; font-size:14px;"></i></div> <audio controls style="max-width:200px; height:35px;"><source src="data:${c.media.mimetype};base64,${c.media.data}" type="${c.media.mimetype}"></audio></div>`+(v?`<div style="margin-top:5px;">${v}</div>`:""):c.media.mimetype.startsWith("video/")?b=`<video controls style="max-width:100%; border-radius:8px; margin-bottom:5px;"><source src="data:${c.media.mimetype};base64,${c.media.data}" type="${c.media.mimetype}"></video>`+(v?`<div>${v}</div>`:""):b=`<div style="background:rgba(0,0,0,0.05); padding:10px; border-radius:8px; display:flex; align-items:center; gap:10px; margin-bottom:5px;"><i class="fas fa-file-alt" style="font-size:24px; color:#54656f;"></i> <div><strong style="display:block; font-size:13px;">ملف ${c.media.filename||"مرفق"}</strong><span style="font-size:11px; opacity:0.7;">تنزيل للعرض</span></div></div>`+(v?`<div>${v}</div>`:"");let x="";if(c.isMe){let w=c.ack!==void 0?c.ack:c.status==="read"?3:c.status==="delivered"?2:c.status==="sent"?1:void 0;w===1||w===0?x='<i class="fas fa-check" style="font-size:12px; margin-right:4px; color:#c7c7c7;"></i>':w===2?x='<i class="fas fa-check-double" style="font-size:12px; margin-right:4px; color:#c7c7c7;"></i>':w>=3?x='<i class="fas fa-check-double" style="font-size:12px; margin-right:4px; color:#53bdeb;"></i>':x='<i class="fas fa-check" style="font-size:12px; margin-right:4px; color:#c7c7c7;"></i>'}y.innerHTML=`${b} <div style="display:flex; justify-content:flex-end; align-items:center; margin-top:2px; float:left; margin-left:-5px; padding-left:10px; padding-top:2px;">
