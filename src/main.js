...
window.state = {
  ...
  settings: window.CONFIG || {
    ...
    textGradColor1: "#ae8d42",
    textGradColor2: "#b1934e",
    enableTopbarGradient: true,
    topbarGradColor1: "#c8a95e",
    topbarGradColor2: "#c8a95e",
    enablePrimaryGradient: true,
    primaryGradColor1: "#c8a95e",
    primaryGradColor2: "#c8a95e",
    enableSecondaryGradient: false,
